...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 7f 08 00 	movl   $0x87f,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43e:	0f b6 90 dc 0a 00 00 	movzbl 0xadc(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 59d:	75 27                	jne    5c6 <printf+0x11f>
          s = "(null)";
 59f:	c7 45 f4 98 08 00 00 	movl   $0x898,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 66b:	a1 f8 0a 00 00       	mov    0xaf8,%eax
...
free(void *ap)
{
 ...
 72c:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 731:	c9                   	leave  
 732:	c3                   	ret    
