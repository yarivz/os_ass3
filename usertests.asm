...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
       b:	c7 44 24 04 b2 41 00 	movl   $0x41b2,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 bc 3d 00 00       	call   3dd7 <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
      3d:	c7 44 24 04 bd 41 00 	movl   $0x41bd,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 8a 3d 00 00       	call   3dd7 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
      b6:	c7 44 24 04 09 42 00 	movl   $0x4209,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 11 3d 00 00       	call   3dd7 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
      e8:	c7 44 24 04 20 42 00 	movl   $0x4220,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 df 3c 00 00       	call   3dd7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     109:	c7 44 24 04 3b 42 00 	movl   $0x423b,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 be 3c 00 00       	call   3dd7 <printf>
    exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     1b3:	c7 44 24 04 b8 42 00 	movl   $0x42b8,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 14 3c 00 00       	call   3dd7 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     1f0:	c7 44 24 04 c3 42 00 	movl   $0x42c3,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 d7 3b 00 00       	call   3dd7 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     22e:	c7 44 24 04 dc 42 00 	movl   $0x42dc,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 99 3b 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     248:	c7 44 24 04 f7 42 00 	movl   $0x42f7,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 7f 3b 00 00       	call   3dd7 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     27a:	c7 44 24 04 0a 43 00 	movl   $0x430a,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 4d 3b 00 00       	call   3dd7 <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     2cb:	c7 44 24 04 40 43 00 	movl   $0x4340,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 fc 3a 00 00       	call   3dd7 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     2fd:	c7 44 24 04 54 43 00 	movl   $0x4354,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 ca 3a 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     ...
     35e:	e8 74 3a 00 00       	call   3dd7 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     3a3:	c7 44 24 04 8c 43 00 	movl   $0x438c,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 24 3a 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     ...
     407:	e8 cb 39 00 00       	call   3dd7 <printf>
        exit();
     ...
     41a:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     ...
     431:	e8 a1 39 00 00       	call   3dd7 <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     44e:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     ...
     469:	e8 69 39 00 00       	call   3dd7 <printf>
             n, ((int*)buf)[0]);
      exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     4d4:	c7 44 24 04 18 44 00 	movl   $0x4418,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 f3 38 00 00       	call   3dd7 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     56f:	c7 44 24 04 40 44 00 	movl   $0x4440,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 58 38 00 00       	call   3dd7 <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     58c:	c7 44 24 04 66 44 00 	movl   $0x4466,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 3b 38 00 00       	call   3dd7 <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     5ac:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     5b1:	c7 44 24 04 77 44 00 	movl   $0x4477,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 16 38 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     5db:	c7 44 24 04 85 44 00 	movl   $0x4485,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 ec 37 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     600:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     605:	c7 44 24 04 9b 44 00 	movl   $0x449b,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 c2 37 00 00       	call   3dd7 <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     666:	c7 44 24 04 c0 44 00 	movl   $0x44c0,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 61 37 00 00       	call   3dd7 <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 e0 5e 00 	movl   $0x5ee0,0x4(%esp)
     67d:	00 
    ...
    printf(stdout, "exec echo failed\n");
     68e:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
     693:	c7 44 24 04 cb 44 00 	movl   $0x44cb,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 34 37 00 00       	call   3dd7 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     6ce:	e8 04 37 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     75e:	e8 74 36 00 00       	call   3dd7 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7d7:	e8 fb 35 00 00       	call   3dd7 <printf>
          return;
    ...
    if(total != 5 * 1033){
     ...
     84d:	e8 85 35 00 00       	call   3dd7 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     ...
     876:	e8 5c 35 00 00       	call   3dd7 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     88c:	e8 46 35 00 00       	call   3dd7 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     8ad:	e8 25 35 00 00       	call   3dd7 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     925:	e8 ad 34 00 00       	call   3dd7 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     971:	e8 61 34 00 00       	call   3dd7 <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     992:	e8 40 34 00 00       	call   3dd7 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     9c7:	e8 0b 34 00 00       	call   3dd7 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     9ea:	e8 e8 33 00 00       	call   3dd7 <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a1d:	e8 b5 33 00 00       	call   3dd7 <printf>
      return;
    ...
    if(pid){
     ...
     a43:	e8 8f 33 00 00       	call   3dd7 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     a68:	e8 6a 33 00 00       	call   3dd7 <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     a84:	e8 4e 33 00 00       	call   3dd7 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 f5 35 00 00       	call   40bb <malloc>
    ...
    while(m1){
     ...
     adf:	e8 a8 34 00 00       	call   3f8c <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     af7:	e8 bf 35 00 00       	call   40bb <malloc>
    ...
    if(m1 == 0){
     ...
     b14:	e8 be 32 00 00       	call   3dd7 <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     b69:	e8 69 32 00 00       	call   3dd7 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ba6:	e8 2c 32 00 00       	call   3dd7 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c18:	e8 ba 31 00 00       	call   3dd7 <printf>
      break;
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     c73:	e8 5f 31 00 00       	call   3dd7 <printf>
    return;
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 ee 45 00 00 	movl   $0x45ee,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 6f 46 00 	movl   $0x466f,0x4(%esp)
     d16:	00 
     d17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1e:	e8 b4 30 00 00       	call   3dd7 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 7c 46 00 	movl   $0x467c,0x4(%esp)
     d3a:	00 
     d3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d42:	e8 90 30 00 00       	call   3dd7 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 91 46 00 	movl   $0x4691,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 6f 30 00 00       	call   3dd7 <printf>

  unlink("f1");
     d68:	c7 04 24 a0 46 00 00 	movl   $0x46a0,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 a3 46 00 00 	movl   $0x46a3,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 89 45 00 	movl   $0x4589,0x4(%esp)
     d95:	00 
     d96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9d:	e8 35 30 00 00       	call   3dd7 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 a0 46 00 00       	mov    $0x46a0,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 a3 46 00 00       	mov    $0x46a3,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 a6 46 00 	movl   $0x46a6,0x4(%esp)
     ddf:	00 
     de0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de7:	e8 eb 2f 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e52:	c7 44 24 04 b5 46 00 	movl   $0x46b5,0x4(%esp)
     e59:	00 
     e5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e61:	e8 71 2f 00 00       	call   3dd7 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 a0 46 00 00       	mov    $0x46a0,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 a3 46 00 00       	mov    $0x46a3,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 c6 46 00 	movl   $0x46c6,0x4(%esp)
     efe:	00 
     eff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f06:	e8 cc 2e 00 00       	call   3dd7 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 d2 46 00 	movl   $0x46d2,0x4(%esp)
     f68:	00 
     f69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f70:	e8 62 2e 00 00       	call   3dd7 <printf>
      exit();
  ...
  unlink("f1");
     f88:	c7 04 24 a0 46 00 00 	movl   $0x46a0,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 a3 46 00 00 	movl   $0x46a3,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 e3 46 00 	movl   $0x46e3,0x4(%esp)
     fa7:	00 
     fa8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faf:	e8 23 2e 00 00       	call   3dd7 <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 f0 46 00 	movl   $0x46f0,0x4(%esp)
     fc3:	00 
     fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcb:	e8 07 2e 00 00       	call   3dd7 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 89 45 00 	movl   $0x4589,0x4(%esp)
     fe5:	00 
     fe6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fed:	e8 e5 2d 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 a6 46 00 	movl   $0x46a6,0x4(%esp)
    1048:	00 
    1049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1050:	e8 82 2d 00 00       	call   3dd7 <printf>
      exit();
    ...
    1096:	c7 44 24 04 03 47 00 	movl   $0x4703,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 2d 2d 00 00       	call   3dd7 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 14 47 00 	movl   $0x4714,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 ae 2c 00 00       	call   3dd7 <printf>
      exit();
    ...
    1147:	c7 44 24 04 38 47 00 	movl   $0x4738,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 7c 2c 00 00       	call   3dd7 <printf>
      exit();
    ...
    11ad:	c7 44 24 04 14 47 00 	movl   $0x4714,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 16 2c 00 00       	call   3dd7 <printf>
      exit();
    ...
    11df:	c7 44 24 04 38 47 00 	movl   $0x4738,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 e4 2b 00 00       	call   3dd7 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 58 47 00 	movl   $0x4758,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 72 2b 00 00       	call   3dd7 <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 69 47 00 	movl   $0x4769,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 56 2b 00 00       	call   3dd7 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 7a 47 00 00 	movl   $0x477a,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 85 47 00 	movl   $0x4785,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 25 2b 00 00       	call   3dd7 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 9f 47 00 	movl   $0x479f,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 7a 47 00 00 	movl   $0x477a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1399:	c7 44 24 04 db 47 00 	movl   $0x47db,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 2a 2a 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13bd:	c7 44 24 04 f2 47 00 	movl   $0x47f2,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 06 2a 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13f6:	c7 44 24 04 09 48 00 	movl   $0x4809,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 cd 29 00 00       	call   3dd7 <printf>
    exit();
  ...
  unlink("unlinkread");
    141a:	c7 04 24 7a 47 00 00 	movl   $0x477a,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 22 48 00 	movl   $0x4822,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 9d 29 00 00       	call   3dd7 <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 31 48 00 	movl   $0x4831,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 81 29 00 00       	call   3dd7 <printf>

  unlink("lf1");
    1456:	c7 04 24 3b 48 00 00 	movl   $0x483b,(%esp)
    145d:	e8 16 28 00 00       	call   3c78 <unlink>
  unlink("lf2");
    1462:	c7 04 24 3f 48 00 00 	movl   $0x483f,(%esp)
    1469:	e8 0a 28 00 00       	call   3c78 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 3b 48 00 00 	movl   $0x483b,(%esp)
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 43 48 00 	movl   $0x4843,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 38 29 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 9f 47 00 	movl   $0x479f,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 56 48 00 	movl   $0x4856,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 ff 28 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 3f 48 00 00 	movl   $0x483f,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 a5 48 00 	movl   $0x48a5,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 50 28 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15ac:	c7 44 24 04 b6 48 00 	movl   $0x48b6,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 17 28 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 3f 48 00 	movl   $0x483f,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 3f 48 00 00 	movl   $0x483f,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 c7 48 00 	movl   $0x48c7,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 db 27 00 00       	call   3dd7 <printf>
    exit();
    15fc:	e8 27 26 00 00       	call   3c28 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 3f 48 00 00 	movl   $0x483f,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 3b 48 00 	movl   $0x483b,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 3f 48 00 00 	movl   $0x483f,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 e8 48 00 	movl   $0x48e8,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 9e 27 00 00       	call   3dd7 <printf>
    exit();
    1639:	e8 ea 25 00 00       	call   3c28 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 3b 48 00 	movl   $0x483b,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 0b 49 00 00 	movl   $0x490b,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 0d 49 00 	movl   $0x490d,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 6d 27 00 00       	call   3dd7 <printf>
    exit();
    166a:	e8 b9 25 00 00       	call   3c28 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 29 49 00 	movl   $0x4929,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 54 27 00 00       	call   3dd7 <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 36 49 00 	movl   $0x4936,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 38 27 00 00       	call   3dd7 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1741:	c7 04 24 46 49 00 00 	movl   $0x4946,(%esp)
    ...
    1772:	c7 44 24 04 49 49 00 	movl   $0x4949,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 51 26 00 00       	call   3dd7 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 0b 49 00 00 	movl   $0x490b,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 65 49 00 	movl   $0x4965,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 8b 25 00 00       	call   3dd7 <printf>
        exit();
    ...
    1868:	c7 44 24 04 7e 49 00 	movl   $0x497e,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 5b 25 00 00       	call   3dd7 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 9c 49 00 	movl   $0x499c,0x4(%esp)
    18cb:	00 
    18cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d3:	e8 ff 24 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 89 45 00 	movl   $0x4589,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 c3 24 00 00       	call   3dd7 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 cd 49 00 	movl   $0x49cd,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 a3 23 00 00       	call   3dd7 <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 db 49 00 	movl   $0x49db,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 87 23 00 00       	call   3dd7 <printf>

  unlink("x");
    1a50:	c7 04 24 42 45 00 00 	movl   $0x4542,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 89 45 00 	movl   $0x4589,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 59 23 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 42 45 00 00 	movl   $0x4542,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 42 45 00 	movl   $0x4542,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 42 45 00 00 	movl   $0x4542,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 f0 49 00 	movl   $0x49f0,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 7c 22 00 00       	call   3dd7 <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 ff 49 00 	movl   $0x49ff,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 5b 22 00 00       	call   3dd7 <printf>
  unlink("bd");
    1b7c:	c7 04 24 0c 4a 00 00 	movl   $0x4a0c,(%esp)
    1b83:	e8 f0 20 00 00       	call   3c78 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 0c 4a 00 00 	movl   $0x4a0c,(%esp)
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 0f 4a 00 	movl   $0x4a0f,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 1e 22 00 00       	call   3dd7 <printf>
    exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 0c 4a 00 00 	movl   $0x4a0c,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 39 4a 00 	movl   $0x4a39,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 28 21 00 00       	call   3dd7 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 4e 4a 00 	movl   $0x4a4e,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 02 21 00 00       	call   3dd7 <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 59 4a 00 	movl   $0x4a59,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 e6 20 00 00       	call   3dd7 <printf>

  unlink("ff");
    1cf1:	c7 04 24 66 4a 00 00 	movl   $0x4a66,(%esp)
    1cf8:	e8 7b 1f 00 00       	call   3c78 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 69 4a 00 00 	movl   $0x4a69,(%esp)
    1d04:	e8 87 1f 00 00       	call   3c90 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 6c 4a 00 	movl   $0x4a6c,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 b6 20 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 84 4a 00 00 	movl   $0x4a84,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 8a 4a 00 	movl   $0x4a8a,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 80 20 00 00       	call   3dd7 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 66 4a 00 	movl   $0x4a66,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 e8 4a 00 00 	movl   $0x4ae8,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 f1 4a 00 	movl   $0x4af1,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 d2 1f 00 00       	call   3dd7 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 09 4b 00 	movl   $0x4b09,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 0c 4b 00 00 	movl   $0x4b0c,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 18 4b 00 	movl   $0x4b18,0x4(%esp)
    1e54:	00 
    1e55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5c:	e8 76 1f 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e95:	c7 44 24 04 31 4b 00 	movl   $0x4b31,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 2e 1f 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 4c 4b 00 00 	movl   $0x4b4c,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 16 4c 00 	movl   $0x4c16,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 be 1d 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    203e:	c7 44 24 04 2e 4c 00 	movl   $0x4c2e,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 85 1d 00 00       	call   3dd7 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 a8 4e 00 	movl   $0x4ea8,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 a0 19 00 00       	call   3dd7 <printf>

  unlink("bigwrite");
    2437:	c7 04 24 b7 4e 00 00 	movl   $0x4eb7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 b7 4e 00 00 	movl   $0x4eb7,(%esp)
    ...
    246c:	c7 44 24 04 c0 4e 00 	movl   $0x4ec0,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 57 19 00 00       	call   3dd7 <printf>
      exit();
    ...
    24c1:	c7 44 24 04 d8 4e 00 	movl   $0x4ed8,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 02 19 00 00       	call   3dd7 <printf>
        exit();
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 b7 4e 00 00 	movl   $0x4eb7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 ea 4e 00 	movl   $0x4eea,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 b4 18 00 00       	call   3dd7 <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 f7 4e 00 	movl   $0x4ef7,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 98 18 00 00       	call   3dd7 <printf>

  unlink("bigfile");
    253f:	c7 04 24 05 4f 00 00 	movl   $0x4f05,(%esp)
    2546:	e8 2d 17 00 00       	call   3c78 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 05 4f 00 00 	movl   $0x4f05,(%esp)
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 0d 4f 00 	movl   $0x4f0d,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 5b 18 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25c7:	c7 44 24 04 23 4f 00 	movl   $0x4f23,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 fc 17 00 00       	call   3dd7 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 05 4f 00 00 	movl   $0x4f05,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 39 4f 00 	movl   $0x4f39,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 b1 17 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    265d:	c7 44 24 04 4e 4f 00 	movl   $0x4f4e,0x4(%esp)
    2664:	00 
    2665:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266c:	e8 66 17 00 00       	call   3dd7 <printf>
      exit();
    ...
    2685:	c7 44 24 04 63 4f 00 	movl   $0x4f63,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 3e 17 00 00       	call   3dd7 <printf>
      exit();
    ...
    26d2:	c7 44 24 04 77 4f 00 	movl   $0x4f77,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 f1 16 00 00       	call   3dd7 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 90 4f 00 	movl   $0x4f90,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 b4 16 00 00       	call   3dd7 <printf>
    exit();
    2723:	e8 00 15 00 00       	call   3c28 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 05 4f 00 00 	movl   $0x4f05,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 aa 4f 00 	movl   $0x4faa,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 8f 16 00 00       	call   3dd7 <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 48 50 00 00 	movl   $0x5048,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 78 50 00 	movl   $0x5078,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 f0 15 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 b8 50 00 00 	movl   $0x50b8,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 e8 50 00 	movl   $0x50e8,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 af 15 00 00       	call   3dd7 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 91 52 00 	movl   $0x5291,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 a5 13 00 00       	call   3dd7 <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 9e 52 00 00 	movl   $0x529e,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 a6 52 00 	movl   $0x52a6,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 74 13 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 d7 52 00 00 	movl   $0x52d7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 e2 52 00 	movl   $0x52e2,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 0a 13 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 d7 52 00 00 	movl   $0x52d7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 0b 49 00 00 	movl   $0x490b,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 7c 53 00 	movl   $0x537c,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 f2 11 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 9b 53 00 	movl   $0x539b,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 a3 11 00 00       	call   3dd7 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 af 53 00 	movl   $0x53af,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 7f 11 00 00       	call   3dd7 <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 bf 53 00 	movl   $0x53bf,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 63 11 00 00       	call   3dd7 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 ff 53 00 00 	movl   $0x53ff,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 ff 53 00 00 	movl   $0x53ff,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 22 52 00 00 	movl   $0x5222,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 02 54 00 	movl   $0x5402,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 5b 10 00 00       	call   3dd7 <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 16 54 00 	movl   $0x5416,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 3f 10 00 00       	call   3dd7 <printf>
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 24 54 00 	movl   $0x5424,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 f0 0f 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 46 54 00 	movl   $0x5446,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 ce 0f 00 00       	call   3dd7 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 5a 54 00 	movl   $0x545a,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 a1 0f 00 00       	call   3dd7 <printf>
    exit();
    2e36:	e8 ed 0d 00 00       	call   3c28 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 6d 54 00 	movl   $0x546d,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 88 0f 00 00       	call   3dd7 <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    2e60:	c7 44 24 04 7b 54 00 	movl   $0x547b,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 67 0f 00 00       	call   3dd7 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    ...
    2ec8:	c7 44 24 04 86 54 00 	movl   $0x5486,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 ff 0e 00 00       	call   3dd7 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    2f0c:	c7 44 24 04 a1 54 00 	movl   $0x54a1,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 bb 0e 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    2f4f:	c7 44 24 04 b8 54 00 	movl   $0x54b8,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 78 0e 00 00       	call   3dd7 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    2faf:	c7 44 24 04 d4 54 00 	movl   $0x54d4,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 18 0e 00 00       	call   3dd7 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    2ffa:	c7 44 24 04 12 55 00 	movl   $0x5512,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 cd 0d 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    ...
    303e:	c7 44 24 04 30 55 00 	movl   $0x5530,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 89 0d 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    ...
    30a5:	c7 44 24 04 68 55 00 	movl   $0x5568,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 22 0d 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    30c9:	c7 44 24 04 90 55 00 	movl   $0x5590,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 fe 0c 00 00       	call   3dd7 <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    ...
    3128:	c7 44 24 04 c0 55 00 	movl   $0x55c0,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 9f 0c 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3161:	c7 44 24 04 89 45 00 	movl   $0x4589,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 66 0c 00 00       	call   3dd7 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 e6 0b 00 00       	call   3dd7 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 42 45 00 	movl   $0x4542,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    32e9:	c7 44 24 04 fa 55 00 	movl   $0x55fa,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 de 0a 00 00       	call   3dd7 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3331:	c7 44 24 04 15 56 00 	movl   $0x5615,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 96 0a 00 00       	call   3dd7 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3380:	c7 44 24 04 23 56 00 	movl   $0x5623,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 47 0a 00 00       	call   3dd7 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 32 56 00 00 	movl   $0x5632,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3403:	c7 44 24 04 3d 56 00 	movl   $0x563d,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 c4 09 00 00       	call   3dd7 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3430:	c7 44 24 04 56 56 00 	movl   $0x5656,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 97 09 00 00       	call   3dd7 <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    344d:	c7 44 24 04 63 56 00 	movl   $0x5663,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 7a 09 00 00       	call   3dd7 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3475:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    347a:	c7 44 24 04 6d 56 00 	movl   $0x566d,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 4d 09 00 00       	call   3dd7 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    34a2:	c7 44 24 04 7e 56 00 	movl   $0x567e,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 25 09 00 00       	call   3dd7 <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 8b 56 00 00 	movl   $0x568b,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 20 5f 00 00 	movl   $0x5698,0x5f20(,%eax,4)
    34eb:	98 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3503:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3508:	c7 44 24 04 75 57 00 	movl   $0x5775,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 bf 08 00 00       	call   3dd7 <printf>
    exec("echo", args);
    3518:	c7 44 24 04 20 5f 00 	movl   $0x5f20,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 9c 41 00 00 	movl   $0x419c,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3531:	c7 44 24 04 82 57 00 	movl   $0x5782,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 96 08 00 00       	call   3dd7 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 8b 56 00 00 	movl   $0x568b,(%esp)
    ...
    356e:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    3573:	c7 44 24 04 92 57 00 	movl   $0x5792,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 54 08 00 00       	call   3dd7 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 8b 56 00 00 	movl   $0x568b,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 f4 5e 00 00       	mov    0x5ef4,%eax
    35af:	c7 44 24 04 ab 57 00 	movl   $0x57ab,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 18 08 00 00       	call   3dd7 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 8b 56 00 00 	movl   $0x568b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 c0 57 00 	movl   $0x57c0,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 d8 07 00 00       	call   3dd7 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 cd 57 00 	movl   $0x57cd,0x4(%esp)
    36e2:	00 
    36e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36ea:	e8 e8 06 00 00       	call   3dd7 <printf>
    ...
    3712:	c7 44 24 04 d9 57 00 	movl   $0x57d9,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 b1 06 00 00       	call   3dd7 <printf>
      break;
    ...
    376a:	c7 44 24 04 e9 57 00 	movl   $0x57e9,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 59 06 00 00       	call   3dd7 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 f9 57 00 	movl   $0x57f9,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 3e 05 00 00       	call   3dd7 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 f8 5e 00 00       	mov    0x5ef8,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 f8 5e 00 00       	mov    %eax,0x5ef8
  return randstate;
    38b7:	a1 f8 5e 00 00       	mov    0x5ef8,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 23 58 00 00 	movl   $0x5823,(%esp)
...
putc(int fd, char c)
{
    ...
    3d06:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d09:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3d0c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3d13:	00 
    3d14:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3d17:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d1b:	8b 45 08             	mov    0x8(%ebp),%eax
    3d1e:	89 04 24             	mov    %eax,(%esp)
    3d21:	e8 22 ff ff ff       	call   3c48 <write>
}
    3d26:	c9                   	leave  
    3d27:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3d2e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d35:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d39:	74 17                	je     3d52 <printint+0x2a>
    3d3b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d3f:	79 11                	jns    3d52 <printint+0x2a>
    neg = 1;
    3d41:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d48:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d4b:	f7 d8                	neg    %eax
    3d4d:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d50:	eb 06                	jmp    3d58 <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
    3d58:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d5f:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3d62:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d65:	ba 00 00 00 00       	mov    $0x0,%edx
    3d6a:	f7 f1                	div    %ecx
    3d6c:	89 d0                	mov    %edx,%eax
    3d6e:	0f b6 90 fc 5e 00 00 	movzbl 0x5efc(%eax),%edx
    3d75:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d78:	03 45 f4             	add    -0xc(%ebp),%eax
    3d7b:	88 10                	mov    %dl,(%eax)
    3d7d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d81:	8b 55 10             	mov    0x10(%ebp),%edx
    3d84:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d87:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d8a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d8f:	f7 75 d4             	divl   -0x2c(%ebp)
    3d92:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d95:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d99:	75 c4                	jne    3d5f <printint+0x37>
  if(neg)
    3d9b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d9f:	74 2a                	je     3dcb <printint+0xa3>
    buf[i++] = '-';
    3da1:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3da4:	03 45 f4             	add    -0xc(%ebp),%eax
    3da7:	c6 00 2d             	movb   $0x2d,(%eax)
    3daa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3dae:	eb 1b                	jmp    3dcb <printint+0xa3>
    putc(fd, buf[i]);
    3db0:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3db3:	03 45 f4             	add    -0xc(%ebp),%eax
    3db6:	0f b6 00             	movzbl (%eax),%eax
    3db9:	0f be c0             	movsbl %al,%eax
    3dbc:	89 44 24 04          	mov    %eax,0x4(%esp)
    3dc0:	8b 45 08             	mov    0x8(%ebp),%eax
    3dc3:	89 04 24             	mov    %eax,(%esp)
    3dc6:	e8 35 ff ff ff       	call   3d00 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dcb:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3dcf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3dd3:	79 db                	jns    3db0 <printint+0x88>
    putc(fd, buf[i]);
}
    3dd5:	c9                   	leave  
    3dd6:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3dda:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3ddd:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3de4:	8d 45 0c             	lea    0xc(%ebp),%eax
    3de7:	83 c0 04             	add    $0x4,%eax
    3dea:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3ded:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3df4:	e9 7d 01 00 00       	jmp    3f76 <printf+0x19f>
    c = fmt[i] & 0xff;
    3df9:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3dff:	01 d0                	add    %edx,%eax
    3e01:	0f b6 00             	movzbl (%eax),%eax
    3e04:	0f be c0             	movsbl %al,%eax
    3e07:	25 ff 00 00 00       	and    $0xff,%eax
    3e0c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3e0f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3e13:	75 2c                	jne    3e41 <printf+0x6a>
      if(c == '%'){
    3e15:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3e19:	75 0c                	jne    3e27 <printf+0x50>
        state = '%';
    3e1b:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e22:	e9 4b 01 00 00       	jmp    3f72 <printf+0x19b>
      } else {
        putc(fd, c);
    3e27:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e2a:	0f be c0             	movsbl %al,%eax
    3e2d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e31:	8b 45 08             	mov    0x8(%ebp),%eax
    3e34:	89 04 24             	mov    %eax,(%esp)
    3e37:	e8 c4 fe ff ff       	call   3d00 <putc>
    3e3c:	e9 31 01 00 00       	jmp    3f72 <printf+0x19b>
      }
    } else if(state == '%'){
    3e41:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e45:	0f 85 27 01 00 00    	jne    3f72 <printf+0x19b>
      if(c == 'd'){
    3e4b:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e4f:	75 2d                	jne    3e7e <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e51:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e54:	8b 00                	mov    (%eax),%eax
    3e56:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e5d:	00 
    3e5e:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e65:	00 
    3e66:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e6a:	8b 45 08             	mov    0x8(%ebp),%eax
    3e6d:	89 04 24             	mov    %eax,(%esp)
    3e70:	e8 b3 fe ff ff       	call   3d28 <printint>
        ap++;
    3e75:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e79:	e9 ed 00 00 00       	jmp    3f6b <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e7e:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e82:	74 06                	je     3e8a <printf+0xb3>
    3e84:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e88:	75 2d                	jne    3eb7 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e8a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e8d:	8b 00                	mov    (%eax),%eax
    3e8f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e96:	00 
    3e97:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e9e:	00 
    3e9f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ea3:	8b 45 08             	mov    0x8(%ebp),%eax
    3ea6:	89 04 24             	mov    %eax,(%esp)
    3ea9:	e8 7a fe ff ff       	call   3d28 <printint>
        ap++;
    3eae:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3eb2:	e9 b4 00 00 00       	jmp    3f6b <printf+0x194>
      } else if(c == 's'){
    3eb7:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3ebb:	75 46                	jne    3f03 <printf+0x12c>
        s = (char*)*ap;
    3ebd:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3ec0:	8b 00                	mov    (%eax),%eax
    3ec2:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3ec5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3ec9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ecd:	75 27                	jne    3ef6 <printf+0x11f>
          s = "(null)";
    3ecf:	c7 45 f4 5e 58 00 00 	movl   $0x585e,-0xc(%ebp)
        while(*s != 0){
    3ed6:	eb 1e                	jmp    3ef6 <printf+0x11f>
          putc(fd, *s);
    ...
    3eeb:	e8 10 fe ff ff       	call   3d00 <putc>
          s++;
    3ef0:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3ef4:	eb 01                	jmp    3ef7 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
        ...
        while(*s != 0){
    3ef6:	90                   	nop
    3ef7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3efa:	0f b6 00             	movzbl (%eax),%eax
    3efd:	84 c0                	test   %al,%al
    3eff:	75 d7                	jne    3ed8 <printf+0x101>
    3f01:	eb 68                	jmp    3f6b <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3f03:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3f07:	75 1d                	jne    3f26 <printf+0x14f>
        putc(fd, *ap);
    3f09:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f0c:	8b 00                	mov    (%eax),%eax
    3f0e:	0f be c0             	movsbl %al,%eax
    3f11:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f15:	8b 45 08             	mov    0x8(%ebp),%eax
    3f18:	89 04 24             	mov    %eax,(%esp)
    3f1b:	e8 e0 fd ff ff       	call   3d00 <putc>
        ap++;
    3f20:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f24:	eb 45                	jmp    3f6b <printf+0x194>
      } else if(c == '%'){
    3f26:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f2a:	75 17                	jne    3f43 <printf+0x16c>
        putc(fd, c);
    3f2c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f2f:	0f be c0             	movsbl %al,%eax
    3f32:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f36:	8b 45 08             	mov    0x8(%ebp),%eax
    3f39:	89 04 24             	mov    %eax,(%esp)
    3f3c:	e8 bf fd ff ff       	call   3d00 <putc>
    3f41:	eb 28                	jmp    3f6b <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f43:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f4a:	00 
    3f4b:	8b 45 08             	mov    0x8(%ebp),%eax
    3f4e:	89 04 24             	mov    %eax,(%esp)
    3f51:	e8 aa fd ff ff       	call   3d00 <putc>
        putc(fd, c);
    3f56:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f59:	0f be c0             	movsbl %al,%eax
    3f5c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f60:	8b 45 08             	mov    0x8(%ebp),%eax
    3f63:	89 04 24             	mov    %eax,(%esp)
    3f66:	e8 95 fd ff ff       	call   3d00 <putc>
      }
      state = 0;
    3f6b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f72:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    3f76:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f79:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f7c:	01 d0                	add    %edx,%eax
    3f7e:	0f b6 00             	movzbl (%eax),%eax
    3f81:	84 c0                	test   %al,%al
    3f83:	0f 85 70 fe ff ff    	jne    3df9 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    3f8f:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3f92:	8b 45 08             	mov    0x8(%ebp),%eax
    3f95:	83 e8 08             	sub    $0x8,%eax
    3f98:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f9b:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    3fa0:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3fa3:	eb 24                	jmp    3fc9 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3fa5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fa8:	8b 00                	mov    (%eax),%eax
    3faa:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fad:	77 12                	ja     3fc1 <free+0x35>
    3faf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fb2:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fb5:	77 24                	ja     3fdb <free+0x4f>
    3fb7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fba:	8b 00                	mov    (%eax),%eax
    3fbc:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fbf:	77 1a                	ja     3fdb <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3fc6:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3fc9:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fcc:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fcf:	76 d4                	jbe    3fa5 <free+0x19>
    3fd1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fd4:	8b 00                	mov    (%eax),%eax
    3fd6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fd9:	76 ca                	jbe    3fa5 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3fdb:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fde:	8b 40 04             	mov    0x4(%eax),%eax
    3fe1:	c1 e0 03             	shl    $0x3,%eax
    3fe4:	89 c2                	mov    %eax,%edx
    3fe6:	03 55 f8             	add    -0x8(%ebp),%edx
    3fe9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fec:	8b 00                	mov    (%eax),%eax
    3fee:	39 c2                	cmp    %eax,%edx
    3ff0:	75 24                	jne    4016 <free+0x8a>
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    4069:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4070:	77 07                	ja     4079 <morecore+0x16>
    nu = 4096;
    4072:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4079:	8b 45 08             	mov    0x8(%ebp),%eax
    407c:	c1 e0 03             	shl    $0x3,%eax
    407f:	89 04 24             	mov    %eax,(%esp)
    4082:	e8 29 fc ff ff       	call   3cb0 <sbrk>
    4087:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    408a:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    408e:	75 07                	jne    4097 <morecore+0x34>
    return 0;
    4090:	b8 00 00 00 00       	mov    $0x0,%eax
    4095:	eb 22                	jmp    40b9 <morecore+0x56>
  hp = (Header*)p;
    4097:	8b 45 f4             	mov    -0xc(%ebp),%eax
    409a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    409d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40a0:	8b 55 08             	mov    0x8(%ebp),%edx
    40a3:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    40a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40a9:	83 c0 08             	add    $0x8,%eax
    40ac:	89 04 24             	mov    %eax,(%esp)
    40af:	e8 d8 fe ff ff       	call   3f8c <free>
  return freep;
    40b4:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
}
    40b9:	c9                   	leave  
    40ba:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    40c4:	83 c0 07             	add    $0x7,%eax
    40c7:	c1 e8 03             	shr    $0x3,%eax
    40ca:	83 c0 01             	add    $0x1,%eax
    40cd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40d0:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    40d5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40d8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40dc:	75 23                	jne    4101 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40de:	c7 45 f0 a0 5f 00 00 	movl   $0x5fa0,-0x10(%ebp)
    40e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40e8:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
    40ed:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    40f2:	a3 a0 5f 00 00       	mov    %eax,0x5fa0
    base.s.size = 0;
    40f7:	c7 05 a4 5f 00 00 00 	movl   $0x0,0x5fa4
    40fe:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4101:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4104:	8b 00                	mov    (%eax),%eax
    4106:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4109:	8b 45 f4             	mov    -0xc(%ebp),%eax
    410c:	8b 40 04             	mov    0x4(%eax),%eax
    410f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4112:	72 4d                	jb     4161 <malloc+0xa6>
      if(p->s.size == nunits)
    4114:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4117:	8b 40 04             	mov    0x4(%eax),%eax
    411a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    411d:	75 0c                	jne    412b <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    411f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4122:	8b 10                	mov    (%eax),%edx
    4124:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4127:	89 10                	mov    %edx,(%eax)
    4129:	eb 26                	jmp    4151 <malloc+0x96>
      else {
        p->s.size -= nunits;
    412b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412e:	8b 40 04             	mov    0x4(%eax),%eax
    4131:	89 c2                	mov    %eax,%edx
    4133:	2b 55 ec             	sub    -0x14(%ebp),%edx
    4136:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4139:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    413c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    413f:	8b 40 04             	mov    0x4(%eax),%eax
    4142:	c1 e0 03             	shl    $0x3,%eax
    4145:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4148:	8b 45 f4             	mov    -0xc(%ebp),%eax
    414b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    414e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4151:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4154:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
      return (void*)(p + 1);
    4159:	8b 45 f4             	mov    -0xc(%ebp),%eax
    415c:	83 c0 08             	add    $0x8,%eax
    415f:	eb 38                	jmp    4199 <malloc+0xde>
    }
    if(p == freep)
    4161:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    4166:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4169:	75 1b                	jne    4186 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    416b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    416e:	89 04 24             	mov    %eax,(%esp)
    4171:	e8 ed fe ff ff       	call   4063 <morecore>
    4176:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4179:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    417d:	75 07                	jne    4186 <malloc+0xcb>
        return 0;
    417f:	b8 00 00 00 00       	mov    $0x0,%eax
    4184:	eb 13                	jmp    4199 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4186:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4189:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    4194:	e9 70 ff ff ff       	jmp    4109 <malloc+0x4e>
}
    4199:	c9                   	leave  
    419a:	c3                   	ret    
