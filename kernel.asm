...
8010003a:	c7 44 24 04 5c 97 10 	movl   $0x8010975c,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 20 d7 10 80 	movl   $0x8010d720,(%esp)
80100049:	e8 b0 5b 00 00       	call   80105bfe <initlock>
...
801000bd:	e8 5d 5b 00 00       	call   80105c1f <acquire>
...
80100104:	e8 b1 5b 00 00       	call   80105cba <release>
        return b;
...
8010011f:	e8 b9 55 00 00       	call   801056dd <sleep>
      goto loop;
...
8010017c:	e8 39 5b 00 00       	call   80105cba <release>
      return b;
...
80100198:	c7 04 24 63 97 10 80 	movl   $0x80109763,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 74 97 10 80 	movl   $0x80109774,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 7b 97 10 80 	movl   $0x8010977b,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 20 d7 10 80 	movl   $0x8010d720,(%esp)
8010023c:	e8 de 59 00 00       	call   80105c1f <acquire>
...
8010029d:	e8 50 56 00 00       	call   801058f2 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 20 d7 10 80 	movl   $0x8010d720,(%esp)
801002a9:	e8 0c 5a 00 00       	call   80105cba <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 5e 58 00 00       	call   80105c1f <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 82 97 10 80 	movl   $0x80109782,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 8b 97 10 80 	movl   $0x8010978b,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 7f 57 00 00       	call   80105cba <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 92 97 10 80 	movl   $0x80109792,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 a1 97 10 80 	movl   $0x801097a1,(%esp)
...
80100592:	e8 72 57 00 00       	call   80105d09 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 a3 97 10 80 	movl   $0x801097a3,(%esp)
...
80100776:	e8 46 76 00 00       	call   80107dc1 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 3a 76 00 00       	call   80107dc1 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 2e 76 00 00       	call   80107dc1 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 21 76 00 00       	call   80107dc1 <uartputc>
  cgaputc(c);
...
801007ba:	e8 60 54 00 00       	call   80105c1f <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 f8 51 00 00       	call   801059e7 <procdump>
      break;
...
801008f7:	e8 f6 4f 00 00       	call   801058f2 <wakeup>
        }
      }
      break;
...
8010091e:	e8 97 53 00 00       	call   80105cba <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 d7 52 00 00       	call   80105c1f <acquire>
  while(n > 0){
...
80100961:	e8 54 53 00 00       	call   80105cba <release>
        ilock(ip);
...
8010098a:	e8 4e 4d 00 00       	call   801056dd <sleep>
...
80100a08:	e8 ad 52 00 00       	call   80105cba <release>
  ilock(ip);
...
80100a3e:	e8 dc 51 00 00       	call   80105c1f <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 3d 52 00 00       	call   80105cba <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 a7 97 10 	movl   $0x801097a7,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 57 51 00 00       	call   80105bfe <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 af 97 10 	movl   $0x801097af,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 60 ee 10 80 	movl   $0x8010ee60,(%esp)
80100ab6:	e8 43 51 00 00       	call   80105bfe <initlock>
...
80100b7b:	e8 85 83 00 00       	call   80108f05 <setupkvm>
...
80100c14:	e8 be 86 00 00       	call   801092d7 <allocuvm>
...
80100c51:	e8 92 85 00 00       	call   801091e8 <loaduvm>
...
80100cbc:	e8 16 86 00 00       	call   801092d7 <allocuvm>
...
80100ce0:	e8 16 88 00 00       	call   801094fb <clearpteu>
  sp = sz;
...
80100d57:	e8 53 89 00 00       	call   801096af <copyout>
...
80100df7:	e8 b3 88 00 00       	call   801096af <copyout>
...
80100ea0:	e8 51 81 00 00       	call   80108ff6 <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 bd 85 00 00       	call   8010946d <freevm>
  return 0;
...
80100ee2:	e8 86 85 00 00       	call   8010946d <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 b5 97 10 	movl   $0x801097b5,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 20 ef 10 80 	movl   $0x8010ef20,(%esp)
80100f15:	e8 e4 4c 00 00       	call   80105bfe <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 f1 4c 00 00       	call   80105c1f <acquire>
...
80100f52:	e8 63 4d 00 00       	call   80105cba <release>
      return f;
...
80100f70:	e8 45 4d 00 00       	call   80105cba <release>
  return 0;
...
80100f89:	e8 91 4c 00 00       	call   80105c1f <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 bc 97 10 80 	movl   $0x801097bc,(%esp)
...
80100fba:	e8 fb 4c 00 00       	call   80105cba <release>
  return f;
...
80100fd1:	e8 49 4c 00 00       	call   80105c1f <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 c4 97 10 80 	movl   $0x801097c4,(%esp)
...
8010100c:	e8 a9 4c 00 00       	call   80105cba <release>
    return;
...
80101056:	e8 5f 4c 00 00       	call   80105cba <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 ce 97 10 80 	movl   $0x801097ce,(%esp)
...
801012a3:	c7 04 24 d7 97 10 80 	movl   $0x801097d7,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 e7 97 10 80 	movl   $0x801097e7,(%esp)
...
80101320:	e8 54 4c 00 00       	call   80105f79 <memmove>
  brelse(bp);
...
80101366:	e8 3b 4b 00 00       	call   80105ea6 <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 f1 97 10 80 	movl   $0x801097f1,(%esp)
...
80101565:	c7 04 24 07 98 10 80 	movl   $0x80109807,(%esp)
...
801015b9:	c7 44 24 04 1a 98 10 	movl   $0x8010981a,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 20 f9 10 80 	movl   $0x8010f920,(%esp)
801015c8:	e8 31 46 00 00       	call   80105bfe <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 57 48 00 00       	call   80105ea6 <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 21 98 10 80 	movl   $0x80109821,(%esp)
...
80101747:	e8 2d 48 00 00       	call   80105f79 <memmove>
  log_write(bp);
...
80101771:	e8 a9 44 00 00       	call   80105c1f <acquire>
...
801017bb:	e8 fa 44 00 00       	call   80105cba <release>
      return ip;
...
801017ee:	c7 04 24 33 98 10 80 	movl   $0x80109833,(%esp)
...
8010182c:	e8 89 44 00 00       	call   80105cba <release>
...
80101843:	e8 d7 43 00 00       	call   80105c1f <acquire>
  ip->ref++;
...
8010185e:	e8 57 44 00 00       	call   80105cba <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 43 98 10 80 	movl   $0x80109843,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 20 f9 10 80 	movl   $0x8010f920,(%esp)
80101891:	e8 89 43 00 00       	call   80105c1f <acquire>
...
801018a6:	e8 32 3e 00 00       	call   801056dd <sleep>
...
801018d0:	e8 e5 43 00 00       	call   80105cba <release>
...
8010197b:	e8 f9 45 00 00       	call   80105f79 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 49 98 10 80 	movl   $0x80109849,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 58 98 10 80 	movl   $0x80109858,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>
  acquire(&icache.lock);
801019e5:	c7 04 24 20 f9 10 80 	movl   $0x8010f920,(%esp)
801019ec:	e8 2e 42 00 00       	call   80105c1f <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 e5 3e 00 00       	call   801058f2 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 20 f9 10 80 	movl   $0x8010f920,(%esp)
80101a14:	e8 a1 42 00 00       	call   80105cba <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 f2 41 00 00       	call   80105c1f <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 60 98 10 80 	movl   $0x80109860,(%esp)
...
80101a8a:	e8 2b 42 00 00       	call   80105cba <release>
    itrunc(ip);
...
80101ab5:	e8 65 41 00 00       	call   80105c1f <acquire>
    ip->flags = 0;
...
80101aca:	e8 23 3e 00 00       	call   801058f2 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 d0 41 00 00       	call   80105cba <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 6a 98 10 80 	movl   $0x8010986a,(%esp)
...
80101e92:	e8 e2 40 00 00       	call   80105f79 <memmove>
    brelse(bp);
...
80101ff8:	e8 7c 3f 00 00       	call   80105f79 <memmove>
    log_write(bp);
...
8010207a:	e8 9e 3f 00 00       	call   8010601d <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 7d 98 10 80 	movl   $0x8010987d,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 8f 98 10 80 	movl   $0x8010988f,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 8f 98 10 80 	movl   $0x8010988f,(%esp)
...
801021fc:	e8 74 3e 00 00       	call   80106075 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 9c 98 10 80 	movl   $0x8010989c,(%esp)
...
801022b5:	e8 bf 3c 00 00       	call   80105f79 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 a4 3c 00 00       	call   80105f79 <memmove>
    name[len] = 0;
...
80102532:	c7 44 24 04 a4 98 10 	movl   $0x801098a4,0x4(%esp)
80102539:	80 
8010253a:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
80102541:	e8 b8 36 00 00       	call   80105bfe <initlock>
  picenable(IRQ_IDE);
...
801025dc:	75 0c                	jne    801025ea <idestart+0x18>
    panic("idestart");
801025de:	c7 04 24 a8 98 10 80 	movl   $0x801098a8,(%esp)
...
80102704:	e8 16 35 00 00       	call   80105c1f <acquire>
  if((b = idequeue) == 0){
...
8010271e:	e8 97 35 00 00       	call   80105cba <release>
...
801027a8:	e8 0d 35 00 00       	call   80105cba <release>
}
801027ad:	c9                   	leave  
801027ae:	c3                   	ret    
...
801027c1:	c7 04 24 b1 98 10 80 	movl   $0x801098b1,(%esp)
...
801027da:	c7 04 24 c5 98 10 80 	movl   $0x801098c5,(%esp)
...
8010285e:	e8 57 34 00 00       	call   80105cba <release>
	sti();
80102863:	e8 7a fc ff ff       	call   801024e2 <sti>
	acquire(&idelock); 
80102868:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
8010286f:	e8 ab 33 00 00       	call   80105c1f <acquire>
...
8010288b:	e8 2a 34 00 00       	call   80105cba <release>
}
80102890:	c9                   	leave  
80102891:	c3                   	ret    
	...
...
8010291a:	c7 04 24 f8 98 10 80 	movl   $0x801098f8,(%esp)
...
801029e8:	c7 44 24 04 2c 99 10 	movl   $0x8010992c,0x4(%esp)
801029ef:	80 
801029f0:	c7 04 24 00 09 11 80 	movl   $0x80110900,(%esp)
801029f7:	e8 02 32 00 00       	call   80105bfe <initlock>
  kmem.use_lock = 0;
...
80102aa2:	76 0c                	jbe    80102ab0 <kfree+0x39>
    panic("kfree");
80102aa4:	c7 04 24 31 99 10 80 	movl   $0x80109931,(%esp)
...
80102ac6:	e8 db 33 00 00       	call   80105ea6 <memset>
...
80102adb:	e8 3f 31 00 00       	call   80105c1f <acquire>
  r = (struct run*)v;
...
80102b09:	e8 ac 31 00 00       	call   80105cba <release>
}
80102b0e:	c9                   	leave  
80102b0f:	c3                   	ret    
...
80102b26:	e8 f4 30 00 00       	call   80105c1f <acquire>
  r = kmem.freelist;
...
80102b53:	e8 62 31 00 00       	call   80105cba <release>
  return (char*)r;
...
80102b72:	c7 04 24 38 99 10 80 	movl   $0x80109938,(%esp)
...
80102db8:	e8 62 2e 00 00       	call   80105c1f <acquire>
...
80102f00:	e8 6c 5f 00 00       	call   80108e71 <mappages>
		break;
...
80102f3a:	e8 32 5f 00 00       	call   80108e71 <mappages>
		break;
...
80102fab:	e8 0a 2d 00 00       	call   80105cba <release>
  return ans;
...
80102fd6:	e8 00 5e 00 00       	call   80108ddb <walkpgdir>
...
80102ffa:	e8 20 2c 00 00       	call   80105c1f <acquire>
...
8010305f:	c7 04 24 70 99 10 80 	movl   $0x80109970,(%esp)
...
801030fc:	c7 04 24 b4 99 10 80 	movl   $0x801099b4,(%esp)
...
80103127:	e8 8e 2b 00 00       	call   80105cba <release>
...
8010315c:	e8 7a 5c 00 00       	call   80108ddb <walkpgdir>
...
801031aa:	e8 70 2a 00 00       	call   80105c1f <acquire>
...
80103206:	e8 d0 5b 00 00       	call   80108ddb <walkpgdir>
...
80103298:	e8 3e 5b 00 00       	call   80108ddb <walkpgdir>
...
80103340:	e8 75 29 00 00       	call   80105cba <release>
}
80103345:	c9                   	leave  
80103346:	c3                   	ret    
	...
...
801036ba:	c7 04 24 f0 99 10 80 	movl   $0x801099f0,(%esp)
...
80103818:	c7 44 24 04 1c 9a 10 	movl   $0x80109a1c,0x4(%esp)
8010381f:	80 
80103820:	c7 04 24 e0 70 12 80 	movl   $0x801270e0,(%esp)
80103827:	e8 d2 23 00 00       	call   80105bfe <initlock>
  readsb(ROOTDEV, &sb);
...
801038da:	e8 9a 26 00 00       	call   80105f79 <memmove>
...
80103a2c:	e8 ee 21 00 00       	call   80105c1f <acquire>
...
80103a3a:	e8 7b 22 00 00       	call   80105cba <release>
    sti();
80103a3f:	e8 c8 fd ff ff       	call   8010380c <sti>
    acquire(&log.lock);
80103a44:	c7 04 24 e0 70 12 80 	movl   $0x801270e0,(%esp)
80103a4b:	e8 cf 21 00 00       	call   80105c1f <acquire>
...
80103a6a:	e8 4b 22 00 00       	call   80105cba <release>
}
80103a6f:	c9                   	leave  
80103a70:	c3                   	ret    
...
80103aa0:	e8 7a 21 00 00       	call   80105c1f <acquire>
  log.busy = 0;
...
80103ab6:	e8 ff 21 00 00       	call   80105cba <release>
}
80103abb:	c9                   	leave  
80103abc:	c3                   	ret    
...
80103adf:	c7 04 24 20 9a 10 80 	movl   $0x80109a20,(%esp)
...
80103af4:	c7 04 24 36 9a 10 80 	movl   $0x80109a36,(%esp)
...
80103b83:	e8 f1 23 00 00       	call   80105f79 <memmove>
  bwrite(lbuf);
...
80103c24:	e8 99 53 00 00       	call   80108fc2 <kvmalloc>
...
80103c3b:	e8 25 4d 00 00       	call   80108965 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103c50:	c7 04 24 4d 9a 10 80 	movl   $0x80109a4d,(%esp)
...
80103c6b:	e8 40 40 00 00       	call   80107cb0 <uartinit>
  pinit();         // process table
80103c70:	e8 a3 0b 00 00       	call   80104818 <pinit>
  tvinit();        // trap vectors
80103c75:	e8 d9 3b 00 00       	call   80107853 <tvinit>
  binit();         // buffer cache
...
80103c97:	e8 fa 3a 00 00       	call   80107796 <timerinit>
...
80103cb5:	e8 46 12 00 00       	call   80104f00 <userinit>
...
80103cc2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
80103cc5:	e8 0f 53 00 00       	call   80108fd9 <switchkvm>
  seginit();
80103cca:	e8 96 4c 00 00       	call   80108965 <seginit>
  lapicinit(cpunum());
...
80103cf7:	c7 04 24 64 9a 10 80 	movl   $0x80109a64,(%esp)
80103cfe:	e8 9e c6 ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103d03:	e8 bf 3c 00 00       	call   801079c7 <idtinit>
...
80103d23:	e8 09 18 00 00       	call   80105531 <scheduler>
...
80103d55:	e8 1f 22 00 00       	call   80105f79 <memmove>
...
80103ee3:	00 
80103ee4:	c7 44 24 04 78 9a 10 	movl   $0x80109a78,0x4(%esp)
80103eeb:	80 
80103eec:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103eef:	89 04 24             	mov    %eax,(%esp)
80103ef2:	e8 26 20 00 00       	call   80105f1d <memcmp>
...
80104024:	00 
80104025:	c7 44 24 04 7d 9a 10 	movl   $0x80109a7d,0x4(%esp)
8010402c:	80 
8010402d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104030:	89 04 24             	mov    %eax,(%esp)
80104033:	e8 e5 1e 00 00       	call   80105f1d <memcmp>
...
801040fe:	8b 04 85 c0 9a 10 80 	mov    -0x7fef6540(,%eax,4),%eax
...
80104137:	c7 04 24 82 9a 10 80 	movl   $0x80109a82,(%esp)
...
801041ca:	c7 04 24 a0 9a 10 80 	movl   $0x80109aa0,(%esp)
...
801044cf:	c7 44 24 04 d4 9a 10 	movl   $0x80109ad4,0x4(%esp)
801044d6:	80 
801044d7:	89 04 24             	mov    %eax,(%esp)
801044da:	e8 1f 17 00 00       	call   80105bfe <initlock>
  (*f0)->type = FD_PIPE;
...
80104587:	e8 93 16 00 00       	call   80105c1f <acquire>
  if(writable){
...
801045aa:	e8 43 13 00 00       	call   801058f2 <wakeup>
...
801045c9:	e8 24 13 00 00       	call   801058f2 <wakeup>
  }
...
801045ee:	e8 c7 16 00 00       	call   80105cba <release>
    kfree((char*)p);
...
80104606:	e8 af 16 00 00       	call   80105cba <release>
}
8010460b:	c9                   	leave  
8010460c:	c3                   	ret    
...
8010461a:	e8 00 16 00 00       	call   80105c1f <acquire>
  for(i = 0; i < n; i++){
...
8010464b:	e8 6a 16 00 00       	call   80105cba <release>
        return -1;
...
80104665:	e8 88 12 00 00       	call   801058f2 <wakeup>
...
8010467d:	e8 5b 10 00 00       	call   801056dd <sleep>
...
801046e4:	e8 09 12 00 00       	call   801058f2 <wakeup>
  release(&p->lock);
801046e9:	8b 45 08             	mov    0x8(%ebp),%eax
801046ec:	89 04 24             	mov    %eax,(%esp)
801046ef:	e8 c6 15 00 00       	call   80105cba <release>
  return n;
...
8010470a:	e8 10 15 00 00       	call   80105c1f <acquire>
...
80104724:	e8 91 15 00 00       	call   80105cba <release>
      return -1;
...
80104746:	e8 92 0f 00 00       	call   801056dd <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801047d6:	e8 17 11 00 00       	call   801058f2 <wakeup>
  release(&p->lock);
801047db:	8b 45 08             	mov    0x8(%ebp),%eax
801047de:	89 04 24             	mov    %eax,(%esp)
801047e1:	e8 d4 14 00 00       	call   80105cba <release>
  return i;
...
8010481e:	c7 44 24 04 dc 9a 10 	movl   $0x80109adc,0x4(%esp)
80104825:	80 
80104826:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010482d:	e8 cc 13 00 00       	call   80105bfe <initlock>
  initlock(&swaplock, "swaplock");
80104832:	c7 44 24 04 e3 9a 10 	movl   $0x80109ae3,0x4(%esp)
80104839:	80 
8010483a:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80104841:	e8 b8 13 00 00       	call   80105bfe <initlock>
  initlock(&wakeuplock, "wakeuplock");
80104846:	c7 44 24 04 ec 9a 10 	movl   $0x80109aec,0x4(%esp)
8010484d:	80 
8010484e:	c7 04 24 e0 c6 10 80 	movl   $0x8010c6e0,(%esp)
80104855:	e8 a4 13 00 00       	call   80105bfe <initlock>
}
8010485a:	c9                   	leave  
8010485b:	c3                   	ret    
...
80104869:	e8 b1 13 00 00       	call   80105c1f <acquire>
...
80104898:	e8 1d 14 00 00       	call   80105cba <release>
  return 0;
...
801048cc:	e8 e9 13 00 00       	call   80105cba <release>
...
80104919:	ba 08 78 10 80       	mov    $0x80107808,%edx
...
80104949:	e8 58 15 00 00       	call   80105ea6 <memset>
  p->context->eip = (uint)forkret;
8010494e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104951:	8b 40 1c             	mov    0x1c(%eax),%eax
80104954:	ba b1 56 10 80       	mov    $0x801056b1,%edx
...
801049f9:	e8 d8 16 00 00       	call   801060d6 <safestrcpy>
  return p;
...
80104a22:	e8 de 44 00 00       	call   80108f05 <setupkvm>
...
80104a37:	c7 04 24 f7 9a 10 80 	movl   $0x80109af7,(%esp)
...
80104a71:	e8 30 14 00 00       	call   80105ea6 <memset>
...
80104ad7:	c7 04 24 11 9b 10 80 	movl   $0x80109b11,(%esp)
...
80104b01:	e8 d0 15 00 00       	call   801060d6 <safestrcpy>
  np->state = RUNNABLE;
...
80104b63:	e8 1f 22 00 00       	call   80106d87 <fileopen>
...
80104bbb:	e8 17 47 00 00       	call   801092d7 <allocuvm>
80104bc0:	85 c0                	test   %eax,%eax
80104bc2:	75 11                	jne    80104bd5 <swapIn+0xc0>
      {
	cprintf("allocuvm failed\n");
80104bc4:	c7 04 24 24 9b 10 80 	movl   $0x80109b24,(%esp)
...
80104c20:	e8 c3 45 00 00       	call   801091e8 <loaduvm>
...
80104ca7:	e8 96 1b 00 00       	call   80106842 <unlink>
      
      acquire(&ptable.lock);
80104cac:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
80104cb3:	e8 67 0f 00 00       	call   80105c1f <acquire>
      t->state = RUNNABLE;
...
80104cc9:	e8 51 0f 00 00       	call   80105c1f <acquire>
...
80104ce2:	e8 d3 0f 00 00       	call   80105cba <release>
...
80104d05:	e8 15 0f 00 00       	call   80105c1f <acquire>
...
80104d1a:	e8 9b 0f 00 00       	call   80105cba <release>
      goto swapin;
...
80104d2b:	e8 8a 0f 00 00       	call   80105cba <release>
...
80104d45:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
     ...
     sched();
80104d4c:	e8 7c 08 00 00       	call   801055cd <sched>
     proc->chan = 0;
...
80104d85:	e8 fd 1f 00 00       	call   80106d87 <fileopen>
80104d8a:	89 43 7c             	mov    %eax,0x7c(%ebx)
    pte_t *pte;
    uint pa, j;
    for(j = 0; j < proc->sz; j += PGSIZE)
80104d8d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104d94:	e9 ac 00 00 00       	jmp    80104e45 <swapOut+0xe2>
    {
...
80104da5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80104dac:	00 
80104dad:	89 54 24 04          	mov    %edx,0x4(%esp)
80104db1:	89 04 24             	mov    %eax,(%esp)
80104db4:	e8 22 40 00 00       	call   80108ddb <walkpgdir>
80104db9:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104dbc:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80104dc0:	75 0c                	jne    80104dce <swapOut+0x6b>
	panic("walkpgdir: pte should exist");
80104dc2:	c7 04 24 35 9b 10 80 	movl   $0x80109b35,(%esp)
80104dc9:	e8 6f b7 ff ff       	call   8010053d <panic>
      if(!(*pte & PTE_P))
80104dce:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104dd1:	8b 00                	mov    (%eax),%eax
80104dd3:	83 e0 01             	and    $0x1,%eax
80104dd6:	85 c0                	test   %eax,%eax
80104dd8:	75 0c                	jne    80104de6 <swapOut+0x83>
	panic("walkpgdir: page not present");
80104dda:	c7 04 24 51 9b 10 80 	movl   $0x80109b51,(%esp)
80104de1:	e8 57 b7 ff ff       	call   8010053d <panic>
      pa = PTE_ADDR(*pte);
80104de6:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104de9:	8b 00                	mov    (%eax),%eax
80104deb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80104df0:	89 45 e8             	mov    %eax,-0x18(%ebp)
      if(filewrite(proc->swap, (char*)p2v(pa), PGSIZE) < 0){		//write each PTE found to swapfile
80104df3:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104df6:	89 04 24             	mov    %eax,(%esp)
80104df9:	e8 f2 f9 ff ff       	call   801047f0 <p2v>
80104dfe:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104e05:	8b 52 7c             	mov    0x7c(%edx),%edx
80104e08:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80104e0f:	00 
80104e10:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e14:	89 14 24             	mov    %edx,(%esp)
80104e17:	e8 89 c3 ff ff       	call   801011a5 <filewrite>
80104e1c:	85 c0                	test   %eax,%eax
80104e1e:	79 1e                	jns    80104e3e <swapOut+0xdb>
...
80104e2d:	c7 04 24 70 9b 10 80 	movl   $0x80109b70,(%esp)
80104e34:	e8 68 b5 ff ff       	call   801003a1 <cprintf>
	return;
80104e39:	e9 bc 00 00 00       	jmp    80104efa <swapOut+0x197>
swapOut()
{
    proc->swap = fileopen(proc->swapFileName,(O_CREATE | O_RDWR));	//create the swapfile
    pte_t *pte;
    uint pa, j;
    for(j = 0; j < proc->sz; j += PGSIZE)
80104e3e:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80104e45:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e4b:	8b 00                	mov    (%eax),%eax
80104e4d:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104e50:	0f 87 43 ff ff ff    	ja     80104d99 <swapOut+0x36>
	return;
      }
    }
    ...
    int fd;
    for(fd = 0; fd < NOFILE; fd++)
80104e56:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104e5d:	eb 63                	jmp    80104ec2 <swapOut+0x15f>
    {
...
80104e6b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104e6f:	85 c0                	test   %eax,%eax
80104e71:	74 4b                	je     80104ebe <swapOut+0x15b>
80104e73:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e79:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e7c:	83 c2 08             	add    $0x8,%edx
80104e7f:	8b 54 90 08          	mov    0x8(%eax,%edx,4),%edx
80104e83:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e89:	8b 40 7c             	mov    0x7c(%eax),%eax
80104e8c:	39 c2                	cmp    %eax,%edx
80104e8e:	75 2e                	jne    80104ebe <swapOut+0x15b>
      {
	fileclose(proc->ofile[fd]);
80104e90:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e96:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e99:	83 c2 08             	add    $0x8,%edx
80104e9c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104ea0:	89 04 24             	mov    %eax,(%esp)
80104ea3:	e8 1c c1 ff ff       	call   80100fc4 <fileclose>
	proc->ofile[fd] = 0;
80104ea8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104eae:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104eb1:	83 c2 08             	add    $0x8,%edx
80104eb4:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104ebb:	00 
	break;
80104ebc:	eb 0a                	jmp    80104ec8 <swapOut+0x165>
	return;
      }
    }
    ...
    int fd;
    for(fd = 0; fd < NOFILE; fd++)
80104ebe:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104ec2:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104ec6:	7e 97                	jle    80104e5f <swapOut+0xfc>
	fileclose(proc->ofile[fd]);
	proc->ofile[fd] = 0;
	break;
      }
...
80104ece:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
...
80104ee6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80104eed:	00 
80104eee:	89 54 24 04          	mov    %edx,0x4(%esp)
80104ef2:	89 04 24             	mov    %eax,(%esp)
80104ef5:	e8 b7 44 00 00       	call   801093b1 <deallocuvm>
}
80104efa:	83 c4 24             	add    $0x24,%esp
80104efd:	5b                   	pop    %ebx
80104efe:	5d                   	pop    %ebp
80104eff:	c3                   	ret    
...
80104f03:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
80104f06:	e8 51 f9 ff ff       	call   8010485c <allocproc>
80104f0b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
80104f0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f11:	a3 88 c6 10 80       	mov    %eax,0x8010c688
  if((p->pgdir = setupkvm(kalloc)) == 0)
80104f16:	c7 04 24 10 2b 10 80 	movl   $0x80102b10,(%esp)
80104f1d:	e8 e3 3f 00 00       	call   80108f05 <setupkvm>
80104f22:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104f25:	89 42 04             	mov    %eax,0x4(%edx)
80104f28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f2b:	8b 40 04             	mov    0x4(%eax),%eax
80104f2e:	85 c0                	test   %eax,%eax
80104f30:	75 0c                	jne    80104f3e <userinit+0x3e>
    panic("userinit: out of memory?");
80104f32:	c7 04 24 a2 9b 10 80 	movl   $0x80109ba2,(%esp)
80104f39:	e8 ff b5 ff ff       	call   8010053d <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80104f3e:	ba 2c 00 00 00       	mov    $0x2c,%edx
80104f43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f46:	8b 40 04             	mov    0x4(%eax),%eax
80104f49:	89 54 24 08          	mov    %edx,0x8(%esp)
80104f4d:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
80104f54:	80 
80104f55:	89 04 24             	mov    %eax,(%esp)
80104f58:	e8 00 42 00 00       	call   8010915d <inituvm>
  p->sz = PGSIZE;
80104f5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f60:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104f66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f69:	8b 40 18             	mov    0x18(%eax),%eax
80104f6c:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104f73:	00 
80104f74:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104f7b:	00 
80104f7c:	89 04 24             	mov    %eax,(%esp)
80104f7f:	e8 22 0f 00 00       	call   80105ea6 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80104f84:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f87:	8b 40 18             	mov    0x18(%eax),%eax
80104f8a:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104f90:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f93:	8b 40 18             	mov    0x18(%eax),%eax
80104f96:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
80104f9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f9f:	8b 40 18             	mov    0x18(%eax),%eax
80104fa2:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104fa5:	8b 52 18             	mov    0x18(%edx),%edx
80104fa8:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104fac:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80104fb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fb3:	8b 40 18             	mov    0x18(%eax),%eax
80104fb6:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104fb9:	8b 52 18             	mov    0x18(%edx),%edx
80104fbc:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104fc0:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80104fc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fc7:	8b 40 18             	mov    0x18(%eax),%eax
80104fca:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80104fd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fd4:	8b 40 18             	mov    0x18(%eax),%eax
80104fd7:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80104fde:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fe1:	8b 40 18             	mov    0x18(%eax),%eax
80104fe4:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104feb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fee:	83 c0 6c             	add    $0x6c,%eax
80104ff1:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104ff8:	00 
80104ff9:	c7 44 24 04 bb 9b 10 	movl   $0x80109bbb,0x4(%esp)
80105000:	80 
80105001:	89 04 24             	mov    %eax,(%esp)
80105004:	e8 cd 10 00 00       	call   801060d6 <safestrcpy>
  p->cwd = namei("/");
80105009:	c7 04 24 11 9b 10 80 	movl   $0x80109b11,(%esp)
80105010:	e8 f5 d3 ff ff       	call   8010240a <namei>
80105015:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105018:	89 42 68             	mov    %eax,0x68(%edx)

  p->state = RUNNABLE;
8010501b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010501e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)

  createInternalProcess("inswapper", swapIn);
80105025:	c7 44 24 04 15 4b 10 	movl   $0x80104b15,0x4(%esp)
8010502c:	80 
8010502d:	c7 04 24 c4 9b 10 80 	movl   $0x80109bc4,(%esp)
80105034:	e8 ca f9 ff ff       	call   80104a03 <createInternalProcess>
}
80105039:	c9                   	leave  
8010503a:	c3                   	ret    
...
80105049:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
8010504c:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80105050:	7e 34                	jle    80105086 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
80105052:	8b 45 08             	mov    0x8(%ebp),%eax
80105055:	89 c2                	mov    %eax,%edx
80105057:	03 55 f4             	add    -0xc(%ebp),%edx
8010505a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105060:	8b 40 04             	mov    0x4(%eax),%eax
80105063:	89 54 24 08          	mov    %edx,0x8(%esp)
80105067:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010506a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010506e:	89 04 24             	mov    %eax,(%esp)
80105071:	e8 61 42 00 00       	call   801092d7 <allocuvm>
80105076:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105079:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010507d:	75 41                	jne    801050c0 <growproc+0x85>
      return -1;
8010507f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105084:	eb 58                	jmp    801050de <growproc+0xa3>
  } else if(n < 0){
80105086:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010508a:	79 34                	jns    801050c0 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
8010508c:	8b 45 08             	mov    0x8(%ebp),%eax
8010508f:	89 c2                	mov    %eax,%edx
80105091:	03 55 f4             	add    -0xc(%ebp),%edx
80105094:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010509a:	8b 40 04             	mov    0x4(%eax),%eax
8010509d:	89 54 24 08          	mov    %edx,0x8(%esp)
801050a1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801050a4:	89 54 24 04          	mov    %edx,0x4(%esp)
801050a8:	89 04 24             	mov    %eax,(%esp)
801050ab:	e8 01 43 00 00       	call   801093b1 <deallocuvm>
801050b0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801050b3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801050b7:	75 07                	jne    801050c0 <growproc+0x85>
      return -1;
801050b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050be:	eb 1e                	jmp    801050de <growproc+0xa3>
  }
  proc->sz = sz;
801050c0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050c6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801050c9:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
801050cb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801050d1:	89 04 24             	mov    %eax,(%esp)
801050d4:	e8 1d 3f 00 00       	call   80108ff6 <switchuvm>
  return 0;
...
801050e6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  // Allocate process.
  if((np = allocproc()) == 0)
801050e9:	e8 6e f7 ff ff       	call   8010485c <allocproc>
801050ee:	89 45 e0             	mov    %eax,-0x20(%ebp)
801050f1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801050f5:	75 0a                	jne    80105101 <fork+0x21>
    return -1;
801050f7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050fc:	e9 3a 01 00 00       	jmp    8010523b <fork+0x15b>
  
  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
80105101:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105107:	8b 10                	mov    (%eax),%edx
...
80105119:	e8 23 44 00 00       	call   80109541 <copyuvm>
8010511e:	8b 55 e0             	mov    -0x20(%ebp),%edx
80105121:	89 42 04             	mov    %eax,0x4(%edx)
80105124:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105127:	8b 40 04             	mov    0x4(%eax),%eax
8010512a:	85 c0                	test   %eax,%eax
8010512c:	75 2c                	jne    8010515a <fork+0x7a>
    kfree(np->kstack);
8010512e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105131:	8b 40 08             	mov    0x8(%eax),%eax
80105134:	89 04 24             	mov    %eax,(%esp)
80105137:	e8 3b d9 ff ff       	call   80102a77 <kfree>
    np->kstack = 0;
8010513c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010513f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
80105146:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105149:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
80105150:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105155:	e9 e1 00 00 00       	jmp    8010523b <fork+0x15b>
  }
  np->sz = proc->sz;
8010515a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105160:	8b 10                	mov    (%eax),%edx
80105162:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105165:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80105167:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010516e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105171:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
80105174:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105177:	8b 50 18             	mov    0x18(%eax),%edx
8010517a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105180:	8b 40 18             	mov    0x18(%eax),%eax
80105183:	89 c3                	mov    %eax,%ebx
80105185:	b8 13 00 00 00       	mov    $0x13,%eax
8010518a:	89 d7                	mov    %edx,%edi
8010518c:	89 de                	mov    %ebx,%esi
8010518e:	89 c1                	mov    %eax,%ecx
80105190:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80105192:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105195:	8b 40 18             	mov    0x18(%eax),%eax
80105198:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
8010519f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801051a6:	eb 3d                	jmp    801051e5 <fork+0x105>
    if(proc->ofile[i])
801051a8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801051b1:	83 c2 08             	add    $0x8,%edx
801051b4:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801051b8:	85 c0                	test   %eax,%eax
801051ba:	74 25                	je     801051e1 <fork+0x101>
      np->ofile[i] = filedup(proc->ofile[i]);
801051bc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051c2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801051c5:	83 c2 08             	add    $0x8,%edx
801051c8:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801051cc:	89 04 24             	mov    %eax,(%esp)
801051cf:	e8 a8 bd ff ff       	call   80100f7c <filedup>
801051d4:	8b 55 e0             	mov    -0x20(%ebp),%edx
801051d7:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801051da:	83 c1 08             	add    $0x8,%ecx
801051dd:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
801051e1:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801051e5:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801051e9:	7e bd                	jle    801051a8 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
801051f7:	e8 3a c6 ff ff       	call   80101836 <idup>
801051fc:	8b 55 e0             	mov    -0x20(%ebp),%edx
801051ff:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
80105202:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105205:	8b 40 10             	mov    0x10(%eax),%eax
80105208:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
8010520b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010520e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
80105215:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010521b:	8d 50 6c             	lea    0x6c(%eax),%edx
8010521e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105221:	83 c0 6c             	add    $0x6c,%eax
80105224:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010522b:	00 
8010522c:	89 54 24 04          	mov    %edx,0x4(%esp)
80105230:	89 04 24             	mov    %eax,(%esp)
80105233:	e8 9e 0e 00 00       	call   801060d6 <safestrcpy>
  return pid;
80105238:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
8010523b:	83 c4 2c             	add    $0x2c,%esp
8010523e:	5b                   	pop    %ebx
8010523f:	5e                   	pop    %esi
80105240:	5f                   	pop    %edi
80105241:	5d                   	pop    %ebp
...
80105246:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
80105249:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105250:	a1 88 c6 10 80       	mov    0x8010c688,%eax
80105255:	39 c2                	cmp    %eax,%edx
80105257:	75 0c                	jne    80105265 <exit+0x22>
    panic("init exiting");
80105259:	c7 04 24 ce 9b 10 80 	movl   $0x80109bce,(%esp)
80105260:	e8 d8 b2 ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80105265:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010526c:	eb 44                	jmp    801052b2 <exit+0x6f>
    if(proc->ofile[fd]){
8010526e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105274:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105277:	83 c2 08             	add    $0x8,%edx
8010527a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010527e:	85 c0                	test   %eax,%eax
80105280:	74 2c                	je     801052ae <exit+0x6b>
      fileclose(proc->ofile[fd]);
...
80105295:	e8 2a bd ff ff       	call   80100fc4 <fileclose>
      proc->ofile[fd] = 0;
8010529a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052a0:	8b 55 f0             	mov    -0x10(%ebp),%edx
801052a3:	83 c2 08             	add    $0x8,%edx
801052a6:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801052ad:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801052ae:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801052b2:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801052b6:	7e b6                	jle    8010526e <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
801052be:	8b 40 68             	mov    0x68(%eax),%eax
801052c1:	89 04 24             	mov    %eax,(%esp)
801052c4:	e8 52 c7 ff ff       	call   80101a1b <iput>
  proc->cwd = 0;
801052c9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052cf:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)
  
  if(proc->has_shm)
801052d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052dc:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
801052e2:	85 c0                	test   %eax,%eax
801052e4:	74 11                	je     801052f7 <exit+0xb4>
    deallocshm(proc->pid);		//deallocate any shared memory segments proc did not shmdt
801052e6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052ec:	8b 40 10             	mov    0x10(%eax),%eax
801052ef:	89 04 24             	mov    %eax,(%esp)
801052f2:	e8 9f de ff ff       	call   80103196 <deallocshm>
  
  acquire(&ptable.lock);
801052f7:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801052fe:	e8 1c 09 00 00       	call   80105c1f <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80105303:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105309:	8b 40 14             	mov    0x14(%eax),%eax
8010530c:	89 04 24             	mov    %eax,(%esp)
8010530f:	e8 19 05 00 00       	call   8010582d <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105314:	c7 45 f4 b4 77 12 80 	movl   $0x801277b4,-0xc(%ebp)
8010531b:	eb 3b                	jmp    80105358 <exit+0x115>
    if(p->parent == proc){
8010531d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105320:	8b 50 14             	mov    0x14(%eax),%edx
80105323:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105329:	39 c2                	cmp    %eax,%edx
8010532b:	75 24                	jne    80105351 <exit+0x10e>
      p->parent = initproc;
8010532d:	8b 15 88 c6 10 80    	mov    0x8010c688,%edx
80105333:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105336:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
80105339:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010533c:	8b 40 0c             	mov    0xc(%eax),%eax
8010533f:	83 f8 05             	cmp    $0x5,%eax
80105342:	75 0d                	jne    80105351 <exit+0x10e>
        wakeup1(initproc);
80105344:	a1 88 c6 10 80       	mov    0x8010c688,%eax
80105349:	89 04 24             	mov    %eax,(%esp)
8010534c:	e8 dc 04 00 00       	call   8010582d <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105351:	81 45 f4 94 00 00 00 	addl   $0x94,-0xc(%ebp)
80105358:	81 7d f4 b4 9c 12 80 	cmpl   $0x80129cb4,-0xc(%ebp)
8010535f:	72 bc                	jb     8010531d <exit+0xda>
        wakeup1(initproc);
    }
  }
...
80105367:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010536e:	e8 5a 02 00 00       	call   801055cd <sched>
  panic("zombie exit");
80105373:	c7 04 24 db 9b 10 80 	movl   $0x80109bdb,(%esp)
...
80105382:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80105385:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010538c:	e8 8e 08 00 00       	call   80105c1f <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80105391:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105398:	c7 45 f4 b4 77 12 80 	movl   $0x801277b4,-0xc(%ebp)
8010539f:	e9 9d 00 00 00       	jmp    80105441 <wait+0xc2>
      if(p->parent != proc)
801053a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053a7:	8b 50 14             	mov    0x14(%eax),%edx
801053aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801053b0:	39 c2                	cmp    %eax,%edx
801053b2:	0f 85 81 00 00 00    	jne    80105439 <wait+0xba>
        continue;
      havekids = 1;
801053b8:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
801053bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053c2:	8b 40 0c             	mov    0xc(%eax),%eax
801053c5:	83 f8 05             	cmp    $0x5,%eax
801053c8:	75 70                	jne    8010543a <wait+0xbb>
        // Found one.
        pid = p->pid;
801053ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053cd:	8b 40 10             	mov    0x10(%eax),%eax
801053d0:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
801053d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053d6:	8b 40 08             	mov    0x8(%eax),%eax
801053d9:	89 04 24             	mov    %eax,(%esp)
801053dc:	e8 96 d6 ff ff       	call   80102a77 <kfree>
        p->kstack = 0;
801053e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053e4:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
801053eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053ee:	8b 40 04             	mov    0x4(%eax),%eax
801053f1:	89 04 24             	mov    %eax,(%esp)
801053f4:	e8 74 40 00 00       	call   8010946d <freevm>
        p->state = UNUSED;
801053f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053fc:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80105403:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105406:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
8010540d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105410:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80105417:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010541a:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
8010541e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105421:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80105428:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010542f:	e8 86 08 00 00       	call   80105cba <release>
        return pid;
80105434:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105437:	eb 56                	jmp    8010548f <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80105439:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010543a:	81 45 f4 94 00 00 00 	addl   $0x94,-0xc(%ebp)
80105441:	81 7d f4 b4 9c 12 80 	cmpl   $0x80129cb4,-0xc(%ebp)
80105448:	0f 82 56 ff ff ff    	jb     801053a4 <wait+0x25>
        return pid;
      }
    }
...
8010544e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105452:	74 0d                	je     80105461 <wait+0xe2>
80105454:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010545a:	8b 40 24             	mov    0x24(%eax),%eax
8010545d:	85 c0                	test   %eax,%eax
8010545f:	74 13                	je     80105474 <wait+0xf5>
      release(&ptable.lock);
80105461:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
80105468:	e8 4d 08 00 00       	call   80105cba <release>
      return -1;
8010546d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105472:	eb 1b                	jmp    8010548f <wait+0x110>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80105474:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010547a:	c7 44 24 04 80 77 12 	movl   $0x80127780,0x4(%esp)
80105481:	80 
80105482:	89 04 24             	mov    %eax,(%esp)
80105485:	e8 53 02 00 00       	call   801056dd <sleep>
  }
8010548a:	e9 02 ff ff ff       	jmp    80105391 <wait+0x12>
}
8010548f:	c9                   	leave  
80105490:	c3                   	ret    

80105491 <register_handler>:
...
80105494:	83 ec 28             	sub    $0x28,%esp
...
801054b5:	e8 98 41 00 00       	call   80109652 <uva2ka>
...
801054c9:	25 ff 0f 00 00       	and    $0xfff,%eax
801054ce:	85 c0                	test   %eax,%eax
801054d0:	75 0c                	jne    801054de <register_handler+0x4d>
    panic("esp_offset == 0");
801054d2:	c7 04 24 e7 9b 10 80 	movl   $0x80109be7,(%esp)
801054d9:	e8 5f b0 ff ff       	call   8010053d <panic>

    /* open a new frame */
  *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF))
801054de:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054e4:	8b 40 18             	mov    0x18(%eax),%eax
801054e7:	8b 40 44             	mov    0x44(%eax),%eax
801054ea:	83 e8 04             	sub    $0x4,%eax
801054ed:	25 ff 0f 00 00       	and    $0xfff,%eax
801054f2:	03 45 f4             	add    -0xc(%ebp),%eax
          = proc->tf->eip;
801054f5:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801054fc:	8b 52 18             	mov    0x18(%edx),%edx
801054ff:	8b 52 38             	mov    0x38(%edx),%edx
...
80105514:	8b 52 18             	mov    0x18(%edx),%edx
80105517:	8b 52 44             	mov    0x44(%edx),%edx
8010551a:	83 ea 04             	sub    $0x4,%edx
8010551d:	89 50 44             	mov    %edx,0x44(%eax)

    /* update eip */
  proc->tf->eip = (uint)sighandler;
80105520:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105526:	8b 40 18             	mov    0x18(%eax),%eax
80105529:	8b 55 08             	mov    0x8(%ebp),%edx
8010552c:	89 50 38             	mov    %edx,0x38(%eax)
}
8010552f:	c9                   	leave  
80105530:	c3                   	ret    
...
80105534:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  
  for(;;){
    // Enable interrupts on this processor.
    sti();
80105537:	e8 d6 f2 ff ff       	call   80104812 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
8010553c:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
80105543:	e8 d7 06 00 00       	call   80105c1f <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105548:	c7 45 f4 b4 77 12 80 	movl   $0x801277b4,-0xc(%ebp)
8010554f:	eb 62                	jmp    801055b3 <scheduler+0x82>
      if(p->state != RUNNABLE)
80105551:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105554:	8b 40 0c             	mov    0xc(%eax),%eax
80105557:	83 f8 03             	cmp    $0x3,%eax
8010555a:	75 4f                	jne    801055ab <scheduler+0x7a>
        continue;
...
8010555f:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80105565:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105568:	89 04 24             	mov    %eax,(%esp)
8010556b:	e8 86 3a 00 00       	call   80108ff6 <switchuvm>
      p->state = RUNNING;
80105570:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105573:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
8010557a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105580:	8b 40 1c             	mov    0x1c(%eax),%eax
80105583:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010558a:	83 c2 04             	add    $0x4,%edx
8010558d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105591:	89 14 24             	mov    %edx,(%esp)
80105594:	e8 b3 0b 00 00       	call   8010614c <swtch>
      switchkvm();
80105599:	e8 3b 3a 00 00       	call   80108fd9 <switchkvm>
                 
      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
8010559e:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801055a5:	00 00 00 00 
801055a9:	eb 01                	jmp    801055ac <scheduler+0x7b>
...
801055ab:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801055ac:	81 45 f4 94 00 00 00 	addl   $0x94,-0xc(%ebp)
801055b3:	81 7d f4 b4 9c 12 80 	cmpl   $0x80129cb4,-0xc(%ebp)
801055ba:	72 95                	jb     80105551 <scheduler+0x20>
    ...
    release(&ptable.lock);
801055bc:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801055c3:	e8 f2 06 00 00       	call   80105cba <release>

  }
801055c8:	e9 6a ff ff ff       	jmp    80105537 <scheduler+0x6>
...
801055d0:	83 ec 28             	sub    $0x28,%esp
  int intena;

  if(!holding(&ptable.lock))
801055d3:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801055da:	e8 97 07 00 00       	call   80105d76 <holding>
801055df:	85 c0                	test   %eax,%eax
801055e1:	75 0c                	jne    801055ef <sched+0x22>
    panic("sched ptable.lock");
801055e3:	c7 04 24 f7 9b 10 80 	movl   $0x80109bf7,(%esp)
801055ea:	e8 4e af ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
801055ef:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055f5:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801055fb:	83 f8 01             	cmp    $0x1,%eax
801055fe:	74 0c                	je     8010560c <sched+0x3f>
    panic("sched locks");
80105600:	c7 04 24 09 9c 10 80 	movl   $0x80109c09,(%esp)
80105607:	e8 31 af ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
8010560c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105612:	8b 40 0c             	mov    0xc(%eax),%eax
80105615:	83 f8 04             	cmp    $0x4,%eax
80105618:	75 0c                	jne    80105626 <sched+0x59>
    panic("sched running");
8010561a:	c7 04 24 15 9c 10 80 	movl   $0x80109c15,(%esp)
80105621:	e8 17 af ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80105626:	e8 d2 f1 ff ff       	call   801047fd <readeflags>
8010562b:	25 00 02 00 00       	and    $0x200,%eax
80105630:	85 c0                	test   %eax,%eax
80105632:	74 0c                	je     80105640 <sched+0x73>
    panic("sched interruptible");
80105634:	c7 04 24 23 9c 10 80 	movl   $0x80109c23,(%esp)
8010563b:	e8 fd ae ff ff       	call   8010053d <panic>
  intena = cpu->intena;
...
8010565f:	83 c2 1c             	add    $0x1c,%edx
80105662:	89 44 24 04          	mov    %eax,0x4(%esp)
80105666:	89 14 24             	mov    %edx,(%esp)
80105669:	e8 de 0a 00 00       	call   8010614c <swtch>
  cpu->intena = intena;
8010566e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105674:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105677:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010567d:	c9                   	leave  
8010567e:	c3                   	ret    
...
80105682:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
80105685:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010568c:	e8 8e 05 00 00       	call   80105c1f <acquire>
  proc->state = RUNNABLE;
80105691:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105697:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
8010569e:	e8 2a ff ff ff       	call   801055cd <sched>
  release(&ptable.lock);
801056a3:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801056aa:	e8 0b 06 00 00       	call   80105cba <release>
}
801056af:	c9                   	leave  
801056b0:	c3                   	ret    
...
801056b4:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
801056b7:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801056be:	e8 f7 05 00 00       	call   80105cba <release>

  if (first) {
801056c3:	a1 20 c0 10 80       	mov    0x8010c020,%eax
801056c8:	85 c0                	test   %eax,%eax
801056ca:	74 0f                	je     801056db <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
801056cc:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
801056d3:	00 00 00 
    initlog();
801056d6:	e8 37 e1 ff ff       	call   80103812 <initlog>
  }
...
801056eb:	75 0c                	jne    801056f9 <sleep+0x1c>
    panic("sleep");
801056ed:	c7 04 24 37 9c 10 80 	movl   $0x80109c37,(%esp)
801056f4:	e8 44 ae ff ff       	call   8010053d <panic>

  if(lk == 0)
801056f9:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801056fd:	75 0c                	jne    8010570b <sleep+0x2e>
    panic("sleep without lk");
801056ff:	c7 04 24 3d 9c 10 80 	movl   $0x80109c3d,(%esp)
80105706:	e8 32 ae ff ff       	call   8010053d <panic>
...
8010570b:	81 7d 0c 80 77 12 80 	cmpl   $0x80127780,0xc(%ebp)
80105712:	74 17                	je     8010572b <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80105714:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010571b:	e8 ff 04 00 00       	call   80105c1f <acquire>
    release(lk);
80105720:	8b 45 0c             	mov    0xc(%ebp),%eax
80105723:	89 04 24             	mov    %eax,(%esp)
80105726:	e8 8f 05 00 00       	call   80105cba <release>
  }

  // Go to sleep.
  proc->chan = chan;
8010572b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105731:	8b 55 08             	mov    0x8(%ebp),%edx
80105734:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80105737:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010573d:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)

  // Swap out
  if(swapFlag)			//check if swapping out is enabled
80105744:	a1 80 c6 10 80       	mov    0x8010c680,%eax
80105749:	85 c0                	test   %eax,%eax
8010574b:	0f 84 a8 00 00 00    	je     801057f9 <sleep+0x11c>
  {
...
8010575a:	83 f8 03             	cmp    $0x3,%eax
8010575d:	0f 8e 96 00 00 00    	jle    801057f9 <sleep+0x11c>
    {
      proc->wokenUp = 0;
80105763:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105769:	c7 80 8c 00 00 00 00 	movl   $0x0,0x8c(%eax)
80105770:	00 00 00 
      proc->swappingOut = 1;
80105773:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105779:	c7 80 88 00 00 00 01 	movl   $0x1,0x88(%eax)
80105780:	00 00 00 
	...
	//acquire(&wakeuplock);
      //}
      release(&ptable.lock);	
80105783:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010578a:	e8 2b 05 00 00       	call   80105cba <release>
      swapOut();		//swap out proc
8010578f:	e8 cf f5 ff ff       	call   80104d63 <swapOut>
      proc->swappingOut = 0;	//oran
80105794:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010579a:	c7 80 88 00 00 00 00 	movl   $0x0,0x88(%eax)
801057a1:	00 00 00 
      acquire(&ptable.lock);
801057a4:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801057ab:	e8 6f 04 00 00       	call   80105c1f <acquire>
      
      //release(&wakeuplock);
      if(proc->wokenUp == 1)
801057b0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057b6:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
801057bc:	83 f8 01             	cmp    $0x1,%eax
801057bf:	75 2b                	jne    801057ec <sleep+0x10f>
      {
	proc->wokenUp = 0;	//oran
801057c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057c7:	c7 80 8c 00 00 00 00 	movl   $0x0,0x8c(%eax)
801057ce:	00 00 00 
	proc->state = RUNNABLE_SUSPENDED;
801057d1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057d7:	c7 40 0c 07 00 00 00 	movl   $0x7,0xc(%eax)
	inswapper->state = RUNNABLE;
801057de:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
801057e3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801057ea:	eb 0d                	jmp    801057f9 <sleep+0x11c>
      }
      else
      {
	proc->state = SLEEPING_SUSPENDED;					//set proc to SLEEPING_SUSPENDED
801057ec:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057f2:	c7 40 0c 06 00 00 00 	movl   $0x6,0xc(%eax)
  ...
  sched();
801057f9:	e8 cf fd ff ff       	call   801055cd <sched>
  
  // Tidy up.
  proc->chan = 0;
801057fe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105804:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
8010580b:	81 7d 0c 80 77 12 80 	cmpl   $0x80127780,0xc(%ebp)
80105812:	74 17                	je     8010582b <sleep+0x14e>
    release(&ptable.lock);
80105814:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010581b:	e8 9a 04 00 00       	call   80105cba <release>
    acquire(lk);
80105820:	8b 45 0c             	mov    0xc(%ebp),%eax
80105823:	89 04 24             	mov    %eax,(%esp)
80105826:	e8 f4 03 00 00       	call   80105c1f <acquire>
  }
}
8010582b:	c9                   	leave  
8010582c:	c3                   	ret    
...
80105830:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int found_suspended = 0;
80105833:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010583a:	c7 45 f4 b4 77 12 80 	movl   $0x801277b4,-0xc(%ebp)
80105841:	e9 9d 00 00 00       	jmp    801058e3 <wakeup1+0xb6>
  {
    if(p->state == SLEEPING && p->chan == chan)
80105846:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105849:	8b 40 0c             	mov    0xc(%eax),%eax
8010584c:	83 f8 02             	cmp    $0x2,%eax
8010584f:	75 34                	jne    80105885 <wakeup1+0x58>
80105851:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105854:	8b 40 20             	mov    0x20(%eax),%eax
80105857:	3b 45 08             	cmp    0x8(%ebp),%eax
8010585a:	75 29                	jne    80105885 <wakeup1+0x58>
      //if(!holding(&wakeuplock));
      //{
...
8010585f:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80105865:	83 f8 01             	cmp    $0x1,%eax
80105868:	75 0f                	jne    80105879 <wakeup1+0x4c>
	p->wokenUp = 1;
8010586a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010586d:	c7 80 8c 00 00 00 01 	movl   $0x1,0x8c(%eax)
80105874:	00 00 00 
      //if(!holding(&wakeuplock));
      //{
	//cprintf("wakeup1, p->pid = %d\n",p->pid);
	 // acquire(&wakeuplock);
      //}
      if(p->swappingOut == 1)
80105877:	eb 63                	jmp    801058dc <wakeup1+0xaf>
	p->wokenUp = 1;
      else
	p->state = RUNNABLE;
80105879:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587c:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      //if(!holding(&wakeuplock));
      //{
	//cprintf("wakeup1, p->pid = %d\n",p->pid);
	 // acquire(&wakeuplock);
      //}
      if(p->swappingOut == 1)
80105883:	eb 57                	jmp    801058dc <wakeup1+0xaf>
	p->wokenUp = 1;
      else
	p->state = RUNNABLE;
      //release(&wakeuplock);
...
80105888:	8b 40 0c             	mov    0xc(%eax),%eax
8010588b:	83 f8 06             	cmp    $0x6,%eax
8010588e:	75 4c                	jne    801058dc <wakeup1+0xaf>
80105890:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105893:	8b 40 20             	mov    0x20(%eax),%eax
80105896:	3b 45 08             	cmp    0x8(%ebp),%eax
80105899:	75 41                	jne    801058dc <wakeup1+0xaf>
8010589b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010589f:	75 3b                	jne    801058dc <wakeup1+0xaf>
    {
      //cprintf("proc = %d\n",proc->pid);
      acquire(&swaplock);
801058a1:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801058a8:	e8 72 03 00 00       	call   80105c1f <acquire>
      swappedout++;								//increment swapped out counter
801058ad:	a1 84 c6 10 80       	mov    0x8010c684,%eax
801058b2:	83 c0 01             	add    $0x1,%eax
801058b5:	a3 84 c6 10 80       	mov    %eax,0x8010c684
      p->state = RUNNABLE_SUSPENDED;						//set state to RUNNABLE_SUSPENDED
801058ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058bd:	c7 40 0c 07 00 00 00 	movl   $0x7,0xc(%eax)
      inswapper->state = RUNNABLE;						//wakeup inswapper
801058c4:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
801058c9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&swaplock);
801058d0:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801058d7:	e8 de 03 00 00       	call   80105cba <release>
wakeup1(void *chan)
{
  struct proc *p;
  int found_suspended = 0;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801058dc:	81 45 f4 94 00 00 00 	addl   $0x94,-0xc(%ebp)
801058e3:	81 7d f4 b4 9c 12 80 	cmpl   $0x80129cb4,-0xc(%ebp)
801058ea:	0f 82 56 ff ff ff    	jb     80105846 <wakeup1+0x19>
      p->state = RUNNABLE_SUSPENDED;						//set state to RUNNABLE_SUSPENDED
      inswapper->state = RUNNABLE;						//wakeup inswapper
      release(&swaplock);
    }
...
801058f5:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
801058f8:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801058ff:	e8 1b 03 00 00       	call   80105c1f <acquire>
  wakeup1(chan);
80105904:	8b 45 08             	mov    0x8(%ebp),%eax
80105907:	89 04 24             	mov    %eax,(%esp)
8010590a:	e8 1e ff ff ff       	call   8010582d <wakeup1>
  release(&ptable.lock);
8010590f:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
80105916:	e8 9f 03 00 00       	call   80105cba <release>
}
8010591b:	c9                   	leave  
8010591c:	c3                   	ret    
...
80105920:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80105923:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
8010592a:	e8 f0 02 00 00       	call   80105c1f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010592f:	c7 45 f4 b4 77 12 80 	movl   $0x801277b4,-0xc(%ebp)
80105936:	e9 8c 00 00 00       	jmp    801059c7 <kill+0xaa>
    if(p->pid == pid){
8010593b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010593e:	8b 40 10             	mov    0x10(%eax),%eax
80105941:	3b 45 08             	cmp    0x8(%ebp),%eax
80105944:	75 7a                	jne    801059c0 <kill+0xa3>
      p->killed = 1;
...
80105956:	83 f8 02             	cmp    $0x2,%eax
80105959:	75 0c                	jne    80105967 <kill+0x4a>
        p->state = RUNNABLE;
8010595b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010595e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80105965:	eb 46                	jmp    801059ad <kill+0x90>
...
8010596a:	8b 40 0c             	mov    0xc(%eax),%eax
8010596d:	83 f8 06             	cmp    $0x6,%eax
80105970:	75 3b                	jne    801059ad <kill+0x90>
      {
        acquire(&swaplock);
80105972:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
80105979:	e8 a1 02 00 00       	call   80105c1f <acquire>
      	swappedout++;
8010597e:	a1 84 c6 10 80       	mov    0x8010c684,%eax
80105983:	83 c0 01             	add    $0x1,%eax
80105986:	a3 84 c6 10 80       	mov    %eax,0x8010c684
      	p->state = RUNNABLE_SUSPENDED;
8010598b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010598e:	c7 40 0c 07 00 00 00 	movl   $0x7,0xc(%eax)
      	inswapper->state = RUNNABLE;
80105995:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
8010599a:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      	release(&swaplock);
801059a1:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801059a8:	e8 0d 03 00 00       	call   80105cba <release>
      }
      release(&ptable.lock);
801059ad:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801059b4:	e8 01 03 00 00       	call   80105cba <release>
      return 0;
801059b9:	b8 00 00 00 00       	mov    $0x0,%eax
801059be:	eb 25                	jmp    801059e5 <kill+0xc8>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801059c0:	81 45 f4 94 00 00 00 	addl   $0x94,-0xc(%ebp)
801059c7:	81 7d f4 b4 9c 12 80 	cmpl   $0x80129cb4,-0xc(%ebp)
801059ce:	0f 82 67 ff ff ff    	jb     8010593b <kill+0x1e>
      }
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
801059d4:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
801059db:	e8 da 02 00 00       	call   80105cba <release>
  return -1;
...
801059ea:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801059ed:	c7 45 f0 b4 77 12 80 	movl   $0x801277b4,-0x10(%ebp)
801059f4:	e9 db 00 00 00       	jmp    80105ad4 <procdump+0xed>
    if(p->state == UNUSED)
801059f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059fc:	8b 40 0c             	mov    0xc(%eax),%eax
801059ff:	85 c0                	test   %eax,%eax
80105a01:	0f 84 c5 00 00 00    	je     80105acc <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80105a07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a0a:	8b 40 0c             	mov    0xc(%eax),%eax
80105a0d:	83 f8 05             	cmp    $0x5,%eax
80105a10:	77 23                	ja     80105a35 <procdump+0x4e>
80105a12:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a15:	8b 40 0c             	mov    0xc(%eax),%eax
80105a18:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105a1f:	85 c0                	test   %eax,%eax
80105a21:	74 12                	je     80105a35 <procdump+0x4e>
      state = states[p->state];
80105a23:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a26:	8b 40 0c             	mov    0xc(%eax),%eax
80105a29:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80105a30:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105a33:	eb 07                	jmp    80105a3c <procdump+0x55>
    else
      state = "???";
80105a35:	c7 45 ec 4e 9c 10 80 	movl   $0x80109c4e,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80105a3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a3f:	8d 50 6c             	lea    0x6c(%eax),%edx
80105a42:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a45:	8b 40 10             	mov    0x10(%eax),%eax
80105a48:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105a4c:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105a4f:	89 54 24 08          	mov    %edx,0x8(%esp)
80105a53:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a57:	c7 04 24 52 9c 10 80 	movl   $0x80109c52,(%esp)
80105a5e:	e8 3e a9 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80105a63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a66:	8b 40 0c             	mov    0xc(%eax),%eax
80105a69:	83 f8 02             	cmp    $0x2,%eax
80105a6c:	75 50                	jne    80105abe <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80105a6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a71:	8b 40 1c             	mov    0x1c(%eax),%eax
80105a74:	8b 40 0c             	mov    0xc(%eax),%eax
80105a77:	83 c0 08             	add    $0x8,%eax
80105a7a:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80105a7d:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a81:	89 04 24             	mov    %eax,(%esp)
80105a84:	e8 80 02 00 00       	call   80105d09 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80105a89:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105a90:	eb 1b                	jmp    80105aad <procdump+0xc6>
        cprintf(" %p", pc[i]);
80105a92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a95:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105a99:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a9d:	c7 04 24 5b 9c 10 80 	movl   $0x80109c5b,(%esp)
80105aa4:	e8 f8 a8 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80105aa9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105aad:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105ab1:	7f 0b                	jg     80105abe <procdump+0xd7>
80105ab3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ab6:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105aba:	85 c0                	test   %eax,%eax
80105abc:	75 d4                	jne    80105a92 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80105abe:	c7 04 24 5f 9c 10 80 	movl   $0x80109c5f,(%esp)
80105ac5:	e8 d7 a8 ff ff       	call   801003a1 <cprintf>
80105aca:	eb 01                	jmp    80105acd <procdump+0xe6>
  char *state;
  uint pc[10];
...
80105acc:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105acd:	81 45 f0 94 00 00 00 	addl   $0x94,-0x10(%ebp)
80105ad4:	81 7d f0 b4 9c 12 80 	cmpl   $0x80129cb4,-0x10(%ebp)
80105adb:	0f 82 18 ff ff ff    	jb     801059f9 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80105ae6:	83 ec 38             	sub    $0x38,%esp
  struct proc* p;
  acquire(&ptable.lock);
80105ae9:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
80105af0:	e8 2a 01 00 00       	call   80105c1f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105af5:	c7 45 f4 b4 77 12 80 	movl   $0x801277b4,-0xc(%ebp)
80105afc:	eb 12                	jmp    80105b10 <getAllocatedPages+0x2d>
    if(p->pid == pid){
80105afe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b01:	8b 40 10             	mov    0x10(%eax),%eax
80105b04:	3b 45 08             	cmp    0x8(%ebp),%eax
80105b07:	74 12                	je     80105b1b <getAllocatedPages+0x38>
}
...
int getAllocatedPages(int pid) {			//traverse the process with the given pid's virtual memory and count how many PTE_U pages are allocated
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105b09:	81 45 f4 94 00 00 00 	addl   $0x94,-0xc(%ebp)
80105b10:	81 7d f4 b4 9c 12 80 	cmpl   $0x80129cb4,-0xc(%ebp)
80105b17:	72 e5                	jb     80105afe <getAllocatedPages+0x1b>
80105b19:	eb 01                	jmp    80105b1c <getAllocatedPages+0x39>
    if(p->pid == pid){
     break;
80105b1b:	90                   	nop
    }
  ...
  release(&ptable.lock);
80105b1c:	c7 04 24 80 77 12 80 	movl   $0x80127780,(%esp)
80105b23:	e8 92 01 00 00       	call   80105cba <release>
   int count= 0, j, k;
80105b28:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
   for (j=0; j<1024; j++) {
80105b2f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
80105b36:	eb 71                	jmp    80105ba9 <getAllocatedPages+0xc6>
      if(p->pgdir){ 
80105b38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b3b:	8b 40 04             	mov    0x4(%eax),%eax
80105b3e:	85 c0                	test   %eax,%eax
80105b40:	74 63                	je     80105ba5 <getAllocatedPages+0xc2>
	if (p->pgdir[j] & PTE_P) {
80105b42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b45:	8b 40 04             	mov    0x4(%eax),%eax
80105b48:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b4b:	c1 e2 02             	shl    $0x2,%edx
80105b4e:	01 d0                	add    %edx,%eax
80105b50:	8b 00                	mov    (%eax),%eax
80105b52:	83 e0 01             	and    $0x1,%eax
80105b55:	84 c0                	test   %al,%al
80105b57:	74 4c                	je     80105ba5 <getAllocatedPages+0xc2>
	  pte_t* pte= (pte_t*)p2v(PTE_ADDR(p->pgdir[j]));
80105b59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5c:	8b 40 04             	mov    0x4(%eax),%eax
80105b5f:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b62:	c1 e2 02             	shl    $0x2,%edx
80105b65:	01 d0                	add    %edx,%eax
80105b67:	8b 00                	mov    (%eax),%eax
80105b69:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105b6e:	89 04 24             	mov    %eax,(%esp)
80105b71:	e8 7a ec ff ff       	call   801047f0 <p2v>
80105b76:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	  for (k=0; k<1024; k++) {
80105b79:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
80105b80:	eb 1a                	jmp    80105b9c <getAllocatedPages+0xb9>
	      if ( pte[k] & PTE_U )
80105b82:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105b85:	c1 e0 02             	shl    $0x2,%eax
80105b88:	03 45 e4             	add    -0x1c(%ebp),%eax
80105b8b:	8b 00                	mov    (%eax),%eax
80105b8d:	83 e0 04             	and    $0x4,%eax
80105b90:	85 c0                	test   %eax,%eax
80105b92:	74 04                	je     80105b98 <getAllocatedPages+0xb5>
		count++;
80105b94:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
   int count= 0, j, k;
   for (j=0; j<1024; j++) {
      if(p->pgdir){ 
	if (p->pgdir[j] & PTE_P) {
	  pte_t* pte= (pte_t*)p2v(PTE_ADDR(p->pgdir[j]));
	  for (k=0; k<1024; k++) {
80105b98:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
80105b9c:	81 7d e8 ff 03 00 00 	cmpl   $0x3ff,-0x18(%ebp)
80105ba3:	7e dd                	jle    80105b82 <getAllocatedPages+0x9f>
     break;
    }
  }
  release(&ptable.lock);
   int count= 0, j, k;
   for (j=0; j<1024; j++) {
80105ba5:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
80105ba9:	81 7d ec ff 03 00 00 	cmpl   $0x3ff,-0x14(%ebp)
80105bb0:	7e 86                	jle    80105b38 <getAllocatedPages+0x55>
		count++;
	  }
	}
      }
...
80105bbf:	9c                   	pushf  
80105bc0:	5b                   	pop    %ebx
80105bc1:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
80105bc4:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80105be3:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80105be6:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
80105be9:	89 c3                	mov    %eax,%ebx
80105beb:	89 d8                	mov    %ebx,%eax
80105bed:	f0 87 02             	lock xchg %eax,(%edx)
80105bf0:	89 c3                	mov    %eax,%ebx
80105bf2:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80105bf5:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80105c04:	8b 55 0c             	mov    0xc(%ebp),%edx
80105c07:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80105c0a:	8b 45 08             	mov    0x8(%ebp),%eax
80105c0d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80105c13:	8b 45 08             	mov    0x8(%ebp),%eax
80105c16:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80105c1d:	5d                   	pop    %ebp
80105c1e:	c3                   	ret    
...
80105c25:	e8 76 01 00 00       	call   80105da0 <pushcli>
  if(holding(lk))
80105c2a:	8b 45 08             	mov    0x8(%ebp),%eax
80105c2d:	89 04 24             	mov    %eax,(%esp)
80105c30:	e8 41 01 00 00       	call   80105d76 <holding>
80105c35:	85 c0                	test   %eax,%eax
80105c37:	74 45                	je     80105c7e <acquire+0x5f>
  {
    cprintf("lock = %s\n",lk->name);
80105c39:	8b 45 08             	mov    0x8(%ebp),%eax
80105c3c:	8b 40 04             	mov    0x4(%eax),%eax
80105c3f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c43:	c7 04 24 8b 9c 10 80 	movl   $0x80109c8b,(%esp)
80105c4a:	e8 52 a7 ff ff       	call   801003a1 <cprintf>
    if(proc)
80105c4f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c55:	85 c0                	test   %eax,%eax
80105c57:	74 19                	je     80105c72 <acquire+0x53>
      cprintf("pid = %d\n",proc->pid);
80105c59:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105c5f:	8b 40 10             	mov    0x10(%eax),%eax
80105c62:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c66:	c7 04 24 96 9c 10 80 	movl   $0x80109c96,(%esp)
80105c6d:	e8 2f a7 ff ff       	call   801003a1 <cprintf>
    panic("acquire");
80105c72:	c7 04 24 a0 9c 10 80 	movl   $0x80109ca0,(%esp)
80105c79:	e8 bf a8 ff ff       	call   8010053d <panic>
  }
...
80105c82:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105c89:	00 
80105c8a:	89 04 24             	mov    %eax,(%esp)
80105c8d:	e8 47 ff ff ff       	call   80105bd9 <xchg>
80105c92:	85 c0                	test   %eax,%eax
80105c94:	75 e9                	jne    80105c7f <acquire+0x60>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80105c96:	8b 45 08             	mov    0x8(%ebp),%eax
80105c99:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105ca0:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105ca3:	8b 45 08             	mov    0x8(%ebp),%eax
80105ca6:	83 c0 0c             	add    $0xc,%eax
80105ca9:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cad:	8d 45 08             	lea    0x8(%ebp),%eax
80105cb0:	89 04 24             	mov    %eax,(%esp)
80105cb3:	e8 51 00 00 00       	call   80105d09 <getcallerpcs>
}
80105cb8:	c9                   	leave  
80105cb9:	c3                   	ret    
...
80105cc6:	e8 ab 00 00 00       	call   80105d76 <holding>
80105ccb:	85 c0                	test   %eax,%eax
80105ccd:	75 0c                	jne    80105cdb <release+0x21>
    panic("release");
80105ccf:	c7 04 24 a8 9c 10 80 	movl   $0x80109ca8,(%esp)
80105cd6:	e8 62 a8 ff ff       	call   8010053d <panic>
...
80105cfd:	e8 d7 fe ff ff       	call   80105bd9 <xchg>

  popcli();
80105d02:	e8 e1 00 00 00       	call   80105de8 <popcli>
}
80105d07:	c9                   	leave  
80105d08:	c3                   	ret    

80105d09 <getcallerpcs>:
...
80105d12:	83 e8 08             	sub    $0x8,%eax
80105d15:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105d18:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80105d1f:	eb 32                	jmp    80105d53 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105d21:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105d25:	74 47                	je     80105d6e <getcallerpcs+0x65>
80105d27:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105d2e:	76 3e                	jbe    80105d6e <getcallerpcs+0x65>
80105d30:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105d34:	74 38                	je     80105d6e <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105d36:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105d39:	c1 e0 02             	shl    $0x2,%eax
80105d3c:	03 45 0c             	add    0xc(%ebp),%eax
80105d3f:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105d42:	8b 52 04             	mov    0x4(%edx),%edx
80105d45:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80105d47:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105d4a:	8b 00                	mov    (%eax),%eax
80105d4c:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80105d4f:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105d53:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105d57:	7e c8                	jle    80105d21 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105d59:	eb 13                	jmp    80105d6e <getcallerpcs+0x65>
    pcs[i] = 0;
80105d5b:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105d5e:	c1 e0 02             	shl    $0x2,%eax
80105d61:	03 45 0c             	add    0xc(%ebp),%eax
80105d64:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80105d6a:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105d6e:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105d72:	7e e7                	jle    80105d5b <getcallerpcs+0x52>
    pcs[i] = 0;
}
80105d74:	c9                   	leave  
80105d75:	c3                   	ret    
...
80105d80:	74 17                	je     80105d99 <holding+0x23>
80105d82:	8b 45 08             	mov    0x8(%ebp),%eax
80105d85:	8b 50 08             	mov    0x8(%eax),%edx
80105d88:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105d8e:	39 c2                	cmp    %eax,%edx
80105d90:	75 07                	jne    80105d99 <holding+0x23>
80105d92:	b8 01 00 00 00       	mov    $0x1,%eax
80105d97:	eb 05                	jmp    80105d9e <holding+0x28>
...
80105da3:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105da6:	e8 0d fe ff ff       	call   80105bb8 <readeflags>
80105dab:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105dae:	e8 1a fe ff ff       	call   80105bcd <cli>
  if(cpu->ncli++ == 0)
80105db3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105db9:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105dbf:	85 d2                	test   %edx,%edx
80105dc1:	0f 94 c1             	sete   %cl
80105dc4:	83 c2 01             	add    $0x1,%edx
80105dc7:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105dcd:	84 c9                	test   %cl,%cl
80105dcf:	74 15                	je     80105de6 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105dd1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105dd7:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105dda:	81 e2 00 02 00 00    	and    $0x200,%edx
80105de0:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105de6:	c9                   	leave  
80105de7:	c3                   	ret    
...
80105deb:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105dee:	e8 c5 fd ff ff       	call   80105bb8 <readeflags>
80105df3:	25 00 02 00 00       	and    $0x200,%eax
80105df8:	85 c0                	test   %eax,%eax
80105dfa:	74 0c                	je     80105e08 <popcli+0x20>
    panic("popcli - interruptible");
80105dfc:	c7 04 24 b0 9c 10 80 	movl   $0x80109cb0,(%esp)
80105e03:	e8 35 a7 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80105e08:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105e0e:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105e14:	83 ea 01             	sub    $0x1,%edx
80105e17:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105e1d:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105e23:	85 c0                	test   %eax,%eax
80105e25:	79 0c                	jns    80105e33 <popcli+0x4b>
    panic("popcli");
80105e27:	c7 04 24 c7 9c 10 80 	movl   $0x80109cc7,(%esp)
80105e2e:	e8 0a a7 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105e33:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105e39:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105e3f:	85 c0                	test   %eax,%eax
80105e41:	75 15                	jne    80105e58 <popcli+0x70>
80105e43:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105e49:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80105e4f:	85 c0                	test   %eax,%eax
80105e51:	74 05                	je     80105e58 <popcli+0x70>
    sti();
80105e53:	e8 7b fd ff ff       	call   80105bd3 <sti>
}
80105e58:	c9                   	leave  
80105e59:	c3                   	ret    
	...
...
80106326:	83 f8 1e             	cmp    $0x1e,%eax
...
80106374:	c7 04 24 ce 9c 10 80 	movl   $0x80109cce,(%esp)
...
8010669c:	e8 69 bd ff ff       	call   8010240a <namei>
...
801066af:	e9 1e 01 00 00       	jmp    801067d2 <sys_link+0x17a>
  ...
  begin_trans();
801066b4:	e8 66 d3 ff ff       	call   80103a1f <begin_trans>

  ilock(ip);
801066b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066bc:	89 04 24             	mov    %eax,(%esp)
801066bf:	e8 a4 b1 ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
...
801066d7:	e8 10 b4 ff ff       	call   80101aec <iunlockput>
    commit_trans();
801066dc:	e8 90 d3 ff ff       	call   80103a71 <commit_trans>
    return -1;
...
80106702:	e8 a5 af ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80106707:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010670a:	89 04 24             	mov    %eax,(%esp)
8010670d:	e8 a4 b2 ff ff       	call   801019b6 <iunlock>
...
8010671f:	e8 08 bd ff ff       	call   8010242c <nameiparent>
...
80106733:	e8 30 b1 ff ff       	call   80101868 <ilock>
...
8010675d:	e8 e7 b9 ff ff       	call   80102149 <dirlink>
...
8010676c:	e8 7b b3 ff ff       	call   80101aec <iunlockput>
    goto bad;
...
80106779:	e8 6e b3 ff ff       	call   80101aec <iunlockput>
  iput(ip);
8010677e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106781:	89 04 24             	mov    %eax,(%esp)
80106784:	e8 92 b2 ff ff       	call   80101a1b <iput>

  commit_trans();
80106789:	e8 e3 d2 ff ff       	call   80103a71 <commit_trans>
...
8010679c:	e8 c7 b0 ff ff       	call   80101868 <ilock>
  ip->nlink--;
...
801067b8:	e8 ef ae ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
801067bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067c0:	89 04 24             	mov    %eax,(%esp)
801067c3:	e8 24 b3 ff ff       	call   80101aec <iunlockput>
  commit_trans();
801067c8:	e8 a4 d2 ff ff       	call   80103a71 <commit_trans>
  return -1;
...
801067ff:	e8 5a b5 ff ff       	call   80101d5e <readi>
80106804:	83 f8 10             	cmp    $0x10,%eax
80106807:	74 0c                	je     80106815 <isdirempty+0x41>
      panic("isdirempty: readi");
80106809:	c7 04 24 ea 9c 10 80 	movl   $0x80109cea,(%esp)
...
80106848:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010684b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010684f:	8b 45 08             	mov    0x8(%ebp),%eax
80106852:	89 04 24             	mov    %eax,(%esp)
80106855:	e8 d2 bb ff ff       	call   8010242c <nameiparent>
8010685a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010685d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106861:	75 0a                	jne    8010686d <unlink+0x2b>
    return -1;
80106863:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106868:	e9 85 01 00 00       	jmp    801069f2 <unlink+0x1b0>

  begin_trans();
8010686d:	e8 ad d1 ff ff       	call   80103a1f <begin_trans>

  ilock(dp);
80106872:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106875:	89 04 24             	mov    %eax,(%esp)
80106878:	e8 eb af ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010687d:	c7 44 24 04 fc 9c 10 	movl   $0x80109cfc,0x4(%esp)
80106884:	80 
80106885:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106888:	89 04 24             	mov    %eax,(%esp)
8010688b:	e8 cf b7 ff ff       	call   8010205f <namecmp>
80106890:	85 c0                	test   %eax,%eax
80106892:	0f 84 45 01 00 00    	je     801069dd <unlink+0x19b>
80106898:	c7 44 24 04 fe 9c 10 	movl   $0x80109cfe,0x4(%esp)
8010689f:	80 
801068a0:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801068a3:	89 04 24             	mov    %eax,(%esp)
801068a6:	e8 b4 b7 ff ff       	call   8010205f <namecmp>
801068ab:	85 c0                	test   %eax,%eax
801068ad:	0f 84 2a 01 00 00    	je     801069dd <unlink+0x19b>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
801068b3:	8d 45 cc             	lea    -0x34(%ebp),%eax
801068b6:	89 44 24 08          	mov    %eax,0x8(%esp)
801068ba:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801068bd:	89 44 24 04          	mov    %eax,0x4(%esp)
801068c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068c4:	89 04 24             	mov    %eax,(%esp)
801068c7:	e8 b5 b7 ff ff       	call   80102081 <dirlookup>
801068cc:	89 45 f0             	mov    %eax,-0x10(%ebp)
801068cf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801068d3:	0f 84 03 01 00 00    	je     801069dc <unlink+0x19a>
    goto bad;
  ilock(ip);
...
801068e7:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801068eb:	66 85 c0             	test   %ax,%ax
801068ee:	7f 0c                	jg     801068fc <unlink+0xba>
    panic("unlink: nlink < 1");
801068f0:	c7 04 24 01 9d 10 80 	movl   $0x80109d01,(%esp)
801068f7:	e8 41 9c ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801068fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068ff:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106903:	66 83 f8 01          	cmp    $0x1,%ax
80106907:	75 1f                	jne    80106928 <unlink+0xe6>
80106909:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010690c:	89 04 24             	mov    %eax,(%esp)
8010690f:	e8 c0 fe ff ff       	call   801067d4 <isdirempty>
80106914:	85 c0                	test   %eax,%eax
80106916:	75 10                	jne    80106928 <unlink+0xe6>
    iunlockput(ip);
80106918:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010691b:	89 04 24             	mov    %eax,(%esp)
8010691e:	e8 c9 b1 ff ff       	call   80101aec <iunlockput>
    goto bad;
80106923:	e9 b5 00 00 00       	jmp    801069dd <unlink+0x19b>
  }

  memset(&de, 0, sizeof(de));
80106928:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010692f:	00 
80106930:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106937:	00 
80106938:	8d 45 e0             	lea    -0x20(%ebp),%eax
8010693b:	89 04 24             	mov    %eax,(%esp)
8010693e:	e8 63 f5 ff ff       	call   80105ea6 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106943:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106946:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
8010694d:	00 
8010694e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106952:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106955:	89 44 24 04          	mov    %eax,0x4(%esp)
80106959:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010695c:	89 04 24             	mov    %eax,(%esp)
8010695f:	e8 65 b5 ff ff       	call   80101ec9 <writei>
80106964:	83 f8 10             	cmp    $0x10,%eax
80106967:	74 0c                	je     80106975 <unlink+0x133>
    panic("unlink: writei");
80106969:	c7 04 24 13 9d 10 80 	movl   $0x80109d13,(%esp)
80106970:	e8 c8 9b ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80106975:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106978:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010697c:	66 83 f8 01          	cmp    $0x1,%ax
80106980:	75 1c                	jne    8010699e <unlink+0x15c>
    dp->nlink--;
80106982:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106985:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106989:	8d 50 ff             	lea    -0x1(%eax),%edx
8010698c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010698f:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106993:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106996:	89 04 24             	mov    %eax,(%esp)
80106999:	e8 0e ad ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
8010699e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069a1:	89 04 24             	mov    %eax,(%esp)
801069a4:	e8 43 b1 ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
801069a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069ac:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801069b0:	8d 50 ff             	lea    -0x1(%eax),%edx
801069b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069b6:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801069ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069bd:	89 04 24             	mov    %eax,(%esp)
801069c0:	e8 e7 ac ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
801069c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069c8:	89 04 24             	mov    %eax,(%esp)
801069cb:	e8 1c b1 ff ff       	call   80101aec <iunlockput>

  commit_trans();
801069d0:	e8 9c d0 ff ff       	call   80103a71 <commit_trans>

  return 0;
801069d5:	b8 00 00 00 00       	mov    $0x0,%eax
801069da:	eb 16                	jmp    801069f2 <unlink+0x1b0>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
801069e3:	e8 04 b1 ff ff       	call   80101aec <iunlockput>
  commit_trans();
801069e8:	e8 84 d0 ff ff       	call   80103a71 <commit_trans>
  return -1;
...
801069f7:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801069fa:	8d 45 cc             	lea    -0x34(%ebp),%eax
801069fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a01:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a08:	e8 83 f8 ff ff       	call   80106290 <argstr>
80106a0d:	85 c0                	test   %eax,%eax
80106a0f:	79 0a                	jns    80106a1b <sys_unlink+0x27>
    return -1;
80106a11:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a16:	e9 aa 01 00 00       	jmp    80106bc5 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80106a1b:	8b 45 cc             	mov    -0x34(%ebp),%eax
80106a1e:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80106a21:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a25:	89 04 24             	mov    %eax,(%esp)
80106a28:	e8 ff b9 ff ff       	call   8010242c <nameiparent>
80106a2d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106a30:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106a34:	75 0a                	jne    80106a40 <sys_unlink+0x4c>
    return -1;
80106a36:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a3b:	e9 85 01 00 00       	jmp    80106bc5 <sys_unlink+0x1d1>

  begin_trans();
80106a40:	e8 da cf ff ff       	call   80103a1f <begin_trans>

  ilock(dp);
80106a45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a48:	89 04 24             	mov    %eax,(%esp)
80106a4b:	e8 18 ae ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80106a50:	c7 44 24 04 fc 9c 10 	movl   $0x80109cfc,0x4(%esp)
80106a57:	80 
80106a58:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106a5b:	89 04 24             	mov    %eax,(%esp)
80106a5e:	e8 fc b5 ff ff       	call   8010205f <namecmp>
80106a63:	85 c0                	test   %eax,%eax
80106a65:	0f 84 45 01 00 00    	je     80106bb0 <sys_unlink+0x1bc>
80106a6b:	c7 44 24 04 fe 9c 10 	movl   $0x80109cfe,0x4(%esp)
80106a72:	80 
80106a73:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106a76:	89 04 24             	mov    %eax,(%esp)
80106a79:	e8 e1 b5 ff ff       	call   8010205f <namecmp>
80106a7e:	85 c0                	test   %eax,%eax
80106a80:	0f 84 2a 01 00 00    	je     80106bb0 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106a86:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106a89:	89 44 24 08          	mov    %eax,0x8(%esp)
80106a8d:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106a90:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a94:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a97:	89 04 24             	mov    %eax,(%esp)
80106a9a:	e8 e2 b5 ff ff       	call   80102081 <dirlookup>
80106a9f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106aa2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106aa6:	0f 84 03 01 00 00    	je     80106baf <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80106aac:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106aaf:	89 04 24             	mov    %eax,(%esp)
80106ab2:	e8 b1 ad ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80106ab7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106aba:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106abe:	66 85 c0             	test   %ax,%ax
80106ac1:	7f 0c                	jg     80106acf <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80106ac3:	c7 04 24 01 9d 10 80 	movl   $0x80109d01,(%esp)
80106aca:	e8 6e 9a ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80106acf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ad2:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106ad6:	66 83 f8 01          	cmp    $0x1,%ax
80106ada:	75 1f                	jne    80106afb <sys_unlink+0x107>
80106adc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106adf:	89 04 24             	mov    %eax,(%esp)
80106ae2:	e8 ed fc ff ff       	call   801067d4 <isdirempty>
80106ae7:	85 c0                	test   %eax,%eax
80106ae9:	75 10                	jne    80106afb <sys_unlink+0x107>
    iunlockput(ip);
80106aeb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106aee:	89 04 24             	mov    %eax,(%esp)
80106af1:	e8 f6 af ff ff       	call   80101aec <iunlockput>
    goto bad;
80106af6:	e9 b5 00 00 00       	jmp    80106bb0 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80106afb:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80106b02:	00 
80106b03:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b0a:	00 
80106b0b:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106b0e:	89 04 24             	mov    %eax,(%esp)
80106b11:	e8 90 f3 ff ff       	call   80105ea6 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106b16:	8b 45 c8             	mov    -0x38(%ebp),%eax
80106b19:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80106b20:	00 
80106b21:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80106b32:	e8 92 b3 ff ff       	call   80101ec9 <writei>
80106b37:	83 f8 10             	cmp    $0x10,%eax
80106b3a:	74 0c                	je     80106b48 <sys_unlink+0x154>
    panic("unlink: writei");
80106b3c:	c7 04 24 13 9d 10 80 	movl   $0x80109d13,(%esp)
80106b43:	e8 f5 99 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80106b48:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b4b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106b4f:	66 83 f8 01          	cmp    $0x1,%ax
80106b53:	75 1c                	jne    80106b71 <sys_unlink+0x17d>
    dp->nlink--;
80106b55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b58:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80106b6c:	e8 3b ab ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
80106b71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b74:	89 04 24             	mov    %eax,(%esp)
80106b77:	e8 70 af ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
80106b7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b7f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106b83:	8d 50 ff             	lea    -0x1(%eax),%edx
80106b86:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b89:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80106b8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b90:	89 04 24             	mov    %eax,(%esp)
80106b93:	e8 14 ab ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106b98:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b9b:	89 04 24             	mov    %eax,(%esp)
80106b9e:	e8 49 af ff ff       	call   80101aec <iunlockput>

  commit_trans();
80106ba3:	e8 c9 ce ff ff       	call   80103a71 <commit_trans>

  return 0;
80106ba8:	b8 00 00 00 00       	mov    $0x0,%eax
80106bad:	eb 16                	jmp    80106bc5 <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106bb6:	e8 31 af ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106bbb:	e8 b1 ce ff ff       	call   80103a71 <commit_trans>
  return -1;
...
80106bca:	83 ec 48             	sub    $0x48,%esp
80106bcd:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106bd0:	8b 55 10             	mov    0x10(%ebp),%edx
80106bd3:	8b 45 14             	mov    0x14(%ebp),%eax
80106bd6:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106bda:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106bde:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
  if((dp = nameiparent(path, name)) == 0)
80106be2:	8d 45 de             	lea    -0x22(%ebp),%eax
80106be5:	89 44 24 04          	mov    %eax,0x4(%esp)
80106be9:	8b 45 08             	mov    0x8(%ebp),%eax
80106bec:	89 04 24             	mov    %eax,(%esp)
80106bef:	e8 38 b8 ff ff       	call   8010242c <nameiparent>
80106bf4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106bf7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106bfb:	75 0a                	jne    80106c07 <create+0x40>
    return 0;
80106bfd:	b8 00 00 00 00       	mov    $0x0,%eax
80106c02:	e9 7e 01 00 00       	jmp    80106d85 <create+0x1be>
  ilock(dp);
80106c07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c0a:	89 04 24             	mov    %eax,(%esp)
80106c0d:	e8 56 ac ff ff       	call   80101868 <ilock>
  if((ip = dirlookup(dp, name, &off)) != 0){
80106c12:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106c15:	89 44 24 08          	mov    %eax,0x8(%esp)
80106c19:	8d 45 de             	lea    -0x22(%ebp),%eax
80106c1c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c23:	89 04 24             	mov    %eax,(%esp)
80106c26:	e8 56 b4 ff ff       	call   80102081 <dirlookup>
80106c2b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106c2e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106c32:	74 47                	je     80106c7b <create+0xb4>
    iunlockput(dp);
80106c34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c37:	89 04 24             	mov    %eax,(%esp)
80106c3a:	e8 ad ae ff ff       	call   80101aec <iunlockput>
    ilock(ip);
80106c3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c42:	89 04 24             	mov    %eax,(%esp)
80106c45:	e8 1e ac ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106c4a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106c4f:	75 15                	jne    80106c66 <create+0x9f>
80106c51:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c54:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106c58:	66 83 f8 02          	cmp    $0x2,%ax
80106c5c:	75 08                	jne    80106c66 <create+0x9f>
      return ip;
80106c5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c61:	e9 1f 01 00 00       	jmp    80106d85 <create+0x1be>
    iunlockput(ip);
80106c66:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c69:	89 04 24             	mov    %eax,(%esp)
80106c6c:	e8 7b ae ff ff       	call   80101aec <iunlockput>
    return 0;
80106c71:	b8 00 00 00 00       	mov    $0x0,%eax
80106c76:	e9 0a 01 00 00       	jmp    80106d85 <create+0x1be>
  }
...
80106c88:	89 04 24             	mov    %eax,(%esp)
80106c8b:	e8 3f a9 ff ff       	call   801015cf <ialloc>
80106c90:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106c93:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106c97:	75 0c                	jne    80106ca5 <create+0xde>
    panic("create: ialloc");
80106c99:	c7 04 24 22 9d 10 80 	movl   $0x80109d22,(%esp)
80106ca0:	e8 98 98 ff ff       	call   8010053d <panic>
  ilock(ip);
80106ca5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ca8:	89 04 24             	mov    %eax,(%esp)
80106cab:	e8 b8 ab ff ff       	call   80101868 <ilock>
  ip->major = major;
80106cb0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106cb3:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106cb7:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106cbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106cbe:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106cc2:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106cc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106cc9:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106ccf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106cd2:	89 04 24             	mov    %eax,(%esp)
80106cd5:	e8 d2 a9 ff ff       	call   801016ac <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80106cda:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106cdf:	75 6a                	jne    80106d4b <create+0x184>
    dp->nlink++;  // for ".."
80106ce1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ce4:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106ce8:	8d 50 01             	lea    0x1(%eax),%edx
80106ceb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cee:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80106cf2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cf5:	89 04 24             	mov    %eax,(%esp)
80106cf8:	e8 af a9 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80106cfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d00:	8b 40 04             	mov    0x4(%eax),%eax
80106d03:	89 44 24 08          	mov    %eax,0x8(%esp)
80106d07:	c7 44 24 04 fc 9c 10 	movl   $0x80109cfc,0x4(%esp)
80106d0e:	80 
80106d0f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d12:	89 04 24             	mov    %eax,(%esp)
80106d15:	e8 2f b4 ff ff       	call   80102149 <dirlink>
80106d1a:	85 c0                	test   %eax,%eax
80106d1c:	78 21                	js     80106d3f <create+0x178>
80106d1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d21:	8b 40 04             	mov    0x4(%eax),%eax
80106d24:	89 44 24 08          	mov    %eax,0x8(%esp)
80106d28:	c7 44 24 04 fe 9c 10 	movl   $0x80109cfe,0x4(%esp)
80106d2f:	80 
80106d30:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d33:	89 04 24             	mov    %eax,(%esp)
80106d36:	e8 0e b4 ff ff       	call   80102149 <dirlink>
80106d3b:	85 c0                	test   %eax,%eax
80106d3d:	79 0c                	jns    80106d4b <create+0x184>
      panic("create dots");
80106d3f:	c7 04 24 31 9d 10 80 	movl   $0x80109d31,(%esp)
80106d46:	e8 f2 97 ff ff       	call   8010053d <panic>
  }
  if(dirlink(dp, name, ip->inum) < 0)
80106d4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106d4e:	8b 40 04             	mov    0x4(%eax),%eax
80106d51:	89 44 24 08          	mov    %eax,0x8(%esp)
80106d55:	8d 45 de             	lea    -0x22(%ebp),%eax
80106d58:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d5f:	89 04 24             	mov    %eax,(%esp)
80106d62:	e8 e2 b3 ff ff       	call   80102149 <dirlink>
80106d67:	85 c0                	test   %eax,%eax
80106d69:	79 0c                	jns    80106d77 <create+0x1b0>
    panic("create: dirlink");
80106d6b:	c7 04 24 3d 9d 10 80 	movl   $0x80109d3d,(%esp)
80106d72:	e8 c6 97 ff ff       	call   8010053d <panic>
  iunlockput(dp);
80106d77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d7a:	89 04 24             	mov    %eax,(%esp)
80106d7d:	e8 6a ad ff ff       	call   80101aec <iunlockput>
...
80106d90:	25 00 02 00 00       	and    $0x200,%eax
80106d95:	85 c0                	test   %eax,%eax
80106d97:	74 40                	je     80106dd9 <fileopen+0x52>
    begin_trans();
80106d99:	e8 81 cc ff ff       	call   80103a1f <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106d9e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106da5:	00 
80106da6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106dad:	00 
80106dae:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106db5:	00 
80106db6:	8b 45 08             	mov    0x8(%ebp),%eax
80106db9:	89 04 24             	mov    %eax,(%esp)
80106dbc:	e8 06 fe ff ff       	call   80106bc7 <create>
80106dc1:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80106dc4:	e8 a8 cc ff ff       	call   80103a71 <commit_trans>
    if(ip == 0)
80106dc9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106dcd:	75 5b                	jne    80106e2a <fileopen+0xa3>
      return 0;
80106dcf:	b8 00 00 00 00       	mov    $0x0,%eax
80106dd4:	e9 f9 00 00 00       	jmp    80106ed2 <fileopen+0x14b>
  } else {
    if((ip = namei(path)) == 0)
80106dd9:	8b 45 08             	mov    0x8(%ebp),%eax
80106ddc:	89 04 24             	mov    %eax,(%esp)
80106ddf:	e8 26 b6 ff ff       	call   8010240a <namei>
80106de4:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106de7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106deb:	75 0a                	jne    80106df7 <fileopen+0x70>
      return 0;
80106ded:	b8 00 00 00 00       	mov    $0x0,%eax
80106df2:	e9 db 00 00 00       	jmp    80106ed2 <fileopen+0x14b>
    ilock(ip);
80106df7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dfa:	89 04 24             	mov    %eax,(%esp)
80106dfd:	e8 66 aa ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106e02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e05:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106e09:	66 83 f8 01          	cmp    $0x1,%ax
80106e0d:	75 1b                	jne    80106e2a <fileopen+0xa3>
80106e0f:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80106e13:	74 15                	je     80106e2a <fileopen+0xa3>
      iunlockput(ip);
80106e15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e18:	89 04 24             	mov    %eax,(%esp)
80106e1b:	e8 cc ac ff ff       	call   80101aec <iunlockput>
      return 0;
80106e20:	b8 00 00 00 00       	mov    $0x0,%eax
80106e25:	e9 a8 00 00 00       	jmp    80106ed2 <fileopen+0x14b>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106e2a:	e8 ed a0 ff ff       	call   80100f1c <filealloc>
80106e2f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106e32:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106e36:	74 14                	je     80106e4c <fileopen+0xc5>
80106e38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e3b:	89 04 24             	mov    %eax,(%esp)
80106e3e:	e8 ca f5 ff ff       	call   8010640d <fdalloc>
80106e43:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106e46:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106e4a:	79 23                	jns    80106e6f <fileopen+0xe8>
    if(f)
80106e4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106e50:	74 0b                	je     80106e5d <fileopen+0xd6>
      fileclose(f);
80106e52:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e55:	89 04 24             	mov    %eax,(%esp)
80106e58:	e8 67 a1 ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
...
80106e6d:	eb 63                	jmp    80106ed2 <fileopen+0x14b>
  }
  iunlock(ip);
80106e6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e72:	89 04 24             	mov    %eax,(%esp)
80106e75:	e8 3c ab ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
80106e7a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e7d:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106e83:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e86:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106e89:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106e8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106e8f:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106e96:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e99:	83 e0 01             	and    $0x1,%eax
80106e9c:	85 c0                	test   %eax,%eax
80106e9e:	0f 94 c2             	sete   %dl
80106ea1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ea4:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106ea7:	8b 45 0c             	mov    0xc(%ebp),%eax
80106eaa:	83 e0 01             	and    $0x1,%eax
80106ead:	84 c0                	test   %al,%al
80106eaf:	75 0a                	jne    80106ebb <fileopen+0x134>
80106eb1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106eb4:	83 e0 02             	and    $0x2,%eax
80106eb7:	85 c0                	test   %eax,%eax
80106eb9:	74 07                	je     80106ec2 <fileopen+0x13b>
80106ebb:	b8 01 00 00 00       	mov    $0x1,%eax
80106ec0:	eb 05                	jmp    80106ec7 <fileopen+0x140>
80106ec2:	b8 00 00 00 00       	mov    $0x0,%eax
80106ec7:	89 c2                	mov    %eax,%edx
80106ec9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ecc:	88 50 09             	mov    %dl,0x9(%eax)
  return f;
...
80106ed7:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106eda:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106edd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ee1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ee8:	e8 a3 f3 ff ff       	call   80106290 <argstr>
80106eed:	85 c0                	test   %eax,%eax
80106eef:	78 17                	js     80106f08 <sys_open+0x34>
80106ef1:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106ef4:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ef8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106eff:	e8 f2 f2 ff ff       	call   801061f6 <argint>
80106f04:	85 c0                	test   %eax,%eax
80106f06:	79 0a                	jns    80106f12 <sys_open+0x3e>
    return -1;
80106f08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f0d:	e9 46 01 00 00       	jmp    80107058 <sys_open+0x184>
  if(omode & O_CREATE){
80106f12:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106f15:	25 00 02 00 00       	and    $0x200,%eax
80106f1a:	85 c0                	test   %eax,%eax
80106f1c:	74 40                	je     80106f5e <sys_open+0x8a>
    begin_trans();
80106f1e:	e8 fc ca ff ff       	call   80103a1f <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106f23:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106f26:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106f2d:	00 
80106f2e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106f35:	00 
80106f36:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80106f3d:	00 
80106f3e:	89 04 24             	mov    %eax,(%esp)
80106f41:	e8 81 fc ff ff       	call   80106bc7 <create>
80106f46:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80106f49:	e8 23 cb ff ff       	call   80103a71 <commit_trans>
    if(ip == 0)
80106f4e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106f52:	75 5c                	jne    80106fb0 <sys_open+0xdc>
      return -1;
80106f54:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f59:	e9 fa 00 00 00       	jmp    80107058 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
80106f5e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106f61:	89 04 24             	mov    %eax,(%esp)
80106f64:	e8 a1 b4 ff ff       	call   8010240a <namei>
80106f69:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106f6c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106f70:	75 0a                	jne    80106f7c <sys_open+0xa8>
      return -1;
80106f72:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f77:	e9 dc 00 00 00       	jmp    80107058 <sys_open+0x184>
    ilock(ip);
80106f7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f7f:	89 04 24             	mov    %eax,(%esp)
80106f82:	e8 e1 a8 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106f87:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f8a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106f8e:	66 83 f8 01          	cmp    $0x1,%ax
80106f92:	75 1c                	jne    80106fb0 <sys_open+0xdc>
80106f94:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106f97:	85 c0                	test   %eax,%eax
80106f99:	74 15                	je     80106fb0 <sys_open+0xdc>
      iunlockput(ip);
80106f9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f9e:	89 04 24             	mov    %eax,(%esp)
80106fa1:	e8 46 ab ff ff       	call   80101aec <iunlockput>
      return -1;
80106fa6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106fab:	e9 a8 00 00 00       	jmp    80107058 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106fb0:	e8 67 9f ff ff       	call   80100f1c <filealloc>
80106fb5:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106fb8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106fbc:	74 14                	je     80106fd2 <sys_open+0xfe>
80106fbe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106fc1:	89 04 24             	mov    %eax,(%esp)
80106fc4:	e8 44 f4 ff ff       	call   8010640d <fdalloc>
80106fc9:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106fcc:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106fd0:	79 23                	jns    80106ff5 <sys_open+0x121>
    if(f)
80106fd2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106fd6:	74 0b                	je     80106fe3 <sys_open+0x10f>
      fileclose(f);
80106fd8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106fdb:	89 04 24             	mov    %eax,(%esp)
80106fde:	e8 e1 9f ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
...
80106ff3:	eb 63                	jmp    80107058 <sys_open+0x184>
  }
  iunlock(ip);
80106ff5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ff8:	89 04 24             	mov    %eax,(%esp)
80106ffb:	e8 b6 a9 ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
80107000:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107003:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80107009:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010700c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010700f:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80107012:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107015:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
8010701c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010701f:	83 e0 01             	and    $0x1,%eax
80107022:	85 c0                	test   %eax,%eax
80107024:	0f 94 c2             	sete   %dl
80107027:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010702a:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010702d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107030:	83 e0 01             	and    $0x1,%eax
80107033:	84 c0                	test   %al,%al
80107035:	75 0a                	jne    80107041 <sys_open+0x16d>
80107037:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010703a:	83 e0 02             	and    $0x2,%eax
8010703d:	85 c0                	test   %eax,%eax
8010703f:	74 07                	je     80107048 <sys_open+0x174>
80107041:	b8 01 00 00 00       	mov    $0x1,%eax
80107046:	eb 05                	jmp    8010704d <sys_open+0x179>
80107048:	b8 00 00 00 00       	mov    $0x0,%eax
8010704d:	89 c2                	mov    %eax,%edx
8010704f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107052:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80107055:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80107058:	c9                   	leave  
80107059:	c3                   	ret    
...
8010705d:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
80107060:	e8 ba c9 ff ff       	call   80103a1f <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80107065:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107068:	89 44 24 04          	mov    %eax,0x4(%esp)
8010706c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107073:	e8 18 f2 ff ff       	call   80106290 <argstr>
80107078:	85 c0                	test   %eax,%eax
8010707a:	78 2c                	js     801070a8 <sys_mkdir+0x4e>
8010707c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010707f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80107086:	00 
80107087:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010708e:	00 
8010708f:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107096:	00 
80107097:	89 04 24             	mov    %eax,(%esp)
8010709a:	e8 28 fb ff ff       	call   80106bc7 <create>
8010709f:	89 45 f4             	mov    %eax,-0xc(%ebp)
801070a2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801070a6:	75 0c                	jne    801070b4 <sys_mkdir+0x5a>
    commit_trans();
801070a8:	e8 c4 c9 ff ff       	call   80103a71 <commit_trans>
    return -1;
801070ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801070b2:	eb 15                	jmp    801070c9 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
...
801070ba:	e8 2d aa ff ff       	call   80101aec <iunlockput>
  commit_trans();
801070bf:	e8 ad c9 ff ff       	call   80103a71 <commit_trans>
  return 0;
...
801070ce:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
801070d1:	e8 49 c9 ff ff       	call   80103a1f <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
801070d6:	8d 45 ec             	lea    -0x14(%ebp),%eax
801070d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801070dd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801070e4:	e8 a7 f1 ff ff       	call   80106290 <argstr>
801070e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
801070ec:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801070f0:	78 5e                	js     80107150 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
801070f2:	8d 45 e8             	lea    -0x18(%ebp),%eax
801070f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801070f9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80107100:	e8 f1 f0 ff ff       	call   801061f6 <argint>
  char *path;
  int len;
  int major, minor;
...
80107107:	78 47                	js     80107150 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80107109:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010710c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107110:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80107117:	e8 da f0 ff ff       	call   801061f6 <argint>
  int len;
  int major, minor;
...
8010711e:	78 30                	js     80107150 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80107120:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107123:	0f bf c8             	movswl %ax,%ecx
80107126:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107129:	0f bf d0             	movswl %ax,%edx
8010712c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010712f:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107133:	89 54 24 08          	mov    %edx,0x8(%esp)
80107137:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010713e:	00 
8010713f:	89 04 24             	mov    %eax,(%esp)
80107142:	e8 80 fa ff ff       	call   80106bc7 <create>
80107147:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010714a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010714e:	75 0c                	jne    8010715c <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80107150:	e8 1c c9 ff ff       	call   80103a71 <commit_trans>
    return -1;
80107155:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010715a:	eb 15                	jmp    80107171 <sys_mknod+0xa6>
  }
  iunlockput(ip);
8010715c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010715f:	89 04 24             	mov    %eax,(%esp)
80107162:	e8 85 a9 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80107167:	e8 05 c9 ff ff       	call   80103a71 <commit_trans>
  return 0;
...
80107179:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010717c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107180:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107187:	e8 04 f1 ff ff       	call   80106290 <argstr>
8010718c:	85 c0                	test   %eax,%eax
8010718e:	78 14                	js     801071a4 <sys_chdir+0x31>
80107190:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107193:	89 04 24             	mov    %eax,(%esp)
80107196:	e8 6f b2 ff ff       	call   8010240a <namei>
8010719b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010719e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801071a2:	75 07                	jne    801071ab <sys_chdir+0x38>
    return -1;
801071a4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801071a9:	eb 57                	jmp    80107202 <sys_chdir+0x8f>
  ilock(ip);
801071ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071ae:	89 04 24             	mov    %eax,(%esp)
801071b1:	e8 b2 a6 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
801071b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071b9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801071bd:	66 83 f8 01          	cmp    $0x1,%ax
801071c1:	74 12                	je     801071d5 <sys_chdir+0x62>
    iunlockput(ip);
801071c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071c6:	89 04 24             	mov    %eax,(%esp)
801071c9:	e8 1e a9 ff ff       	call   80101aec <iunlockput>
    return -1;
801071ce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801071d3:	eb 2d                	jmp    80107202 <sys_chdir+0x8f>
  }
  iunlock(ip);
801071d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071d8:	89 04 24             	mov    %eax,(%esp)
801071db:	e8 d6 a7 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
801071e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071e6:	8b 40 68             	mov    0x68(%eax),%eax
801071e9:	89 04 24             	mov    %eax,(%esp)
801071ec:	e8 2a a8 ff ff       	call   80101a1b <iput>
  proc->cwd = ip;
801071f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801071f7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801071fa:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
801071fd:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107202:	c9                   	leave  
80107203:	c3                   	ret    
...
80107207:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80107210:	89 44 24 04          	mov    %eax,0x4(%esp)
80107214:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010721b:	e8 70 f0 ff ff       	call   80106290 <argstr>
80107220:	85 c0                	test   %eax,%eax
80107222:	78 1a                	js     8010723e <sys_exec+0x3a>
80107224:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010722a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010722e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80107235:	e8 bc ef ff ff       	call   801061f6 <argint>
8010723a:	85 c0                	test   %eax,%eax
8010723c:	79 0a                	jns    80107248 <sys_exec+0x44>
    return -1;
8010723e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107243:	e9 e2 00 00 00       	jmp    8010732a <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
80107248:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010724f:	00 
80107250:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107257:	00 
80107258:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010725e:	89 04 24             	mov    %eax,(%esp)
80107261:	e8 40 ec ff ff       	call   80105ea6 <memset>
  for(i=0;; i++){
80107266:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010726d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107270:	83 f8 1f             	cmp    $0x1f,%eax
80107273:	76 0a                	jbe    8010727f <sys_exec+0x7b>
      return -1;
80107275:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010727a:	e9 ab 00 00 00       	jmp    8010732a <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
8010727f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107282:	c1 e0 02             	shl    $0x2,%eax
80107285:	89 c2                	mov    %eax,%edx
80107287:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010728d:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107290:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107296:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
8010729c:	89 54 24 08          	mov    %edx,0x8(%esp)
801072a0:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801072a4:	89 04 24             	mov    %eax,(%esp)
801072a7:	e8 b8 ee ff ff       	call   80106164 <fetchint>
801072ac:	85 c0                	test   %eax,%eax
801072ae:	79 07                	jns    801072b7 <sys_exec+0xb3>
      return -1;
801072b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801072b5:	eb 73                	jmp    8010732a <sys_exec+0x126>
    if(uarg == 0){
801072b7:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801072bd:	85 c0                	test   %eax,%eax
801072bf:	75 26                	jne    801072e7 <sys_exec+0xe3>
      argv[i] = 0;
801072c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801072c4:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801072cb:	00 00 00 00 
      break;
801072cf:	90                   	nop
    }
...
801072d3:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801072d9:	89 54 24 04          	mov    %edx,0x4(%esp)
801072dd:	89 04 24             	mov    %eax,(%esp)
801072e0:	e8 17 98 ff ff       	call   80100afc <exec>
801072e5:	eb 43                	jmp    8010732a <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
801072ea:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801072f1:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801072f7:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
801072fa:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80107300:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107306:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010730a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010730e:	89 04 24             	mov    %eax,(%esp)
80107311:	e8 82 ee ff ff       	call   80106198 <fetchstr>
80107316:	85 c0                	test   %eax,%eax
80107318:	79 07                	jns    80107321 <sys_exec+0x11d>
      return -1;
8010731a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010731f:	eb 09                	jmp    8010732a <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80107321:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
80107325:	e9 43 ff ff ff       	jmp    8010726d <sys_exec+0x69>
  return exec(path, argv);
}
8010732a:	c9                   	leave  
8010732b:	c3                   	ret    
...
8010732f:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80107332:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80107339:	00 
8010733a:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010733d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107341:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107348:	e8 e1 ee ff ff       	call   8010622e <argptr>
8010734d:	85 c0                	test   %eax,%eax
8010734f:	79 0a                	jns    8010735b <sys_pipe+0x2f>
    return -1;
80107351:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107356:	e9 9b 00 00 00       	jmp    801073f6 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
8010735b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010735e:	89 44 24 04          	mov    %eax,0x4(%esp)
80107362:	8d 45 e8             	lea    -0x18(%ebp),%eax
80107365:	89 04 24             	mov    %eax,(%esp)
80107368:	e8 cb d0 ff ff       	call   80104438 <pipealloc>
8010736d:	85 c0                	test   %eax,%eax
8010736f:	79 07                	jns    80107378 <sys_pipe+0x4c>
    return -1;
80107371:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107376:	eb 7e                	jmp    801073f6 <sys_pipe+0xca>
  fd0 = -1;
80107378:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010737f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107382:	89 04 24             	mov    %eax,(%esp)
80107385:	e8 83 f0 ff ff       	call   8010640d <fdalloc>
8010738a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010738d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107391:	78 14                	js     801073a7 <sys_pipe+0x7b>
80107393:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107396:	89 04 24             	mov    %eax,(%esp)
80107399:	e8 6f f0 ff ff       	call   8010640d <fdalloc>
8010739e:	89 45 f0             	mov    %eax,-0x10(%ebp)
801073a1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801073a5:	79 37                	jns    801073de <sys_pipe+0xb2>
    if(fd0 >= 0)
801073a7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801073ab:	78 14                	js     801073c1 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
801073ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801073b3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801073b6:	83 c2 08             	add    $0x8,%edx
801073b9:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801073c0:	00 
    fileclose(rf);
801073c1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801073c4:	89 04 24             	mov    %eax,(%esp)
801073c7:	e8 f8 9b ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
801073cc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801073cf:	89 04 24             	mov    %eax,(%esp)
801073d2:	e8 ed 9b ff ff       	call   80100fc4 <fileclose>
    return -1;
801073d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801073dc:	eb 18                	jmp    801073f6 <sys_pipe+0xca>
  }
  fd[0] = fd0;
801073de:	8b 45 ec             	mov    -0x14(%ebp),%eax
801073e1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801073e4:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
801073e6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801073e9:	8d 50 04             	lea    0x4(%eax),%edx
801073ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801073ef:	89 02                	mov    %eax,(%edx)
  return 0;
801073f1:	b8 00 00 00 00       	mov    $0x0,%eax
}
801073f6:	c9                   	leave  
801073f7:	c3                   	ret    
...
801073fb:	83 ec 08             	sub    $0x8,%esp
  return fork();
801073fe:	e8 dd dc ff ff       	call   801050e0 <fork>
}
80107403:	c9                   	leave  
80107404:	c3                   	ret    
...
80107408:	83 ec 08             	sub    $0x8,%esp
  exit();
8010740b:	e8 33 de ff ff       	call   80105243 <exit>
  return 0;  // not reached
80107410:	b8 00 00 00 00       	mov    $0x0,%eax
}
80107415:	c9                   	leave  
80107416:	c3                   	ret    
...
8010741a:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010741d:	e8 5d df ff ff       	call   8010537f <wait>
}
80107422:	c9                   	leave  
80107423:	c3                   	ret    
...
80107427:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &pid) < 0)
8010742a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010742d:	89 44 24 04          	mov    %eax,0x4(%esp)
80107431:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107438:	e8 b9 ed ff ff       	call   801061f6 <argint>
8010743d:	85 c0                	test   %eax,%eax
8010743f:	79 07                	jns    80107448 <sys_kill+0x24>
    return -1;
80107441:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107446:	eb 0b                	jmp    80107453 <sys_kill+0x2f>
  return kill(pid);
80107448:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010744b:	89 04 24             	mov    %eax,(%esp)
8010744e:	e8 ca e4 ff ff       	call   8010591d <kill>
}
80107453:	c9                   	leave  
80107454:	c3                   	ret    
...
8010745e:	8b 40 10             	mov    0x10(%eax),%eax
}
80107461:	5d                   	pop    %ebp
80107462:	c3                   	ret    
...
80107466:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80107469:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010746c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107470:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107477:	e8 7a ed ff ff       	call   801061f6 <argint>
8010747c:	85 c0                	test   %eax,%eax
8010747e:	79 07                	jns    80107487 <sys_sbrk+0x24>
    return -1;
80107480:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107485:	eb 24                	jmp    801074ab <sys_sbrk+0x48>
  addr = proc->sz;
80107487:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010748d:	8b 00                	mov    (%eax),%eax
8010748f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
80107492:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107495:	89 04 24             	mov    %eax,(%esp)
80107498:	e8 9e db ff ff       	call   8010503b <growproc>
8010749d:	85 c0                	test   %eax,%eax
8010749f:	79 07                	jns    801074a8 <sys_sbrk+0x45>
    return -1;
801074a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801074a6:	eb 03                	jmp    801074ab <sys_sbrk+0x48>
  return addr;
...
801074c1:	e8 30 ed ff ff       	call   801061f6 <argint>
801074c6:	85 c0                	test   %eax,%eax
801074c8:	79 07                	jns    801074d1 <sys_sleep+0x24>
    return -1;
801074ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801074cf:	eb 6c                	jmp    8010753d <sys_sleep+0x90>
  acquire(&tickslock);
801074d1:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
801074d8:	e8 42 e7 ff ff       	call   80105c1f <acquire>
  ticks0 = ticks;
801074dd:	a1 00 a5 12 80       	mov    0x8012a500,%eax
801074e2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801074e5:	eb 34                	jmp    8010751b <sys_sleep+0x6e>
    if(proc->killed){
801074e7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801074ed:	8b 40 24             	mov    0x24(%eax),%eax
801074f0:	85 c0                	test   %eax,%eax
801074f2:	74 13                	je     80107507 <sys_sleep+0x5a>
      release(&tickslock);
801074f4:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
801074fb:	e8 ba e7 ff ff       	call   80105cba <release>
      return -1;
80107500:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107505:	eb 36                	jmp    8010753d <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80107507:	c7 44 24 04 c0 9c 12 	movl   $0x80129cc0,0x4(%esp)
8010750e:	80 
8010750f:	c7 04 24 00 a5 12 80 	movl   $0x8012a500,(%esp)
80107516:	e8 c2 e1 ff ff       	call   801056dd <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010751b:	a1 00 a5 12 80       	mov    0x8012a500,%eax
80107520:	89 c2                	mov    %eax,%edx
80107522:	2b 55 f4             	sub    -0xc(%ebp),%edx
80107525:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107528:	39 c2                	cmp    %eax,%edx
8010752a:	72 bb                	jb     801074e7 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010752c:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
80107533:	e8 82 e7 ff ff       	call   80105cba <release>
  return 0;
80107538:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010753d:	c9                   	leave  
8010753e:	c3                   	ret    
...
80107542:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
80107545:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
8010754c:	e8 ce e6 ff ff       	call   80105c1f <acquire>
  xticks = ticks;
80107551:	a1 00 a5 12 80       	mov    0x8012a500,%eax
80107556:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80107559:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
80107560:	e8 55 e7 ff ff       	call   80105cba <release>
  return xticks;
...
8010756b:	89 e5                	mov    %esp,%ebp
  swapFlag = 1;
8010756d:	c7 05 80 c6 10 80 01 	movl   $0x1,0x8010c680
80107574:	00 00 00 
}
80107577:	5d                   	pop    %ebp
80107578:	c3                   	ret    

80107579 <sys_disableSwapping>:
...
8010757a:	89 e5                	mov    %esp,%ebp
  swapFlag = 0;
8010757c:	c7 05 80 c6 10 80 00 	movl   $0x0,0x8010c680
80107583:	00 00 00 
}
80107586:	5d                   	pop    %ebp
80107587:	c3                   	ret    
...
8010758b:	83 ec 18             	sub    $0x18,%esp
  acquire(&tickslock);
8010758e:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
80107595:	e8 85 e6 ff ff       	call   80105c1f <acquire>
  if(proc->killed){
8010759a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801075a0:	8b 40 24             	mov    0x24(%eax),%eax
801075a3:	85 c0                	test   %eax,%eax
801075a5:	74 13                	je     801075ba <sys_sleep2+0x32>
    release(&tickslock);
801075a7:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
801075ae:	e8 07 e7 ff ff       	call   80105cba <release>
    return -1;
801075b3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801075b8:	eb 25                	jmp    801075df <sys_sleep2+0x57>
  }
  sleep(&swapFlag, &tickslock);
801075ba:	c7 44 24 04 c0 9c 12 	movl   $0x80129cc0,0x4(%esp)
801075c1:	80 
801075c2:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
801075c9:	e8 0f e1 ff ff       	call   801056dd <sleep>
  release(&tickslock);
801075ce:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
801075d5:	e8 e0 e6 ff ff       	call   80105cba <release>
  return 0;
801075da:	b8 00 00 00 00       	mov    $0x0,%eax
}
801075df:	c9                   	leave  
801075e0:	c3                   	ret    

801075e1 <sys_wakeup2>:

int
sys_wakeup2(void)
{
801075e1:	55                   	push   %ebp
801075e2:	89 e5                	mov    %esp,%ebp
801075e4:	83 ec 18             	sub    $0x18,%esp
  wakeup(&swapFlag);
801075e7:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
801075ee:	e8 ff e2 ff ff       	call   801058f2 <wakeup>
  return 0;
801075f3:	b8 00 00 00 00       	mov    $0x0,%eax
}
801075f8:	c9                   	leave  
801075f9:	c3                   	ret    

801075fa <sys_getAllocatedPages>:
...
801075fd:	83 ec 28             	sub    $0x28,%esp
  int pid;
  if(argint(0, &pid) < 0)
80107600:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107603:	89 44 24 04          	mov    %eax,0x4(%esp)
80107607:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010760e:	e8 e3 eb ff ff       	call   801061f6 <argint>
80107613:	85 c0                	test   %eax,%eax
80107615:	79 07                	jns    8010761e <sys_getAllocatedPages+0x24>
    return -1;
80107617:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010761c:	eb 0b                	jmp    80107629 <sys_getAllocatedPages+0x2f>
  return getAllocatedPages(pid);
8010761e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107621:	89 04 24             	mov    %eax,(%esp)
80107624:	e8 ba e4 ff ff       	call   80105ae3 <getAllocatedPages>
}
80107629:	c9                   	leave  
8010762a:	c3                   	ret    
...
8010762e:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &key) < 0)
80107631:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107634:	89 44 24 04          	mov    %eax,0x4(%esp)
80107638:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010763f:	e8 b2 eb ff ff       	call   801061f6 <argint>
80107644:	85 c0                	test   %eax,%eax
80107646:	79 07                	jns    8010764f <sys_shmget+0x24>
    return -1;
80107648:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010764d:	eb 65                	jmp    801076b4 <sys_shmget+0x89>
  
  if(argint(1, &size) < 0)
8010764f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80107652:	89 44 24 04          	mov    %eax,0x4(%esp)
80107656:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010765d:	e8 94 eb ff ff       	call   801061f6 <argint>
80107662:	85 c0                	test   %eax,%eax
80107664:	79 07                	jns    8010766d <sys_shmget+0x42>
    return -1;
80107666:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010766b:	eb 47                	jmp    801076b4 <sys_shmget+0x89>
  if(size<0)
8010766d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107670:	85 c0                	test   %eax,%eax
80107672:	79 07                	jns    8010767b <sys_shmget+0x50>
    return -1;
80107674:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107679:	eb 39                	jmp    801076b4 <sys_shmget+0x89>
  
  if(argint(2, &shmflg) < 0)
8010767b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010767e:	89 44 24 04          	mov    %eax,0x4(%esp)
80107682:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80107689:	e8 68 eb ff ff       	call   801061f6 <argint>
8010768e:	85 c0                	test   %eax,%eax
80107690:	79 07                	jns    80107699 <sys_shmget+0x6e>
    return -1;
80107692:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107697:	eb 1b                	jmp    801076b4 <sys_shmget+0x89>
  
  return shmget(key, (uint)size,shmflg);
80107699:	8b 4d ec             	mov    -0x14(%ebp),%ecx
8010769c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010769f:	89 c2                	mov    %eax,%edx
801076a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a4:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801076a8:	89 54 24 04          	mov    %edx,0x4(%esp)
801076ac:	89 04 24             	mov    %eax,(%esp)
801076af:	e8 a9 b4 ff ff       	call   80102b5d <shmget>
}
801076b4:	c9                   	leave  
801076b5:	c3                   	ret    
...
801076b9:	83 ec 28             	sub    $0x28,%esp
  int shmid;
  if(argint(0, &shmid) < 0)
801076bc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801076bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801076c3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801076ca:	e8 27 eb ff ff       	call   801061f6 <argint>
801076cf:	85 c0                	test   %eax,%eax
801076d1:	79 07                	jns    801076da <sys_shmdel+0x24>
    return -1;
801076d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801076d8:	eb 0b                	jmp    801076e5 <sys_shmdel+0x2f>
  
  return shmdel(shmid);
801076da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076dd:	89 04 24             	mov    %eax,(%esp)
801076e0:	e8 dd b5 ff ff       	call   80102cc2 <shmdel>
}
801076e5:	c9                   	leave  
801076e6:	c3                   	ret    
...
801076ea:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &shmid) < 0)
801076ed:	8d 45 f4             	lea    -0xc(%ebp),%eax
801076f0:	89 44 24 04          	mov    %eax,0x4(%esp)
801076f4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801076fb:	e8 f6 ea ff ff       	call   801061f6 <argint>
80107700:	85 c0                	test   %eax,%eax
80107702:	79 07                	jns    8010770b <sys_shmat+0x24>
    return (void*)-1;
80107704:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107709:	eb 30                	jmp    8010773b <sys_shmat+0x54>
  
  if(argint(1, &shmflg) < 0)
8010770b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010770e:	89 44 24 04          	mov    %eax,0x4(%esp)
80107712:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80107719:	e8 d8 ea ff ff       	call   801061f6 <argint>
8010771e:	85 c0                	test   %eax,%eax
80107720:	79 07                	jns    80107729 <sys_shmat+0x42>
    return (void*)-1;
80107722:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107727:	eb 12                	jmp    8010773b <sys_shmat+0x54>
  
  return shmat(shmid,shmflg);
80107729:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010772c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010772f:	89 54 24 04          	mov    %edx,0x4(%esp)
80107733:	89 04 24             	mov    %eax,(%esp)
80107736:	e8 62 b6 ff ff       	call   80102d9d <shmat>
}
8010773b:	c9                   	leave  
8010773c:	c3                   	ret    
...
80107740:	83 ec 28             	sub    $0x28,%esp
  void* shmaddr;
  if(argptr(0, (void*)&shmaddr,sizeof(void*)) < 0)
80107743:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010774a:	00 
8010774b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010774e:	89 44 24 04          	mov    %eax,0x4(%esp)
80107752:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107759:	e8 d0 ea ff ff       	call   8010622e <argptr>
8010775e:	85 c0                	test   %eax,%eax
80107760:	79 07                	jns    80107769 <sys_shmdt+0x2c>
    return -1;
80107762:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107767:	eb 0b                	jmp    80107774 <sys_shmdt+0x37>
  return shmdt(shmaddr);
80107769:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010776c:	89 04 24             	mov    %eax,(%esp)
8010776f:	e8 41 b8 ff ff       	call   80102fb5 <shmdt>
}
80107774:	c9                   	leave  
80107775:	c3                   	ret    
	...
...
8010777e:	8b 55 08             	mov    0x8(%ebp),%edx
80107781:	8b 45 0c             	mov    0xc(%ebp),%eax
80107784:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80107788:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010778b:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010778f:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80107793:	ee                   	out    %al,(%dx)
}
80107794:	c9                   	leave  
80107795:	c3                   	ret    
...
8010779c:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801077a3:	00 
801077a4:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801077ab:	e8 c8 ff ff ff       	call   80107778 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801077b0:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801077b7:	00 
801077b8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801077bf:	e8 b4 ff ff ff       	call   80107778 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801077c4:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801077cb:	00 
801077cc:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801077d3:	e8 a0 ff ff ff       	call   80107778 <outb>
  picenable(IRQ_TIMER);
801077d8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801077df:	e8 dd ca ff ff       	call   801042c1 <picenable>
}
801077e4:	c9                   	leave  
801077e5:	c3                   	ret    
	...
...
801077e9:	06                   	push   %es
  pushl %fs
801077ea:	0f a0                	push   %fs
  pushl %gs
801077ec:	0f a8                	push   %gs
  pushal
801077ee:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801077ef:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801077f3:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801077f5:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801077f7:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801077fb:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801077fd:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801077ff:	54                   	push   %esp
  call trap
80107800:	e8 de 01 00 00       	call   801079e3 <trap>
  addl $4, %esp
80107805:	83 c4 04             	add    $0x4,%esp
...
80107808:	61                   	popa   
  popl %gs
80107809:	0f a9                	pop    %gs
  popl %fs
8010780b:	0f a1                	pop    %fs
  popl %es
8010780d:	07                   	pop    %es
  popl %ds
8010780e:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010780f:	83 c4 08             	add    $0x8,%esp
  iret
80107812:	cf                   	iret   
	...
...
80107817:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
8010781a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010781d:	83 e8 01             	sub    $0x1,%eax
80107820:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107824:	8b 45 08             	mov    0x8(%ebp),%eax
80107827:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010782b:	8b 45 08             	mov    0x8(%ebp),%eax
8010782e:	c1 e8 10             	shr    $0x10,%eax
80107831:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80107835:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107838:	0f 01 18             	lidtl  (%eax)
}
8010783b:	c9                   	leave  
8010783c:	c3                   	ret    
...
80107841:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80107844:	0f 20 d3             	mov    %cr2,%ebx
80107847:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
8010784a:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80107856:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80107859:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107860:	e9 c3 00 00 00       	jmp    80107928 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80107865:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107868:	8b 04 85 bc c0 10 80 	mov    -0x7fef3f44(,%eax,4),%eax
8010786f:	89 c2                	mov    %eax,%edx
80107871:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107874:	66 89 14 c5 00 9d 12 	mov    %dx,-0x7fed6300(,%eax,8)
8010787b:	80 
8010787c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010787f:	66 c7 04 c5 02 9d 12 	movw   $0x8,-0x7fed62fe(,%eax,8)
80107886:	80 08 00 
80107889:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010788c:	0f b6 14 c5 04 9d 12 	movzbl -0x7fed62fc(,%eax,8),%edx
80107893:	80 
80107894:	83 e2 e0             	and    $0xffffffe0,%edx
80107897:	88 14 c5 04 9d 12 80 	mov    %dl,-0x7fed62fc(,%eax,8)
8010789e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a1:	0f b6 14 c5 04 9d 12 	movzbl -0x7fed62fc(,%eax,8),%edx
801078a8:	80 
801078a9:	83 e2 1f             	and    $0x1f,%edx
801078ac:	88 14 c5 04 9d 12 80 	mov    %dl,-0x7fed62fc(,%eax,8)
801078b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b6:	0f b6 14 c5 05 9d 12 	movzbl -0x7fed62fb(,%eax,8),%edx
801078bd:	80 
801078be:	83 e2 f0             	and    $0xfffffff0,%edx
801078c1:	83 ca 0e             	or     $0xe,%edx
801078c4:	88 14 c5 05 9d 12 80 	mov    %dl,-0x7fed62fb(,%eax,8)
801078cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ce:	0f b6 14 c5 05 9d 12 	movzbl -0x7fed62fb(,%eax,8),%edx
801078d5:	80 
801078d6:	83 e2 ef             	and    $0xffffffef,%edx
801078d9:	88 14 c5 05 9d 12 80 	mov    %dl,-0x7fed62fb(,%eax,8)
801078e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e3:	0f b6 14 c5 05 9d 12 	movzbl -0x7fed62fb(,%eax,8),%edx
801078ea:	80 
801078eb:	83 e2 9f             	and    $0xffffff9f,%edx
801078ee:	88 14 c5 05 9d 12 80 	mov    %dl,-0x7fed62fb(,%eax,8)
801078f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078f8:	0f b6 14 c5 05 9d 12 	movzbl -0x7fed62fb(,%eax,8),%edx
801078ff:	80 
80107900:	83 ca 80             	or     $0xffffff80,%edx
80107903:	88 14 c5 05 9d 12 80 	mov    %dl,-0x7fed62fb(,%eax,8)
8010790a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790d:	8b 04 85 bc c0 10 80 	mov    -0x7fef3f44(,%eax,4),%eax
80107914:	c1 e8 10             	shr    $0x10,%eax
80107917:	89 c2                	mov    %eax,%edx
80107919:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010791c:	66 89 14 c5 06 9d 12 	mov    %dx,-0x7fed62fa(,%eax,8)
80107923:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80107924:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107928:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010792f:	0f 8e 30 ff ff ff    	jle    80107865 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80107935:	a1 bc c1 10 80       	mov    0x8010c1bc,%eax
8010793a:	66 a3 00 9f 12 80    	mov    %ax,0x80129f00
80107940:	66 c7 05 02 9f 12 80 	movw   $0x8,0x80129f02
80107947:	08 00 
80107949:	0f b6 05 04 9f 12 80 	movzbl 0x80129f04,%eax
80107950:	83 e0 e0             	and    $0xffffffe0,%eax
80107953:	a2 04 9f 12 80       	mov    %al,0x80129f04
80107958:	0f b6 05 04 9f 12 80 	movzbl 0x80129f04,%eax
8010795f:	83 e0 1f             	and    $0x1f,%eax
80107962:	a2 04 9f 12 80       	mov    %al,0x80129f04
80107967:	0f b6 05 05 9f 12 80 	movzbl 0x80129f05,%eax
8010796e:	83 c8 0f             	or     $0xf,%eax
80107971:	a2 05 9f 12 80       	mov    %al,0x80129f05
80107976:	0f b6 05 05 9f 12 80 	movzbl 0x80129f05,%eax
8010797d:	83 e0 ef             	and    $0xffffffef,%eax
80107980:	a2 05 9f 12 80       	mov    %al,0x80129f05
80107985:	0f b6 05 05 9f 12 80 	movzbl 0x80129f05,%eax
8010798c:	83 c8 60             	or     $0x60,%eax
8010798f:	a2 05 9f 12 80       	mov    %al,0x80129f05
80107994:	0f b6 05 05 9f 12 80 	movzbl 0x80129f05,%eax
8010799b:	83 c8 80             	or     $0xffffff80,%eax
8010799e:	a2 05 9f 12 80       	mov    %al,0x80129f05
801079a3:	a1 bc c1 10 80       	mov    0x8010c1bc,%eax
801079a8:	c1 e8 10             	shr    $0x10,%eax
801079ab:	66 a3 06 9f 12 80    	mov    %ax,0x80129f06
  
  initlock(&tickslock, "time");
801079b1:	c7 44 24 04 50 9d 10 	movl   $0x80109d50,0x4(%esp)
801079b8:	80 
801079b9:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
801079c0:	e8 39 e2 ff ff       	call   80105bfe <initlock>
}
801079c5:	c9                   	leave  
801079c6:	c3                   	ret    
...
801079ca:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801079cd:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801079d4:	00 
801079d5:	c7 04 24 00 9d 12 80 	movl   $0x80129d00,(%esp)
801079dc:	e8 33 fe ff ff       	call   80107814 <lidt>
}
801079e1:	c9                   	leave  
801079e2:	c3                   	ret    
...
801079e6:	57                   	push   %edi
801079e7:	56                   	push   %esi
801079e8:	53                   	push   %ebx
801079e9:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801079ec:	8b 45 08             	mov    0x8(%ebp),%eax
801079ef:	8b 40 30             	mov    0x30(%eax),%eax
801079f2:	83 f8 40             	cmp    $0x40,%eax
801079f5:	75 3e                	jne    80107a35 <trap+0x52>
    if(proc->killed)
801079f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801079fd:	8b 40 24             	mov    0x24(%eax),%eax
80107a00:	85 c0                	test   %eax,%eax
80107a02:	74 05                	je     80107a09 <trap+0x26>
      exit();
80107a04:	e8 3a d8 ff ff       	call   80105243 <exit>
    proc->tf = tf;
80107a09:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107a0f:	8b 55 08             	mov    0x8(%ebp),%edx
80107a12:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80107a15:	e8 b9 e8 ff ff       	call   801062d3 <syscall>
    if(proc->killed)
80107a1a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107a20:	8b 40 24             	mov    0x24(%eax),%eax
80107a23:	85 c0                	test   %eax,%eax
80107a25:	0f 84 34 02 00 00    	je     80107c5f <trap+0x27c>
      exit();
80107a2b:	e8 13 d8 ff ff       	call   80105243 <exit>
    return;
80107a30:	e9 2a 02 00 00       	jmp    80107c5f <trap+0x27c>
  }

  switch(tf->trapno){
80107a35:	8b 45 08             	mov    0x8(%ebp),%eax
80107a38:	8b 40 30             	mov    0x30(%eax),%eax
80107a3b:	83 e8 20             	sub    $0x20,%eax
80107a3e:	83 f8 1f             	cmp    $0x1f,%eax
80107a41:	0f 87 bc 00 00 00    	ja     80107b03 <trap+0x120>
80107a47:	8b 04 85 f8 9d 10 80 	mov    -0x7fef6208(,%eax,4),%eax
80107a4e:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80107a50:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107a56:	0f b6 00             	movzbl (%eax),%eax
80107a59:	84 c0                	test   %al,%al
80107a5b:	75 31                	jne    80107a8e <trap+0xab>
      acquire(&tickslock);
80107a5d:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
80107a64:	e8 b6 e1 ff ff       	call   80105c1f <acquire>
      ticks++;
80107a69:	a1 00 a5 12 80       	mov    0x8012a500,%eax
80107a6e:	83 c0 01             	add    $0x1,%eax
80107a71:	a3 00 a5 12 80       	mov    %eax,0x8012a500
      wakeup(&ticks);
80107a76:	c7 04 24 00 a5 12 80 	movl   $0x8012a500,(%esp)
80107a7d:	e8 70 de ff ff       	call   801058f2 <wakeup>
      release(&tickslock);
80107a82:	c7 04 24 c0 9c 12 80 	movl   $0x80129cc0,(%esp)
80107a89:	e8 2c e2 ff ff       	call   80105cba <release>
    }
    lapiceoi();
80107a8e:	e8 52 bc ff ff       	call   801036e5 <lapiceoi>
    break;
80107a93:	e9 41 01 00 00       	jmp    80107bd9 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80107a98:	e8 5a ac ff ff       	call   801026f7 <ideintr>
    lapiceoi();
80107a9d:	e8 43 bc ff ff       	call   801036e5 <lapiceoi>
    break;
80107aa2:	e9 32 01 00 00       	jmp    80107bd9 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80107aa7:	e8 17 ba ff ff       	call   801034c3 <kbdintr>
    lapiceoi();
80107aac:	e8 34 bc ff ff       	call   801036e5 <lapiceoi>
    break;
80107ab1:	e9 23 01 00 00       	jmp    80107bd9 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80107ab6:	e8 a9 03 00 00       	call   80107e64 <uartintr>
    lapiceoi();
80107abb:	e8 25 bc ff ff       	call   801036e5 <lapiceoi>
    break;
80107ac0:	e9 14 01 00 00       	jmp    80107bd9 <trap+0x1f6>
  case T_IRQ0 + 7:
...
80107ac5:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107ac8:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80107acb:	8b 45 08             	mov    0x8(%ebp),%eax
80107ace:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107ad2:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80107ad5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107adb:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80107ae1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107ae5:	89 54 24 08          	mov    %edx,0x8(%esp)
80107ae9:	89 44 24 04          	mov    %eax,0x4(%esp)
80107aed:	c7 04 24 58 9d 10 80 	movl   $0x80109d58,(%esp)
80107af4:	e8 a8 88 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80107af9:	e8 e7 bb ff ff       	call   801036e5 <lapiceoi>
    break;
80107afe:	e9 d6 00 00 00       	jmp    80107bd9 <trap+0x1f6>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80107b03:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107b09:	85 c0                	test   %eax,%eax
80107b0b:	74 11                	je     80107b1e <trap+0x13b>
80107b0d:	8b 45 08             	mov    0x8(%ebp),%eax
80107b10:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107b14:	0f b7 c0             	movzwl %ax,%eax
80107b17:	83 e0 03             	and    $0x3,%eax
80107b1a:	85 c0                	test   %eax,%eax
80107b1c:	75 46                	jne    80107b64 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b1e:	e8 1a fd ff ff       	call   8010783d <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80107b23:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b26:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107b29:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107b30:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b33:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80107b36:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107b39:	8b 52 30             	mov    0x30(%edx),%edx
80107b3c:	89 44 24 10          	mov    %eax,0x10(%esp)
80107b40:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80107b44:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80107b48:	89 54 24 04          	mov    %edx,0x4(%esp)
80107b4c:	c7 04 24 7c 9d 10 80 	movl   $0x80109d7c,(%esp)
80107b53:	e8 49 88 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80107b58:	c7 04 24 ae 9d 10 80 	movl   $0x80109dae,(%esp)
80107b5f:	e8 d9 89 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107b64:	e8 d4 fc ff ff       	call   8010783d <rcr2>
...
80107b6b:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107b6e:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107b71:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107b77:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107b7a:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107b7d:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107b80:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107b83:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107b86:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80107b89:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107b8f:	83 c0 6c             	add    $0x6c,%eax
80107b92:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107b95:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107b9b:	8b 40 10             	mov    0x10(%eax),%eax
80107b9e:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80107ba2:	89 7c 24 18          	mov    %edi,0x18(%esp)
80107ba6:	89 74 24 14          	mov    %esi,0x14(%esp)
80107baa:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80107bae:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80107bb2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107bb5:	89 54 24 08          	mov    %edx,0x8(%esp)
80107bb9:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bbd:	c7 04 24 b4 9d 10 80 	movl   $0x80109db4,(%esp)
80107bc4:	e8 d8 87 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80107bc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107bcf:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80107bd6:	eb 01                	jmp    80107bd9 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80107be1:	74 24                	je     80107c07 <trap+0x224>
80107be3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107be9:	8b 40 24             	mov    0x24(%eax),%eax
80107bec:	85 c0                	test   %eax,%eax
80107bee:	74 17                	je     80107c07 <trap+0x224>
80107bf0:	8b 45 08             	mov    0x8(%ebp),%eax
80107bf3:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107bf7:	0f b7 c0             	movzwl %ax,%eax
80107bfa:	83 e0 03             	and    $0x3,%eax
80107bfd:	83 f8 03             	cmp    $0x3,%eax
80107c00:	75 05                	jne    80107c07 <trap+0x224>
    exit();
80107c02:	e8 3c d6 ff ff       	call   80105243 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80107c07:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c0d:	85 c0                	test   %eax,%eax
80107c0f:	74 1e                	je     80107c2f <trap+0x24c>
80107c11:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c17:	8b 40 0c             	mov    0xc(%eax),%eax
80107c1a:	83 f8 04             	cmp    $0x4,%eax
80107c1d:	75 10                	jne    80107c2f <trap+0x24c>
80107c1f:	8b 45 08             	mov    0x8(%ebp),%eax
80107c22:	8b 40 30             	mov    0x30(%eax),%eax
80107c25:	83 f8 20             	cmp    $0x20,%eax
80107c28:	75 05                	jne    80107c2f <trap+0x24c>
    yield();
80107c2a:	e8 50 da ff ff       	call   8010567f <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80107c2f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c35:	85 c0                	test   %eax,%eax
80107c37:	74 27                	je     80107c60 <trap+0x27d>
80107c39:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107c3f:	8b 40 24             	mov    0x24(%eax),%eax
80107c42:	85 c0                	test   %eax,%eax
80107c44:	74 1a                	je     80107c60 <trap+0x27d>
80107c46:	8b 45 08             	mov    0x8(%ebp),%eax
80107c49:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107c4d:	0f b7 c0             	movzwl %ax,%eax
80107c50:	83 e0 03             	and    $0x3,%eax
80107c53:	83 f8 03             	cmp    $0x3,%eax
80107c56:	75 08                	jne    80107c60 <trap+0x27d>
    exit();
80107c58:	e8 e6 d5 ff ff       	call   80105243 <exit>
80107c5d:	eb 01                	jmp    80107c60 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80107c60:	83 c4 3c             	add    $0x3c,%esp
80107c63:	5b                   	pop    %ebx
80107c64:	5e                   	pop    %esi
80107c65:	5f                   	pop    %edi
80107c66:	5d                   	pop    %ebp
...
80107c72:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107c76:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80107c7a:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80107c7e:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80107c82:	ec                   	in     (%dx),%al
80107c83:	89 c3                	mov    %eax,%ebx
80107c85:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80107c88:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107c8c:	83 c4 14             	add    $0x14,%esp
80107c8f:	5b                   	pop    %ebx
80107c90:	5d                   	pop    %ebp
80107c91:	c3                   	ret    
...
80107c9e:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80107ca2:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107ca5:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80107ca9:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80107cad:	ee                   	out    %al,(%dx)
}
80107cae:	c9                   	leave  
80107caf:	c3                   	ret    
...
80107cbd:	00 
80107cbe:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107cc5:	e8 c8 ff ff ff       	call   80107c92 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80107cca:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80107cd1:	00 
80107cd2:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107cd9:	e8 b4 ff ff ff       	call   80107c92 <outb>
  outb(COM1+0, 115200/9600);
80107cde:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80107ce5:	00 
80107ce6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107ced:	e8 a0 ff ff ff       	call   80107c92 <outb>
  outb(COM1+1, 0);
80107cf2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107cf9:	00 
80107cfa:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107d01:	e8 8c ff ff ff       	call   80107c92 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80107d06:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107d0d:	00 
80107d0e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107d15:	e8 78 ff ff ff       	call   80107c92 <outb>
  outb(COM1+4, 0);
80107d1a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d21:	00 
80107d22:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107d29:	e8 64 ff ff ff       	call   80107c92 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80107d2e:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107d35:	00 
80107d36:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107d3d:	e8 50 ff ff ff       	call   80107c92 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107d42:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107d49:	e8 1a ff ff ff       	call   80107c68 <inb>
80107d4e:	3c ff                	cmp    $0xff,%al
80107d50:	74 6c                	je     80107dbe <uartinit+0x10e>
    return;
  uart = 1;
80107d52:	c7 05 14 c7 10 80 01 	movl   $0x1,0x8010c714
80107d59:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107d5c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107d63:	e8 00 ff ff ff       	call   80107c68 <inb>
  inb(COM1+0);
80107d68:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107d6f:	e8 f4 fe ff ff       	call   80107c68 <inb>
  picenable(IRQ_COM1);
80107d74:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107d7b:	e8 41 c5 ff ff       	call   801042c1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107d80:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d87:	00 
80107d88:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107d8f:	e8 e6 ab ff ff       	call   8010297a <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107d94:	c7 45 f4 78 9e 10 80 	movl   $0x80109e78,-0xc(%ebp)
80107d9b:	eb 15                	jmp    80107db2 <uartinit+0x102>
    uartputc(*p);
80107d9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107da0:	0f b6 00             	movzbl (%eax),%eax
80107da3:	0f be c0             	movsbl %al,%eax
80107da6:	89 04 24             	mov    %eax,(%esp)
80107da9:	e8 13 00 00 00       	call   80107dc1 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107dae:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80107db2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107db5:	0f b6 00             	movzbl (%eax),%eax
80107db8:	84 c0                	test   %al,%al
80107dba:	75 e1                	jne    80107d9d <uartinit+0xed>
80107dbc:	eb 01                	jmp    80107dbf <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80107dc4:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80107dc7:	a1 14 c7 10 80       	mov    0x8010c714,%eax
80107dcc:	85 c0                	test   %eax,%eax
80107dce:	74 4d                	je     80107e1d <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80107dd0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107dd7:	eb 10                	jmp    80107de9 <uartputc+0x28>
    microdelay(10);
80107dd9:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107de0:	e8 25 b9 ff ff       	call   8010370a <microdelay>
{
  int i;
...
80107de9:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80107ded:	7f 16                	jg     80107e05 <uartputc+0x44>
80107def:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107df6:	e8 6d fe ff ff       	call   80107c68 <inb>
80107dfb:	0f b6 c0             	movzbl %al,%eax
80107dfe:	83 e0 20             	and    $0x20,%eax
80107e01:	85 c0                	test   %eax,%eax
80107e03:	74 d4                	je     80107dd9 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80107e05:	8b 45 08             	mov    0x8(%ebp),%eax
80107e08:	0f b6 c0             	movzbl %al,%eax
80107e0b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e0f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107e16:	e8 77 fe ff ff       	call   80107c92 <outb>
80107e1b:	eb 01                	jmp    80107e1e <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80107e23:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107e26:	a1 14 c7 10 80       	mov    0x8010c714,%eax
80107e2b:	85 c0                	test   %eax,%eax
80107e2d:	75 07                	jne    80107e36 <uartgetc+0x16>
    return -1;
80107e2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107e34:	eb 2c                	jmp    80107e62 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107e36:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107e3d:	e8 26 fe ff ff       	call   80107c68 <inb>
80107e42:	0f b6 c0             	movzbl %al,%eax
80107e45:	83 e0 01             	and    $0x1,%eax
80107e48:	85 c0                	test   %eax,%eax
80107e4a:	75 07                	jne    80107e53 <uartgetc+0x33>
    return -1;
80107e4c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107e51:	eb 0f                	jmp    80107e62 <uartgetc+0x42>
  return inb(COM1+0);
80107e53:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107e5a:	e8 09 fe ff ff       	call   80107c68 <inb>
80107e5f:	0f b6 c0             	movzbl %al,%eax
}
80107e62:	c9                   	leave  
80107e63:	c3                   	ret    
...
80107e67:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80107e6a:	c7 04 24 20 7e 10 80 	movl   $0x80107e20,(%esp)
80107e71:	e8 37 89 ff ff       	call   801007ad <consoleintr>
}
80107e76:	c9                   	leave  
80107e77:	c3                   	ret    
...
80107e7a:	6a 00                	push   $0x0
  jmp alltraps
80107e7c:	e9 67 f9 ff ff       	jmp    801077e8 <alltraps>
...
80107e81:	6a 00                	push   $0x0
  pushl $1
80107e83:	6a 01                	push   $0x1
  jmp alltraps
80107e85:	e9 5e f9 ff ff       	jmp    801077e8 <alltraps>
...
80107e8a:	6a 00                	push   $0x0
  pushl $2
80107e8c:	6a 02                	push   $0x2
  jmp alltraps
80107e8e:	e9 55 f9 ff ff       	jmp    801077e8 <alltraps>
...
80107e93:	6a 00                	push   $0x0
  pushl $3
80107e95:	6a 03                	push   $0x3
  jmp alltraps
80107e97:	e9 4c f9 ff ff       	jmp    801077e8 <alltraps>
...
80107e9c:	6a 00                	push   $0x0
  pushl $4
80107e9e:	6a 04                	push   $0x4
  jmp alltraps
80107ea0:	e9 43 f9 ff ff       	jmp    801077e8 <alltraps>
...
80107ea5:	6a 00                	push   $0x0
  pushl $5
80107ea7:	6a 05                	push   $0x5
  jmp alltraps
80107ea9:	e9 3a f9 ff ff       	jmp    801077e8 <alltraps>
...
80107eae:	6a 00                	push   $0x0
  pushl $6
80107eb0:	6a 06                	push   $0x6
  jmp alltraps
80107eb2:	e9 31 f9 ff ff       	jmp    801077e8 <alltraps>
...
80107eb7:	6a 00                	push   $0x0
  pushl $7
80107eb9:	6a 07                	push   $0x7
  jmp alltraps
80107ebb:	e9 28 f9 ff ff       	jmp    801077e8 <alltraps>

80107ec0 <vector8>:
.globl vector8
vector8:
  pushl $8
80107ec0:	6a 08                	push   $0x8
  jmp alltraps
80107ec2:	e9 21 f9 ff ff       	jmp    801077e8 <alltraps>
...
80107ec7:	6a 00                	push   $0x0
  pushl $9
80107ec9:	6a 09                	push   $0x9
  jmp alltraps
80107ecb:	e9 18 f9 ff ff       	jmp    801077e8 <alltraps>

80107ed0 <vector10>:
.globl vector10
vector10:
  pushl $10
80107ed0:	6a 0a                	push   $0xa
  jmp alltraps
80107ed2:	e9 11 f9 ff ff       	jmp    801077e8 <alltraps>

80107ed7 <vector11>:
.globl vector11
vector11:
  pushl $11
80107ed7:	6a 0b                	push   $0xb
  jmp alltraps
80107ed9:	e9 0a f9 ff ff       	jmp    801077e8 <alltraps>

80107ede <vector12>:
.globl vector12
vector12:
  pushl $12
80107ede:	6a 0c                	push   $0xc
  jmp alltraps
80107ee0:	e9 03 f9 ff ff       	jmp    801077e8 <alltraps>

80107ee5 <vector13>:
.globl vector13
vector13:
  pushl $13
80107ee5:	6a 0d                	push   $0xd
  jmp alltraps
80107ee7:	e9 fc f8 ff ff       	jmp    801077e8 <alltraps>

80107eec <vector14>:
.globl vector14
vector14:
  pushl $14
80107eec:	6a 0e                	push   $0xe
  jmp alltraps
80107eee:	e9 f5 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107ef3:	6a 00                	push   $0x0
  pushl $15
80107ef5:	6a 0f                	push   $0xf
  jmp alltraps
80107ef7:	e9 ec f8 ff ff       	jmp    801077e8 <alltraps>
...
80107efc:	6a 00                	push   $0x0
  pushl $16
80107efe:	6a 10                	push   $0x10
  jmp alltraps
80107f00:	e9 e3 f8 ff ff       	jmp    801077e8 <alltraps>

80107f05 <vector17>:
.globl vector17
vector17:
  pushl $17
80107f05:	6a 11                	push   $0x11
  jmp alltraps
80107f07:	e9 dc f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f0c:	6a 00                	push   $0x0
  pushl $18
80107f0e:	6a 12                	push   $0x12
  jmp alltraps
80107f10:	e9 d3 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f15:	6a 00                	push   $0x0
  pushl $19
80107f17:	6a 13                	push   $0x13
  jmp alltraps
80107f19:	e9 ca f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f1e:	6a 00                	push   $0x0
  pushl $20
80107f20:	6a 14                	push   $0x14
  jmp alltraps
80107f22:	e9 c1 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f27:	6a 00                	push   $0x0
  pushl $21
80107f29:	6a 15                	push   $0x15
  jmp alltraps
80107f2b:	e9 b8 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f30:	6a 00                	push   $0x0
  pushl $22
80107f32:	6a 16                	push   $0x16
  jmp alltraps
80107f34:	e9 af f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f39:	6a 00                	push   $0x0
  pushl $23
80107f3b:	6a 17                	push   $0x17
  jmp alltraps
80107f3d:	e9 a6 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f42:	6a 00                	push   $0x0
  pushl $24
80107f44:	6a 18                	push   $0x18
  jmp alltraps
80107f46:	e9 9d f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f4b:	6a 00                	push   $0x0
  pushl $25
80107f4d:	6a 19                	push   $0x19
  jmp alltraps
80107f4f:	e9 94 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f54:	6a 00                	push   $0x0
  pushl $26
80107f56:	6a 1a                	push   $0x1a
  jmp alltraps
80107f58:	e9 8b f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f5d:	6a 00                	push   $0x0
  pushl $27
80107f5f:	6a 1b                	push   $0x1b
  jmp alltraps
80107f61:	e9 82 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f66:	6a 00                	push   $0x0
  pushl $28
80107f68:	6a 1c                	push   $0x1c
  jmp alltraps
80107f6a:	e9 79 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f6f:	6a 00                	push   $0x0
  pushl $29
80107f71:	6a 1d                	push   $0x1d
  jmp alltraps
80107f73:	e9 70 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f78:	6a 00                	push   $0x0
  pushl $30
80107f7a:	6a 1e                	push   $0x1e
  jmp alltraps
80107f7c:	e9 67 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f81:	6a 00                	push   $0x0
  pushl $31
80107f83:	6a 1f                	push   $0x1f
  jmp alltraps
80107f85:	e9 5e f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f8a:	6a 00                	push   $0x0
  pushl $32
80107f8c:	6a 20                	push   $0x20
  jmp alltraps
80107f8e:	e9 55 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f93:	6a 00                	push   $0x0
  pushl $33
80107f95:	6a 21                	push   $0x21
  jmp alltraps
80107f97:	e9 4c f8 ff ff       	jmp    801077e8 <alltraps>
...
80107f9c:	6a 00                	push   $0x0
  pushl $34
80107f9e:	6a 22                	push   $0x22
  jmp alltraps
80107fa0:	e9 43 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fa5:	6a 00                	push   $0x0
  pushl $35
80107fa7:	6a 23                	push   $0x23
  jmp alltraps
80107fa9:	e9 3a f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fae:	6a 00                	push   $0x0
  pushl $36
80107fb0:	6a 24                	push   $0x24
  jmp alltraps
80107fb2:	e9 31 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fb7:	6a 00                	push   $0x0
  pushl $37
80107fb9:	6a 25                	push   $0x25
  jmp alltraps
80107fbb:	e9 28 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fc0:	6a 00                	push   $0x0
  pushl $38
80107fc2:	6a 26                	push   $0x26
  jmp alltraps
80107fc4:	e9 1f f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fc9:	6a 00                	push   $0x0
  pushl $39
80107fcb:	6a 27                	push   $0x27
  jmp alltraps
80107fcd:	e9 16 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fd2:	6a 00                	push   $0x0
  pushl $40
80107fd4:	6a 28                	push   $0x28
  jmp alltraps
80107fd6:	e9 0d f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fdb:	6a 00                	push   $0x0
  pushl $41
80107fdd:	6a 29                	push   $0x29
  jmp alltraps
80107fdf:	e9 04 f8 ff ff       	jmp    801077e8 <alltraps>
...
80107fe4:	6a 00                	push   $0x0
  pushl $42
80107fe6:	6a 2a                	push   $0x2a
  jmp alltraps
80107fe8:	e9 fb f7 ff ff       	jmp    801077e8 <alltraps>
...
80107fed:	6a 00                	push   $0x0
  pushl $43
80107fef:	6a 2b                	push   $0x2b
  jmp alltraps
80107ff1:	e9 f2 f7 ff ff       	jmp    801077e8 <alltraps>
...
80107ff6:	6a 00                	push   $0x0
  pushl $44
80107ff8:	6a 2c                	push   $0x2c
  jmp alltraps
80107ffa:	e9 e9 f7 ff ff       	jmp    801077e8 <alltraps>
...
80107fff:	6a 00                	push   $0x0
  pushl $45
80108001:	6a 2d                	push   $0x2d
  jmp alltraps
80108003:	e9 e0 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108008:	6a 00                	push   $0x0
  pushl $46
8010800a:	6a 2e                	push   $0x2e
  jmp alltraps
8010800c:	e9 d7 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108011:	6a 00                	push   $0x0
  pushl $47
80108013:	6a 2f                	push   $0x2f
  jmp alltraps
80108015:	e9 ce f7 ff ff       	jmp    801077e8 <alltraps>
...
8010801a:	6a 00                	push   $0x0
  pushl $48
8010801c:	6a 30                	push   $0x30
  jmp alltraps
8010801e:	e9 c5 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108023:	6a 00                	push   $0x0
  pushl $49
80108025:	6a 31                	push   $0x31
  jmp alltraps
80108027:	e9 bc f7 ff ff       	jmp    801077e8 <alltraps>
...
8010802c:	6a 00                	push   $0x0
  pushl $50
8010802e:	6a 32                	push   $0x32
  jmp alltraps
80108030:	e9 b3 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108035:	6a 00                	push   $0x0
  pushl $51
80108037:	6a 33                	push   $0x33
  jmp alltraps
80108039:	e9 aa f7 ff ff       	jmp    801077e8 <alltraps>
...
8010803e:	6a 00                	push   $0x0
  pushl $52
80108040:	6a 34                	push   $0x34
  jmp alltraps
80108042:	e9 a1 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108047:	6a 00                	push   $0x0
  pushl $53
80108049:	6a 35                	push   $0x35
  jmp alltraps
8010804b:	e9 98 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108050:	6a 00                	push   $0x0
  pushl $54
80108052:	6a 36                	push   $0x36
  jmp alltraps
80108054:	e9 8f f7 ff ff       	jmp    801077e8 <alltraps>
...
80108059:	6a 00                	push   $0x0
  pushl $55
8010805b:	6a 37                	push   $0x37
  jmp alltraps
8010805d:	e9 86 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108062:	6a 00                	push   $0x0
  pushl $56
80108064:	6a 38                	push   $0x38
  jmp alltraps
80108066:	e9 7d f7 ff ff       	jmp    801077e8 <alltraps>
...
8010806b:	6a 00                	push   $0x0
  pushl $57
8010806d:	6a 39                	push   $0x39
  jmp alltraps
8010806f:	e9 74 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108074:	6a 00                	push   $0x0
  pushl $58
80108076:	6a 3a                	push   $0x3a
  jmp alltraps
80108078:	e9 6b f7 ff ff       	jmp    801077e8 <alltraps>
...
8010807d:	6a 00                	push   $0x0
  pushl $59
8010807f:	6a 3b                	push   $0x3b
  jmp alltraps
80108081:	e9 62 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108086:	6a 00                	push   $0x0
  pushl $60
80108088:	6a 3c                	push   $0x3c
  jmp alltraps
8010808a:	e9 59 f7 ff ff       	jmp    801077e8 <alltraps>
...
8010808f:	6a 00                	push   $0x0
  pushl $61
80108091:	6a 3d                	push   $0x3d
  jmp alltraps
80108093:	e9 50 f7 ff ff       	jmp    801077e8 <alltraps>
...
80108098:	6a 00                	push   $0x0
  pushl $62
8010809a:	6a 3e                	push   $0x3e
  jmp alltraps
8010809c:	e9 47 f7 ff ff       	jmp    801077e8 <alltraps>
...
801080a1:	6a 00                	push   $0x0
  pushl $63
801080a3:	6a 3f                	push   $0x3f
  jmp alltraps
801080a5:	e9 3e f7 ff ff       	jmp    801077e8 <alltraps>
...
801080aa:	6a 00                	push   $0x0
  pushl $64
801080ac:	6a 40                	push   $0x40
  jmp alltraps
801080ae:	e9 35 f7 ff ff       	jmp    801077e8 <alltraps>
...
801080b3:	6a 00                	push   $0x0
  pushl $65
801080b5:	6a 41                	push   $0x41
  jmp alltraps
801080b7:	e9 2c f7 ff ff       	jmp    801077e8 <alltraps>
...
801080bc:	6a 00                	push   $0x0
  pushl $66
801080be:	6a 42                	push   $0x42
  jmp alltraps
801080c0:	e9 23 f7 ff ff       	jmp    801077e8 <alltraps>
...
801080c5:	6a 00                	push   $0x0
  pushl $67
801080c7:	6a 43                	push   $0x43
  jmp alltraps
801080c9:	e9 1a f7 ff ff       	jmp    801077e8 <alltraps>
...
801080ce:	6a 00                	push   $0x0
  pushl $68
801080d0:	6a 44                	push   $0x44
  jmp alltraps
801080d2:	e9 11 f7 ff ff       	jmp    801077e8 <alltraps>
...
801080d7:	6a 00                	push   $0x0
  pushl $69
801080d9:	6a 45                	push   $0x45
  jmp alltraps
801080db:	e9 08 f7 ff ff       	jmp    801077e8 <alltraps>
...
801080e0:	6a 00                	push   $0x0
  pushl $70
801080e2:	6a 46                	push   $0x46
  jmp alltraps
801080e4:	e9 ff f6 ff ff       	jmp    801077e8 <alltraps>
...
801080e9:	6a 00                	push   $0x0
  pushl $71
801080eb:	6a 47                	push   $0x47
  jmp alltraps
801080ed:	e9 f6 f6 ff ff       	jmp    801077e8 <alltraps>
...
801080f2:	6a 00                	push   $0x0
  pushl $72
801080f4:	6a 48                	push   $0x48
  jmp alltraps
801080f6:	e9 ed f6 ff ff       	jmp    801077e8 <alltraps>
...
801080fb:	6a 00                	push   $0x0
  pushl $73
801080fd:	6a 49                	push   $0x49
  jmp alltraps
801080ff:	e9 e4 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108104:	6a 00                	push   $0x0
  pushl $74
80108106:	6a 4a                	push   $0x4a
  jmp alltraps
80108108:	e9 db f6 ff ff       	jmp    801077e8 <alltraps>
...
8010810d:	6a 00                	push   $0x0
  pushl $75
8010810f:	6a 4b                	push   $0x4b
  jmp alltraps
80108111:	e9 d2 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108116:	6a 00                	push   $0x0
  pushl $76
80108118:	6a 4c                	push   $0x4c
  jmp alltraps
8010811a:	e9 c9 f6 ff ff       	jmp    801077e8 <alltraps>
...
8010811f:	6a 00                	push   $0x0
  pushl $77
80108121:	6a 4d                	push   $0x4d
  jmp alltraps
80108123:	e9 c0 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108128:	6a 00                	push   $0x0
  pushl $78
8010812a:	6a 4e                	push   $0x4e
  jmp alltraps
8010812c:	e9 b7 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108131:	6a 00                	push   $0x0
  pushl $79
80108133:	6a 4f                	push   $0x4f
  jmp alltraps
80108135:	e9 ae f6 ff ff       	jmp    801077e8 <alltraps>
...
8010813a:	6a 00                	push   $0x0
  pushl $80
8010813c:	6a 50                	push   $0x50
  jmp alltraps
8010813e:	e9 a5 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108143:	6a 00                	push   $0x0
  pushl $81
80108145:	6a 51                	push   $0x51
  jmp alltraps
80108147:	e9 9c f6 ff ff       	jmp    801077e8 <alltraps>
...
8010814c:	6a 00                	push   $0x0
  pushl $82
8010814e:	6a 52                	push   $0x52
  jmp alltraps
80108150:	e9 93 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108155:	6a 00                	push   $0x0
  pushl $83
80108157:	6a 53                	push   $0x53
  jmp alltraps
80108159:	e9 8a f6 ff ff       	jmp    801077e8 <alltraps>
...
8010815e:	6a 00                	push   $0x0
  pushl $84
80108160:	6a 54                	push   $0x54
  jmp alltraps
80108162:	e9 81 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108167:	6a 00                	push   $0x0
  pushl $85
80108169:	6a 55                	push   $0x55
  jmp alltraps
8010816b:	e9 78 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108170:	6a 00                	push   $0x0
  pushl $86
80108172:	6a 56                	push   $0x56
  jmp alltraps
80108174:	e9 6f f6 ff ff       	jmp    801077e8 <alltraps>
...
80108179:	6a 00                	push   $0x0
  pushl $87
8010817b:	6a 57                	push   $0x57
  jmp alltraps
8010817d:	e9 66 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108182:	6a 00                	push   $0x0
  pushl $88
80108184:	6a 58                	push   $0x58
  jmp alltraps
80108186:	e9 5d f6 ff ff       	jmp    801077e8 <alltraps>
...
8010818b:	6a 00                	push   $0x0
  pushl $89
8010818d:	6a 59                	push   $0x59
  jmp alltraps
8010818f:	e9 54 f6 ff ff       	jmp    801077e8 <alltraps>
...
80108194:	6a 00                	push   $0x0
  pushl $90
80108196:	6a 5a                	push   $0x5a
  jmp alltraps
80108198:	e9 4b f6 ff ff       	jmp    801077e8 <alltraps>
...
8010819d:	6a 00                	push   $0x0
  pushl $91
8010819f:	6a 5b                	push   $0x5b
  jmp alltraps
801081a1:	e9 42 f6 ff ff       	jmp    801077e8 <alltraps>
...
801081a6:	6a 00                	push   $0x0
  pushl $92
801081a8:	6a 5c                	push   $0x5c
  jmp alltraps
801081aa:	e9 39 f6 ff ff       	jmp    801077e8 <alltraps>
...
801081af:	6a 00                	push   $0x0
  pushl $93
801081b1:	6a 5d                	push   $0x5d
  jmp alltraps
801081b3:	e9 30 f6 ff ff       	jmp    801077e8 <alltraps>
...
801081b8:	6a 00                	push   $0x0
  pushl $94
801081ba:	6a 5e                	push   $0x5e
  jmp alltraps
801081bc:	e9 27 f6 ff ff       	jmp    801077e8 <alltraps>
...
801081c1:	6a 00                	push   $0x0
  pushl $95
801081c3:	6a 5f                	push   $0x5f
  jmp alltraps
801081c5:	e9 1e f6 ff ff       	jmp    801077e8 <alltraps>
...
801081ca:	6a 00                	push   $0x0
  pushl $96
801081cc:	6a 60                	push   $0x60
  jmp alltraps
801081ce:	e9 15 f6 ff ff       	jmp    801077e8 <alltraps>
...
801081d3:	6a 00                	push   $0x0
  pushl $97
801081d5:	6a 61                	push   $0x61
  jmp alltraps
801081d7:	e9 0c f6 ff ff       	jmp    801077e8 <alltraps>
...
801081dc:	6a 00                	push   $0x0
  pushl $98
801081de:	6a 62                	push   $0x62
  jmp alltraps
801081e0:	e9 03 f6 ff ff       	jmp    801077e8 <alltraps>
...
801081e5:	6a 00                	push   $0x0
  pushl $99
801081e7:	6a 63                	push   $0x63
  jmp alltraps
801081e9:	e9 fa f5 ff ff       	jmp    801077e8 <alltraps>
...
801081ee:	6a 00                	push   $0x0
  pushl $100
801081f0:	6a 64                	push   $0x64
  jmp alltraps
801081f2:	e9 f1 f5 ff ff       	jmp    801077e8 <alltraps>
...
801081f7:	6a 00                	push   $0x0
  pushl $101
801081f9:	6a 65                	push   $0x65
  jmp alltraps
801081fb:	e9 e8 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108200:	6a 00                	push   $0x0
  pushl $102
80108202:	6a 66                	push   $0x66
  jmp alltraps
80108204:	e9 df f5 ff ff       	jmp    801077e8 <alltraps>
...
80108209:	6a 00                	push   $0x0
  pushl $103
8010820b:	6a 67                	push   $0x67
  jmp alltraps
8010820d:	e9 d6 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108212:	6a 00                	push   $0x0
  pushl $104
80108214:	6a 68                	push   $0x68
  jmp alltraps
80108216:	e9 cd f5 ff ff       	jmp    801077e8 <alltraps>
...
8010821b:	6a 00                	push   $0x0
  pushl $105
8010821d:	6a 69                	push   $0x69
  jmp alltraps
8010821f:	e9 c4 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108224:	6a 00                	push   $0x0
  pushl $106
80108226:	6a 6a                	push   $0x6a
  jmp alltraps
80108228:	e9 bb f5 ff ff       	jmp    801077e8 <alltraps>
...
8010822d:	6a 00                	push   $0x0
  pushl $107
8010822f:	6a 6b                	push   $0x6b
  jmp alltraps
80108231:	e9 b2 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108236:	6a 00                	push   $0x0
  pushl $108
80108238:	6a 6c                	push   $0x6c
  jmp alltraps
8010823a:	e9 a9 f5 ff ff       	jmp    801077e8 <alltraps>
...
8010823f:	6a 00                	push   $0x0
  pushl $109
80108241:	6a 6d                	push   $0x6d
  jmp alltraps
80108243:	e9 a0 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108248:	6a 00                	push   $0x0
  pushl $110
8010824a:	6a 6e                	push   $0x6e
  jmp alltraps
8010824c:	e9 97 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108251:	6a 00                	push   $0x0
  pushl $111
80108253:	6a 6f                	push   $0x6f
  jmp alltraps
80108255:	e9 8e f5 ff ff       	jmp    801077e8 <alltraps>
...
8010825a:	6a 00                	push   $0x0
  pushl $112
8010825c:	6a 70                	push   $0x70
  jmp alltraps
8010825e:	e9 85 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108263:	6a 00                	push   $0x0
  pushl $113
80108265:	6a 71                	push   $0x71
  jmp alltraps
80108267:	e9 7c f5 ff ff       	jmp    801077e8 <alltraps>
...
8010826c:	6a 00                	push   $0x0
  pushl $114
8010826e:	6a 72                	push   $0x72
  jmp alltraps
80108270:	e9 73 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108275:	6a 00                	push   $0x0
  pushl $115
80108277:	6a 73                	push   $0x73
  jmp alltraps
80108279:	e9 6a f5 ff ff       	jmp    801077e8 <alltraps>
...
8010827e:	6a 00                	push   $0x0
  pushl $116
80108280:	6a 74                	push   $0x74
  jmp alltraps
80108282:	e9 61 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108287:	6a 00                	push   $0x0
  pushl $117
80108289:	6a 75                	push   $0x75
  jmp alltraps
8010828b:	e9 58 f5 ff ff       	jmp    801077e8 <alltraps>
...
80108290:	6a 00                	push   $0x0
  pushl $118
80108292:	6a 76                	push   $0x76
  jmp alltraps
80108294:	e9 4f f5 ff ff       	jmp    801077e8 <alltraps>
...
80108299:	6a 00                	push   $0x0
  pushl $119
8010829b:	6a 77                	push   $0x77
  jmp alltraps
8010829d:	e9 46 f5 ff ff       	jmp    801077e8 <alltraps>
...
801082a2:	6a 00                	push   $0x0
  pushl $120
801082a4:	6a 78                	push   $0x78
  jmp alltraps
801082a6:	e9 3d f5 ff ff       	jmp    801077e8 <alltraps>
...
801082ab:	6a 00                	push   $0x0
  pushl $121
801082ad:	6a 79                	push   $0x79
  jmp alltraps
801082af:	e9 34 f5 ff ff       	jmp    801077e8 <alltraps>
...
801082b4:	6a 00                	push   $0x0
  pushl $122
801082b6:	6a 7a                	push   $0x7a
  jmp alltraps
801082b8:	e9 2b f5 ff ff       	jmp    801077e8 <alltraps>
...
801082bd:	6a 00                	push   $0x0
  pushl $123
801082bf:	6a 7b                	push   $0x7b
  jmp alltraps
801082c1:	e9 22 f5 ff ff       	jmp    801077e8 <alltraps>
...
801082c6:	6a 00                	push   $0x0
  pushl $124
801082c8:	6a 7c                	push   $0x7c
  jmp alltraps
801082ca:	e9 19 f5 ff ff       	jmp    801077e8 <alltraps>
...
801082cf:	6a 00                	push   $0x0
  pushl $125
801082d1:	6a 7d                	push   $0x7d
  jmp alltraps
801082d3:	e9 10 f5 ff ff       	jmp    801077e8 <alltraps>
...
801082d8:	6a 00                	push   $0x0
  pushl $126
801082da:	6a 7e                	push   $0x7e
  jmp alltraps
801082dc:	e9 07 f5 ff ff       	jmp    801077e8 <alltraps>
...
801082e1:	6a 00                	push   $0x0
  pushl $127
801082e3:	6a 7f                	push   $0x7f
  jmp alltraps
801082e5:	e9 fe f4 ff ff       	jmp    801077e8 <alltraps>
...
801082ea:	6a 00                	push   $0x0
  pushl $128
801082ec:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801082f1:	e9 f2 f4 ff ff       	jmp    801077e8 <alltraps>
...
801082f6:	6a 00                	push   $0x0
  pushl $129
801082f8:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801082fd:	e9 e6 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108302:	6a 00                	push   $0x0
  pushl $130
80108304:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80108309:	e9 da f4 ff ff       	jmp    801077e8 <alltraps>
...
8010830e:	6a 00                	push   $0x0
  pushl $131
80108310:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80108315:	e9 ce f4 ff ff       	jmp    801077e8 <alltraps>
...
8010831a:	6a 00                	push   $0x0
  pushl $132
8010831c:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80108321:	e9 c2 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108326:	6a 00                	push   $0x0
  pushl $133
80108328:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010832d:	e9 b6 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108332:	6a 00                	push   $0x0
  pushl $134
80108334:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80108339:	e9 aa f4 ff ff       	jmp    801077e8 <alltraps>
...
8010833e:	6a 00                	push   $0x0
  pushl $135
80108340:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80108345:	e9 9e f4 ff ff       	jmp    801077e8 <alltraps>
...
8010834a:	6a 00                	push   $0x0
  pushl $136
8010834c:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80108351:	e9 92 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108356:	6a 00                	push   $0x0
  pushl $137
80108358:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010835d:	e9 86 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108362:	6a 00                	push   $0x0
  pushl $138
80108364:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80108369:	e9 7a f4 ff ff       	jmp    801077e8 <alltraps>
...
8010836e:	6a 00                	push   $0x0
  pushl $139
80108370:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80108375:	e9 6e f4 ff ff       	jmp    801077e8 <alltraps>
...
8010837a:	6a 00                	push   $0x0
  pushl $140
8010837c:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80108381:	e9 62 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108386:	6a 00                	push   $0x0
  pushl $141
80108388:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010838d:	e9 56 f4 ff ff       	jmp    801077e8 <alltraps>
...
80108392:	6a 00                	push   $0x0
  pushl $142
80108394:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80108399:	e9 4a f4 ff ff       	jmp    801077e8 <alltraps>
...
8010839e:	6a 00                	push   $0x0
  pushl $143
801083a0:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801083a5:	e9 3e f4 ff ff       	jmp    801077e8 <alltraps>
...
801083aa:	6a 00                	push   $0x0
  pushl $144
801083ac:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801083b1:	e9 32 f4 ff ff       	jmp    801077e8 <alltraps>
...
801083b6:	6a 00                	push   $0x0
  pushl $145
801083b8:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801083bd:	e9 26 f4 ff ff       	jmp    801077e8 <alltraps>
...
801083c2:	6a 00                	push   $0x0
  pushl $146
801083c4:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801083c9:	e9 1a f4 ff ff       	jmp    801077e8 <alltraps>
...
801083ce:	6a 00                	push   $0x0
  pushl $147
801083d0:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801083d5:	e9 0e f4 ff ff       	jmp    801077e8 <alltraps>
...
801083da:	6a 00                	push   $0x0
  pushl $148
801083dc:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801083e1:	e9 02 f4 ff ff       	jmp    801077e8 <alltraps>
...
801083e6:	6a 00                	push   $0x0
  pushl $149
801083e8:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801083ed:	e9 f6 f3 ff ff       	jmp    801077e8 <alltraps>
...
801083f2:	6a 00                	push   $0x0
  pushl $150
801083f4:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801083f9:	e9 ea f3 ff ff       	jmp    801077e8 <alltraps>
...
801083fe:	6a 00                	push   $0x0
  pushl $151
80108400:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80108405:	e9 de f3 ff ff       	jmp    801077e8 <alltraps>
...
8010840a:	6a 00                	push   $0x0
  pushl $152
8010840c:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80108411:	e9 d2 f3 ff ff       	jmp    801077e8 <alltraps>
...
80108416:	6a 00                	push   $0x0
  pushl $153
80108418:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010841d:	e9 c6 f3 ff ff       	jmp    801077e8 <alltraps>
...
80108422:	6a 00                	push   $0x0
  pushl $154
80108424:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80108429:	e9 ba f3 ff ff       	jmp    801077e8 <alltraps>
...
8010842e:	6a 00                	push   $0x0
  pushl $155
80108430:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80108435:	e9 ae f3 ff ff       	jmp    801077e8 <alltraps>
...
8010843a:	6a 00                	push   $0x0
  pushl $156
8010843c:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80108441:	e9 a2 f3 ff ff       	jmp    801077e8 <alltraps>
...
80108446:	6a 00                	push   $0x0
  pushl $157
80108448:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010844d:	e9 96 f3 ff ff       	jmp    801077e8 <alltraps>
...
80108452:	6a 00                	push   $0x0
  pushl $158
80108454:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80108459:	e9 8a f3 ff ff       	jmp    801077e8 <alltraps>
...
8010845e:	6a 00                	push   $0x0
  pushl $159
80108460:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80108465:	e9 7e f3 ff ff       	jmp    801077e8 <alltraps>
...
8010846a:	6a 00                	push   $0x0
  pushl $160
8010846c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80108471:	e9 72 f3 ff ff       	jmp    801077e8 <alltraps>
...
80108476:	6a 00                	push   $0x0
  pushl $161
80108478:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010847d:	e9 66 f3 ff ff       	jmp    801077e8 <alltraps>
...
80108482:	6a 00                	push   $0x0
  pushl $162
80108484:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80108489:	e9 5a f3 ff ff       	jmp    801077e8 <alltraps>
...
8010848e:	6a 00                	push   $0x0
  pushl $163
80108490:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80108495:	e9 4e f3 ff ff       	jmp    801077e8 <alltraps>
...
8010849a:	6a 00                	push   $0x0
  pushl $164
8010849c:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801084a1:	e9 42 f3 ff ff       	jmp    801077e8 <alltraps>
...
801084a6:	6a 00                	push   $0x0
  pushl $165
801084a8:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801084ad:	e9 36 f3 ff ff       	jmp    801077e8 <alltraps>
...
801084b2:	6a 00                	push   $0x0
  pushl $166
801084b4:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801084b9:	e9 2a f3 ff ff       	jmp    801077e8 <alltraps>
...
801084be:	6a 00                	push   $0x0
  pushl $167
801084c0:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801084c5:	e9 1e f3 ff ff       	jmp    801077e8 <alltraps>
...
801084ca:	6a 00                	push   $0x0
  pushl $168
801084cc:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801084d1:	e9 12 f3 ff ff       	jmp    801077e8 <alltraps>
...
801084d6:	6a 00                	push   $0x0
  pushl $169
801084d8:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801084dd:	e9 06 f3 ff ff       	jmp    801077e8 <alltraps>
...
801084e2:	6a 00                	push   $0x0
  pushl $170
801084e4:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801084e9:	e9 fa f2 ff ff       	jmp    801077e8 <alltraps>
...
801084ee:	6a 00                	push   $0x0
  pushl $171
801084f0:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801084f5:	e9 ee f2 ff ff       	jmp    801077e8 <alltraps>
...
801084fa:	6a 00                	push   $0x0
  pushl $172
801084fc:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80108501:	e9 e2 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108506:	6a 00                	push   $0x0
  pushl $173
80108508:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010850d:	e9 d6 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108512:	6a 00                	push   $0x0
  pushl $174
80108514:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80108519:	e9 ca f2 ff ff       	jmp    801077e8 <alltraps>
...
8010851e:	6a 00                	push   $0x0
  pushl $175
80108520:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80108525:	e9 be f2 ff ff       	jmp    801077e8 <alltraps>
...
8010852a:	6a 00                	push   $0x0
  pushl $176
8010852c:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80108531:	e9 b2 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108536:	6a 00                	push   $0x0
  pushl $177
80108538:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010853d:	e9 a6 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108542:	6a 00                	push   $0x0
  pushl $178
80108544:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80108549:	e9 9a f2 ff ff       	jmp    801077e8 <alltraps>
...
8010854e:	6a 00                	push   $0x0
  pushl $179
80108550:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80108555:	e9 8e f2 ff ff       	jmp    801077e8 <alltraps>
...
8010855a:	6a 00                	push   $0x0
  pushl $180
8010855c:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80108561:	e9 82 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108566:	6a 00                	push   $0x0
  pushl $181
80108568:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010856d:	e9 76 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108572:	6a 00                	push   $0x0
  pushl $182
80108574:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80108579:	e9 6a f2 ff ff       	jmp    801077e8 <alltraps>
...
8010857e:	6a 00                	push   $0x0
  pushl $183
80108580:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80108585:	e9 5e f2 ff ff       	jmp    801077e8 <alltraps>
...
8010858a:	6a 00                	push   $0x0
  pushl $184
8010858c:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80108591:	e9 52 f2 ff ff       	jmp    801077e8 <alltraps>
...
80108596:	6a 00                	push   $0x0
  pushl $185
80108598:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010859d:	e9 46 f2 ff ff       	jmp    801077e8 <alltraps>
...
801085a2:	6a 00                	push   $0x0
  pushl $186
801085a4:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801085a9:	e9 3a f2 ff ff       	jmp    801077e8 <alltraps>
...
801085ae:	6a 00                	push   $0x0
  pushl $187
801085b0:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801085b5:	e9 2e f2 ff ff       	jmp    801077e8 <alltraps>
...
801085ba:	6a 00                	push   $0x0
  pushl $188
801085bc:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801085c1:	e9 22 f2 ff ff       	jmp    801077e8 <alltraps>
...
801085c6:	6a 00                	push   $0x0
  pushl $189
801085c8:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801085cd:	e9 16 f2 ff ff       	jmp    801077e8 <alltraps>
...
801085d2:	6a 00                	push   $0x0
  pushl $190
801085d4:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801085d9:	e9 0a f2 ff ff       	jmp    801077e8 <alltraps>
...
801085de:	6a 00                	push   $0x0
  pushl $191
801085e0:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801085e5:	e9 fe f1 ff ff       	jmp    801077e8 <alltraps>
...
801085ea:	6a 00                	push   $0x0
  pushl $192
801085ec:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801085f1:	e9 f2 f1 ff ff       	jmp    801077e8 <alltraps>
...
801085f6:	6a 00                	push   $0x0
  pushl $193
801085f8:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801085fd:	e9 e6 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108602:	6a 00                	push   $0x0
  pushl $194
80108604:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80108609:	e9 da f1 ff ff       	jmp    801077e8 <alltraps>
...
8010860e:	6a 00                	push   $0x0
  pushl $195
80108610:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80108615:	e9 ce f1 ff ff       	jmp    801077e8 <alltraps>
...
8010861a:	6a 00                	push   $0x0
  pushl $196
8010861c:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80108621:	e9 c2 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108626:	6a 00                	push   $0x0
  pushl $197
80108628:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010862d:	e9 b6 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108632:	6a 00                	push   $0x0
  pushl $198
80108634:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80108639:	e9 aa f1 ff ff       	jmp    801077e8 <alltraps>
...
8010863e:	6a 00                	push   $0x0
  pushl $199
80108640:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80108645:	e9 9e f1 ff ff       	jmp    801077e8 <alltraps>
...
8010864a:	6a 00                	push   $0x0
  pushl $200
8010864c:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80108651:	e9 92 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108656:	6a 00                	push   $0x0
  pushl $201
80108658:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010865d:	e9 86 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108662:	6a 00                	push   $0x0
  pushl $202
80108664:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80108669:	e9 7a f1 ff ff       	jmp    801077e8 <alltraps>
...
8010866e:	6a 00                	push   $0x0
  pushl $203
80108670:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80108675:	e9 6e f1 ff ff       	jmp    801077e8 <alltraps>
...
8010867a:	6a 00                	push   $0x0
  pushl $204
8010867c:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80108681:	e9 62 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108686:	6a 00                	push   $0x0
  pushl $205
80108688:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010868d:	e9 56 f1 ff ff       	jmp    801077e8 <alltraps>
...
80108692:	6a 00                	push   $0x0
  pushl $206
80108694:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80108699:	e9 4a f1 ff ff       	jmp    801077e8 <alltraps>
...
8010869e:	6a 00                	push   $0x0
  pushl $207
801086a0:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801086a5:	e9 3e f1 ff ff       	jmp    801077e8 <alltraps>
...
801086aa:	6a 00                	push   $0x0
  pushl $208
801086ac:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801086b1:	e9 32 f1 ff ff       	jmp    801077e8 <alltraps>
...
801086b6:	6a 00                	push   $0x0
  pushl $209
801086b8:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801086bd:	e9 26 f1 ff ff       	jmp    801077e8 <alltraps>
...
801086c2:	6a 00                	push   $0x0
  pushl $210
801086c4:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801086c9:	e9 1a f1 ff ff       	jmp    801077e8 <alltraps>
...
801086ce:	6a 00                	push   $0x0
  pushl $211
801086d0:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801086d5:	e9 0e f1 ff ff       	jmp    801077e8 <alltraps>
...
801086da:	6a 00                	push   $0x0
  pushl $212
801086dc:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801086e1:	e9 02 f1 ff ff       	jmp    801077e8 <alltraps>
...
801086e6:	6a 00                	push   $0x0
  pushl $213
801086e8:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801086ed:	e9 f6 f0 ff ff       	jmp    801077e8 <alltraps>
...
801086f2:	6a 00                	push   $0x0
  pushl $214
801086f4:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801086f9:	e9 ea f0 ff ff       	jmp    801077e8 <alltraps>
...
801086fe:	6a 00                	push   $0x0
  pushl $215
80108700:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80108705:	e9 de f0 ff ff       	jmp    801077e8 <alltraps>
...
8010870a:	6a 00                	push   $0x0
  pushl $216
8010870c:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80108711:	e9 d2 f0 ff ff       	jmp    801077e8 <alltraps>
...
80108716:	6a 00                	push   $0x0
  pushl $217
80108718:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010871d:	e9 c6 f0 ff ff       	jmp    801077e8 <alltraps>
...
80108722:	6a 00                	push   $0x0
  pushl $218
80108724:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80108729:	e9 ba f0 ff ff       	jmp    801077e8 <alltraps>
...
8010872e:	6a 00                	push   $0x0
  pushl $219
80108730:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80108735:	e9 ae f0 ff ff       	jmp    801077e8 <alltraps>
...
8010873a:	6a 00                	push   $0x0
  pushl $220
8010873c:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80108741:	e9 a2 f0 ff ff       	jmp    801077e8 <alltraps>
...
80108746:	6a 00                	push   $0x0
  pushl $221
80108748:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010874d:	e9 96 f0 ff ff       	jmp    801077e8 <alltraps>
...
80108752:	6a 00                	push   $0x0
  pushl $222
80108754:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80108759:	e9 8a f0 ff ff       	jmp    801077e8 <alltraps>
...
8010875e:	6a 00                	push   $0x0
  pushl $223
80108760:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80108765:	e9 7e f0 ff ff       	jmp    801077e8 <alltraps>
...
8010876a:	6a 00                	push   $0x0
  pushl $224
8010876c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80108771:	e9 72 f0 ff ff       	jmp    801077e8 <alltraps>
...
80108776:	6a 00                	push   $0x0
  pushl $225
80108778:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010877d:	e9 66 f0 ff ff       	jmp    801077e8 <alltraps>
...
80108782:	6a 00                	push   $0x0
  pushl $226
80108784:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80108789:	e9 5a f0 ff ff       	jmp    801077e8 <alltraps>
...
8010878e:	6a 00                	push   $0x0
  pushl $227
80108790:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80108795:	e9 4e f0 ff ff       	jmp    801077e8 <alltraps>
...
8010879a:	6a 00                	push   $0x0
  pushl $228
8010879c:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801087a1:	e9 42 f0 ff ff       	jmp    801077e8 <alltraps>
...
801087a6:	6a 00                	push   $0x0
  pushl $229
801087a8:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801087ad:	e9 36 f0 ff ff       	jmp    801077e8 <alltraps>
...
801087b2:	6a 00                	push   $0x0
  pushl $230
801087b4:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801087b9:	e9 2a f0 ff ff       	jmp    801077e8 <alltraps>
...
801087be:	6a 00                	push   $0x0
  pushl $231
801087c0:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801087c5:	e9 1e f0 ff ff       	jmp    801077e8 <alltraps>
...
801087ca:	6a 00                	push   $0x0
  pushl $232
801087cc:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801087d1:	e9 12 f0 ff ff       	jmp    801077e8 <alltraps>
...
801087d6:	6a 00                	push   $0x0
  pushl $233
801087d8:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801087dd:	e9 06 f0 ff ff       	jmp    801077e8 <alltraps>
...
801087e2:	6a 00                	push   $0x0
  pushl $234
801087e4:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801087e9:	e9 fa ef ff ff       	jmp    801077e8 <alltraps>
...
801087ee:	6a 00                	push   $0x0
  pushl $235
801087f0:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801087f5:	e9 ee ef ff ff       	jmp    801077e8 <alltraps>
...
801087fa:	6a 00                	push   $0x0
  pushl $236
801087fc:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80108801:	e9 e2 ef ff ff       	jmp    801077e8 <alltraps>
...
80108806:	6a 00                	push   $0x0
  pushl $237
80108808:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010880d:	e9 d6 ef ff ff       	jmp    801077e8 <alltraps>
...
80108812:	6a 00                	push   $0x0
  pushl $238
80108814:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80108819:	e9 ca ef ff ff       	jmp    801077e8 <alltraps>
...
8010881e:	6a 00                	push   $0x0
  pushl $239
80108820:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80108825:	e9 be ef ff ff       	jmp    801077e8 <alltraps>
...
8010882a:	6a 00                	push   $0x0
  pushl $240
8010882c:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80108831:	e9 b2 ef ff ff       	jmp    801077e8 <alltraps>
...
80108836:	6a 00                	push   $0x0
  pushl $241
80108838:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010883d:	e9 a6 ef ff ff       	jmp    801077e8 <alltraps>
...
80108842:	6a 00                	push   $0x0
  pushl $242
80108844:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80108849:	e9 9a ef ff ff       	jmp    801077e8 <alltraps>
...
8010884e:	6a 00                	push   $0x0
  pushl $243
80108850:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80108855:	e9 8e ef ff ff       	jmp    801077e8 <alltraps>
...
8010885a:	6a 00                	push   $0x0
  pushl $244
8010885c:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80108861:	e9 82 ef ff ff       	jmp    801077e8 <alltraps>
...
80108866:	6a 00                	push   $0x0
  pushl $245
80108868:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010886d:	e9 76 ef ff ff       	jmp    801077e8 <alltraps>
...
80108872:	6a 00                	push   $0x0
  pushl $246
80108874:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80108879:	e9 6a ef ff ff       	jmp    801077e8 <alltraps>
...
8010887e:	6a 00                	push   $0x0
  pushl $247
80108880:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80108885:	e9 5e ef ff ff       	jmp    801077e8 <alltraps>
...
8010888a:	6a 00                	push   $0x0
  pushl $248
8010888c:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80108891:	e9 52 ef ff ff       	jmp    801077e8 <alltraps>
...
80108896:	6a 00                	push   $0x0
  pushl $249
80108898:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010889d:	e9 46 ef ff ff       	jmp    801077e8 <alltraps>
...
801088a2:	6a 00                	push   $0x0
  pushl $250
801088a4:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801088a9:	e9 3a ef ff ff       	jmp    801077e8 <alltraps>
...
801088ae:	6a 00                	push   $0x0
  pushl $251
801088b0:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801088b5:	e9 2e ef ff ff       	jmp    801077e8 <alltraps>
...
801088ba:	6a 00                	push   $0x0
  pushl $252
801088bc:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801088c1:	e9 22 ef ff ff       	jmp    801077e8 <alltraps>
...
801088c6:	6a 00                	push   $0x0
  pushl $253
801088c8:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801088cd:	e9 16 ef ff ff       	jmp    801077e8 <alltraps>
...
801088d2:	6a 00                	push   $0x0
  pushl $254
801088d4:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801088d9:	e9 0a ef ff ff       	jmp    801077e8 <alltraps>
...
801088de:	6a 00                	push   $0x0
  pushl $255
801088e0:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801088e5:	e9 fe ee ff ff       	jmp    801077e8 <alltraps>
	...
...
801088ef:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801088f2:	8b 45 0c             	mov    0xc(%ebp),%eax
801088f5:	83 e8 01             	sub    $0x1,%eax
801088f8:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801088fc:	8b 45 08             	mov    0x8(%ebp),%eax
801088ff:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80108903:	8b 45 08             	mov    0x8(%ebp),%eax
80108906:	c1 e8 10             	shr    $0x10,%eax
80108909:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
8010890d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80108910:	0f 01 10             	lgdtl  (%eax)
}
80108913:	c9                   	leave  
80108914:	c3                   	ret    
...
8010891e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80108922:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80108926:	0f 00 d8             	ltr    %ax
}
80108929:	c9                   	leave  
8010892a:	c3                   	ret    
...
80108934:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80108938:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010893c:	8e e8                	mov    %eax,%gs
}
8010893e:	c9                   	leave  
8010893f:	c3                   	ret    
...
80108951:	05 00 00 00 80       	add    $0x80000000,%eax
80108956:	5d                   	pop    %ebp
80108957:	c3                   	ret    
...
8010895e:	05 00 00 00 80       	add    $0x80000000,%eax
80108963:	5d                   	pop    %ebp
80108964:	c3                   	ret    
...
80108969:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
8010896c:	e8 18 ad ff ff       	call   80103689 <cpunum>
80108971:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80108977:	05 80 71 12 80       	add    $0x80127180,%eax
8010897c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010897f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108982:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80108988:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010898b:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80108991:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108994:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80108998:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010899b:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010899f:	83 e2 f0             	and    $0xfffffff0,%edx
801089a2:	83 ca 0a             	or     $0xa,%edx
801089a5:	88 50 7d             	mov    %dl,0x7d(%eax)
801089a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089ab:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801089af:	83 ca 10             	or     $0x10,%edx
801089b2:	88 50 7d             	mov    %dl,0x7d(%eax)
801089b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089b8:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801089bc:	83 e2 9f             	and    $0xffffff9f,%edx
801089bf:	88 50 7d             	mov    %dl,0x7d(%eax)
801089c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089c5:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801089c9:	83 ca 80             	or     $0xffffff80,%edx
801089cc:	88 50 7d             	mov    %dl,0x7d(%eax)
801089cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089d2:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801089d6:	83 ca 0f             	or     $0xf,%edx
801089d9:	88 50 7e             	mov    %dl,0x7e(%eax)
801089dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089df:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801089e3:	83 e2 ef             	and    $0xffffffef,%edx
801089e6:	88 50 7e             	mov    %dl,0x7e(%eax)
801089e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089ec:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801089f0:	83 e2 df             	and    $0xffffffdf,%edx
801089f3:	88 50 7e             	mov    %dl,0x7e(%eax)
801089f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801089f9:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801089fd:	83 ca 40             	or     $0x40,%edx
80108a00:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a06:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80108a0a:	83 ca 80             	or     $0xffffff80,%edx
80108a0d:	88 50 7e             	mov    %dl,0x7e(%eax)
80108a10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a13:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108a17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a1a:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80108a21:	ff ff 
80108a23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a26:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80108a2d:	00 00 
80108a2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a32:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80108a39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a3c:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108a43:	83 e2 f0             	and    $0xfffffff0,%edx
80108a46:	83 ca 02             	or     $0x2,%edx
80108a49:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108a4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a52:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108a59:	83 ca 10             	or     $0x10,%edx
80108a5c:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108a62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a65:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108a6c:	83 e2 9f             	and    $0xffffff9f,%edx
80108a6f:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108a75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a78:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80108a7f:	83 ca 80             	or     $0xffffff80,%edx
80108a82:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80108a88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a8b:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108a92:	83 ca 0f             	or     $0xf,%edx
80108a95:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108a9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a9e:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108aa5:	83 e2 ef             	and    $0xffffffef,%edx
80108aa8:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108aae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ab1:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108ab8:	83 e2 df             	and    $0xffffffdf,%edx
80108abb:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108ac1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ac4:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108acb:	83 ca 40             	or     $0x40,%edx
80108ace:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108ad4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ad7:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80108ade:	83 ca 80             	or     $0xffffff80,%edx
80108ae1:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80108ae7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108aea:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108af1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108af4:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80108afb:	ff ff 
80108afd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b00:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80108b07:	00 00 
80108b09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b0c:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80108b13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b16:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108b1d:	83 e2 f0             	and    $0xfffffff0,%edx
80108b20:	83 ca 0a             	or     $0xa,%edx
80108b23:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108b29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b2c:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108b33:	83 ca 10             	or     $0x10,%edx
80108b36:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108b3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b3f:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108b46:	83 ca 60             	or     $0x60,%edx
80108b49:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108b4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b52:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80108b59:	83 ca 80             	or     $0xffffff80,%edx
80108b5c:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80108b62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b65:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108b6c:	83 ca 0f             	or     $0xf,%edx
80108b6f:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108b75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b78:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108b7f:	83 e2 ef             	and    $0xffffffef,%edx
80108b82:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108b88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b8b:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108b92:	83 e2 df             	and    $0xffffffdf,%edx
80108b95:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108b9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b9e:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108ba5:	83 ca 40             	or     $0x40,%edx
80108ba8:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108bae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bb1:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80108bb8:	83 ca 80             	or     $0xffffff80,%edx
80108bbb:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80108bc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bc4:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108bcb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bce:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80108bd5:	ff ff 
80108bd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bda:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80108be1:	00 00 
80108be3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108be6:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80108bed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108bf0:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108bf7:	83 e2 f0             	and    $0xfffffff0,%edx
80108bfa:	83 ca 02             	or     $0x2,%edx
80108bfd:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c06:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c0d:	83 ca 10             	or     $0x10,%edx
80108c10:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c19:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c20:	83 ca 60             	or     $0x60,%edx
80108c23:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c2c:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80108c33:	83 ca 80             	or     $0xffffff80,%edx
80108c36:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80108c3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c3f:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108c46:	83 ca 0f             	or     $0xf,%edx
80108c49:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108c4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c52:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108c59:	83 e2 ef             	and    $0xffffffef,%edx
80108c5c:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108c62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c65:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108c6c:	83 e2 df             	and    $0xffffffdf,%edx
80108c6f:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108c75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c78:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108c7f:	83 ca 40             	or     $0x40,%edx
80108c82:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108c88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c8b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80108c92:	83 ca 80             	or     $0xffffff80,%edx
80108c95:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80108c9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108c9e:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80108ca5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ca8:	05 b4 00 00 00       	add    $0xb4,%eax
80108cad:	89 c3                	mov    %eax,%ebx
80108caf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cb2:	05 b4 00 00 00       	add    $0xb4,%eax
80108cb7:	c1 e8 10             	shr    $0x10,%eax
80108cba:	89 c1                	mov    %eax,%ecx
80108cbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cbf:	05 b4 00 00 00       	add    $0xb4,%eax
80108cc4:	c1 e8 18             	shr    $0x18,%eax
80108cc7:	89 c2                	mov    %eax,%edx
80108cc9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ccc:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80108cd3:	00 00 
80108cd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108cd8:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80108cdf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ce2:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80108ce8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ceb:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108cf2:	83 e1 f0             	and    $0xfffffff0,%ecx
80108cf5:	83 c9 02             	or     $0x2,%ecx
80108cf8:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108cfe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d01:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d08:	83 c9 10             	or     $0x10,%ecx
80108d0b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d14:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d1b:	83 e1 9f             	and    $0xffffff9f,%ecx
80108d1e:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d27:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108d2e:	83 c9 80             	or     $0xffffff80,%ecx
80108d31:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108d37:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d3a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108d41:	83 e1 f0             	and    $0xfffffff0,%ecx
80108d44:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108d4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d4d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108d54:	83 e1 ef             	and    $0xffffffef,%ecx
80108d57:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108d5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d60:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108d67:	83 e1 df             	and    $0xffffffdf,%ecx
80108d6a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108d70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d73:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108d7a:	83 c9 40             	or     $0x40,%ecx
80108d7d:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108d83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d86:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108d8d:	83 c9 80             	or     $0xffffff80,%ecx
80108d90:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108d96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108d99:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108d9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108da2:	83 c0 70             	add    $0x70,%eax
80108da5:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80108dac:	00 
80108dad:	89 04 24             	mov    %eax,(%esp)
80108db0:	e8 37 fb ff ff       	call   801088ec <lgdt>
  loadgs(SEG_KCPU << 3);
80108db5:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80108dbc:	e8 6a fb ff ff       	call   8010892b <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80108dc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108dc4:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80108dca:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80108dd1:	00 00 00 00 
}
80108dd5:	83 c4 24             	add    $0x24,%esp
80108dd8:	5b                   	pop    %ebx
80108dd9:	5d                   	pop    %ebp
80108dda:	c3                   	ret    
...
{
80108ddb:	55                   	push   %ebp
80108ddc:	89 e5                	mov    %esp,%ebp
80108dde:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80108de1:	8b 45 0c             	mov    0xc(%ebp),%eax
80108de4:	c1 e8 16             	shr    $0x16,%eax
80108de7:	c1 e0 02             	shl    $0x2,%eax
80108dea:	03 45 08             	add    0x8(%ebp),%eax
80108ded:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80108df0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108df3:	8b 00                	mov    (%eax),%eax
80108df5:	83 e0 01             	and    $0x1,%eax
80108df8:	84 c0                	test   %al,%al
80108dfa:	74 17                	je     80108e13 <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80108dfc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108dff:	8b 00                	mov    (%eax),%eax
80108e01:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108e06:	89 04 24             	mov    %eax,(%esp)
80108e09:	e8 4a fb ff ff       	call   80108958 <p2v>
80108e0e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108e11:	eb 4b                	jmp    80108e5e <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108e13:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80108e17:	74 0e                	je     80108e27 <walkpgdir+0x4c>
80108e19:	e8 f2 9c ff ff       	call   80102b10 <kalloc>
80108e1e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108e21:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108e25:	75 07                	jne    80108e2e <walkpgdir+0x53>
      return 0;
80108e27:	b8 00 00 00 00       	mov    $0x0,%eax
80108e2c:	eb 41                	jmp    80108e6f <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80108e2e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108e35:	00 
80108e36:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108e3d:	00 
80108e3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e41:	89 04 24             	mov    %eax,(%esp)
80108e44:	e8 5d d0 ff ff       	call   80105ea6 <memset>
...
80108e4f:	e8 f7 fa ff ff       	call   8010894b <v2p>
80108e54:	89 c2                	mov    %eax,%edx
80108e56:	83 ca 07             	or     $0x7,%edx
80108e59:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108e5c:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80108e5e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108e61:	c1 e8 0c             	shr    $0xc,%eax
80108e64:	25 ff 03 00 00       	and    $0x3ff,%eax
80108e69:	c1 e0 02             	shl    $0x2,%eax
80108e6c:	03 45 f4             	add    -0xc(%ebp),%eax
}
80108e6f:	c9                   	leave  
80108e70:	c3                   	ret    
...
80108e7a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108e7f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  //cprintf("mappages: a = %p\n",a);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80108e82:	8b 45 0c             	mov    0xc(%ebp),%eax
80108e85:	03 45 10             	add    0x10(%ebp),%eax
80108e88:	83 e8 01             	sub    $0x1,%eax
80108e8b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108e90:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108e93:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108e9a:	00 
80108e9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108e9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108ea2:	8b 45 08             	mov    0x8(%ebp),%eax
80108ea5:	89 04 24             	mov    %eax,(%esp)
80108ea8:	e8 2e ff ff ff       	call   80108ddb <walkpgdir>
80108ead:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108eb0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108eb4:	75 07                	jne    80108ebd <mappages+0x4c>
      return -1;
80108eb6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108ebb:	eb 46                	jmp    80108f03 <mappages+0x92>
    if(*pte & PTE_P)
80108ebd:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108ec0:	8b 00                	mov    (%eax),%eax
80108ec2:	83 e0 01             	and    $0x1,%eax
80108ec5:	84 c0                	test   %al,%al
80108ec7:	74 0c                	je     80108ed5 <mappages+0x64>
      panic("remap");
80108ec9:	c7 04 24 80 9e 10 80 	movl   $0x80109e80,(%esp)
80108ed0:	e8 68 76 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80108ed5:	8b 45 18             	mov    0x18(%ebp),%eax
80108ed8:	0b 45 14             	or     0x14(%ebp),%eax
80108edb:	89 c2                	mov    %eax,%edx
80108edd:	83 ca 01             	or     $0x1,%edx
80108ee0:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108ee3:	89 10                	mov    %edx,(%eax)
   //cprintf("mappages: pte = %p\n",pte);
    if(a == last)
80108ee5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108ee8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108eeb:	74 10                	je     80108efd <mappages+0x8c>
      break;
    a += PGSIZE;
80108eed:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80108ef4:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108efb:	eb 96                	jmp    80108e93 <mappages+0x22>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
   //cprintf("mappages: pte = %p\n",pte);
...
80108efd:	90                   	nop
  ...
  return 0;
80108efe:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108f03:	c9                   	leave  
80108f04:	c3                   	ret    
...
80108f09:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108f0c:	e8 ff 9b ff ff       	call   80102b10 <kalloc>
80108f11:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108f14:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108f18:	75 0a                	jne    80108f24 <setupkvm+0x1f>
    return 0;
80108f1a:	b8 00 00 00 00       	mov    $0x0,%eax
80108f1f:	e9 98 00 00 00       	jmp    80108fbc <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80108f24:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108f2b:	00 
80108f2c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108f33:	00 
80108f34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108f37:	89 04 24             	mov    %eax,(%esp)
80108f3a:	e8 67 cf ff ff       	call   80105ea6 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108f3f:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108f46:	e8 0d fa ff ff       	call   80108958 <p2v>
80108f4b:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108f50:	76 0c                	jbe    80108f5e <setupkvm+0x59>
    panic("PHYSTOP too high");
80108f52:	c7 04 24 86 9e 10 80 	movl   $0x80109e86,(%esp)
80108f59:	e8 df 75 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108f5e:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108f65:	eb 49                	jmp    80108fb0 <setupkvm+0xab>
...
80108f67:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108f6a:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108f6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108f70:	8b 50 04             	mov    0x4(%eax),%edx
80108f73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f76:	8b 58 08             	mov    0x8(%eax),%ebx
80108f79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f7c:	8b 40 04             	mov    0x4(%eax),%eax
80108f7f:	29 c3                	sub    %eax,%ebx
80108f81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108f84:	8b 00                	mov    (%eax),%eax
80108f86:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108f8a:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108f8e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108f92:	89 44 24 04          	mov    %eax,0x4(%esp)
80108f96:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108f99:	89 04 24             	mov    %eax,(%esp)
80108f9c:	e8 d0 fe ff ff       	call   80108e71 <mappages>
80108fa1:	85 c0                	test   %eax,%eax
80108fa3:	79 07                	jns    80108fac <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80108fa5:	b8 00 00 00 00       	mov    $0x0,%eax
80108faa:	eb 10                	jmp    80108fbc <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108fac:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80108fb0:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
80108fb7:	72 ae                	jb     80108f67 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
80108fb9:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80108fbc:	83 c4 34             	add    $0x34,%esp
80108fbf:	5b                   	pop    %ebx
80108fc0:	5d                   	pop    %ebp
80108fc1:	c3                   	ret    
...
kvmalloc(void)
{
80108fc2:	55                   	push   %ebp
80108fc3:	89 e5                	mov    %esp,%ebp
80108fc5:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108fc8:	e8 38 ff ff ff       	call   80108f05 <setupkvm>
80108fcd:	a3 58 a5 12 80       	mov    %eax,0x8012a558
  switchkvm();
80108fd2:	e8 02 00 00 00       	call   80108fd9 <switchkvm>
}
80108fd7:	c9                   	leave  
80108fd8:	c3                   	ret    
...
80108fdc:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
80108fdf:	a1 58 a5 12 80       	mov    0x8012a558,%eax
80108fe4:	89 04 24             	mov    %eax,(%esp)
80108fe7:	e8 5f f9 ff ff       	call   8010894b <v2p>
80108fec:	89 04 24             	mov    %eax,(%esp)
80108fef:	e8 4c f9 ff ff       	call   80108940 <lcr3>
}
80108ff4:	c9                   	leave  
80108ff5:	c3                   	ret    
...
80108ffa:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108ffd:	e8 9e cd ff ff       	call   80105da0 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80109002:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80109008:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010900f:	83 c2 08             	add    $0x8,%edx
80109012:	89 d3                	mov    %edx,%ebx
80109014:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010901b:	83 c2 08             	add    $0x8,%edx
8010901e:	c1 ea 10             	shr    $0x10,%edx
80109021:	89 d1                	mov    %edx,%ecx
80109023:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010902a:	83 c2 08             	add    $0x8,%edx
8010902d:	c1 ea 18             	shr    $0x18,%edx
80109030:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80109037:	67 00 
80109039:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80109040:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80109046:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010904d:	83 e1 f0             	and    $0xfffffff0,%ecx
80109050:	83 c9 09             	or     $0x9,%ecx
80109053:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80109059:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80109060:	83 c9 10             	or     $0x10,%ecx
80109063:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80109069:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80109070:	83 e1 9f             	and    $0xffffff9f,%ecx
80109073:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80109079:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80109080:	83 c9 80             	or     $0xffffff80,%ecx
80109083:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80109089:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80109090:	83 e1 f0             	and    $0xfffffff0,%ecx
80109093:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80109099:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801090a0:	83 e1 ef             	and    $0xffffffef,%ecx
801090a3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801090a9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801090b0:	83 e1 df             	and    $0xffffffdf,%ecx
801090b3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801090b9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801090c0:	83 c9 40             	or     $0x40,%ecx
801090c3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801090c9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801090d0:	83 e1 7f             	and    $0x7f,%ecx
801090d3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801090d9:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801090df:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801090e5:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801090ec:	83 e2 ef             	and    $0xffffffef,%edx
801090ef:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801090f5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801090fb:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80109101:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80109107:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010910e:	8b 52 08             	mov    0x8(%edx),%edx
80109111:	81 c2 00 10 00 00    	add    $0x1000,%edx
80109117:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
8010911a:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80109121:	e8 ef f7 ff ff       	call   80108915 <ltr>
  if(p->pgdir == 0)
80109126:	8b 45 08             	mov    0x8(%ebp),%eax
80109129:	8b 40 04             	mov    0x4(%eax),%eax
8010912c:	85 c0                	test   %eax,%eax
8010912e:	75 0c                	jne    8010913c <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80109130:	c7 04 24 97 9e 10 80 	movl   $0x80109e97,(%esp)
80109137:	e8 01 74 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010913c:	8b 45 08             	mov    0x8(%ebp),%eax
8010913f:	8b 40 04             	mov    0x4(%eax),%eax
80109142:	89 04 24             	mov    %eax,(%esp)
80109145:	e8 01 f8 ff ff       	call   8010894b <v2p>
8010914a:	89 04 24             	mov    %eax,(%esp)
8010914d:	e8 ee f7 ff ff       	call   80108940 <lcr3>
  popcli();
80109152:	e8 91 cc ff ff       	call   80105de8 <popcli>
}
80109157:	83 c4 14             	add    $0x14,%esp
8010915a:	5b                   	pop    %ebx
8010915b:	5d                   	pop    %ebp
8010915c:	c3                   	ret    
...
80109160:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80109163:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010916a:	76 0c                	jbe    80109178 <inituvm+0x1b>
    panic("inituvm: more than a page");
8010916c:	c7 04 24 ab 9e 10 80 	movl   $0x80109eab,(%esp)
80109173:	e8 c5 73 ff ff       	call   8010053d <panic>
  mem = kalloc();
80109178:	e8 93 99 ff ff       	call   80102b10 <kalloc>
8010917d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80109180:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109187:	00 
80109188:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010918f:	00 
80109190:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109193:	89 04 24             	mov    %eax,(%esp)
80109196:	e8 0b cd ff ff       	call   80105ea6 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010919b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010919e:	89 04 24             	mov    %eax,(%esp)
801091a1:	e8 a5 f7 ff ff       	call   8010894b <v2p>
801091a6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801091ad:	00 
801091ae:	89 44 24 0c          	mov    %eax,0xc(%esp)
801091b2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801091b9:	00 
801091ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801091c1:	00 
801091c2:	8b 45 08             	mov    0x8(%ebp),%eax
801091c5:	89 04 24             	mov    %eax,(%esp)
801091c8:	e8 a4 fc ff ff       	call   80108e71 <mappages>
  memmove(mem, init, sz);
801091cd:	8b 45 10             	mov    0x10(%ebp),%eax
801091d0:	89 44 24 08          	mov    %eax,0x8(%esp)
801091d4:	8b 45 0c             	mov    0xc(%ebp),%eax
801091d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801091db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801091de:	89 04 24             	mov    %eax,(%esp)
801091e1:	e8 93 cd ff ff       	call   80105f79 <memmove>
}
801091e6:	c9                   	leave  
801091e7:	c3                   	ret    
...
801091eb:	53                   	push   %ebx
801091ec:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
  if((uint) addr % PGSIZE != 0)
801091ef:	8b 45 0c             	mov    0xc(%ebp),%eax
801091f2:	25 ff 0f 00 00       	and    $0xfff,%eax
801091f7:	85 c0                	test   %eax,%eax
801091f9:	74 0c                	je     80109207 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801091fb:	c7 04 24 c8 9e 10 80 	movl   $0x80109ec8,(%esp)
80109202:	e8 36 73 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80109207:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010920e:	e9 ad 00 00 00       	jmp    801092c0 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80109213:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109216:	8b 55 0c             	mov    0xc(%ebp),%edx
80109219:	01 d0                	add    %edx,%eax
8010921b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109222:	00 
80109223:	89 44 24 04          	mov    %eax,0x4(%esp)
80109227:	8b 45 08             	mov    0x8(%ebp),%eax
8010922a:	89 04 24             	mov    %eax,(%esp)
8010922d:	e8 a9 fb ff ff       	call   80108ddb <walkpgdir>
80109232:	89 45 ec             	mov    %eax,-0x14(%ebp)
80109235:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80109239:	75 0c                	jne    80109247 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010923b:	c7 04 24 eb 9e 10 80 	movl   $0x80109eeb,(%esp)
80109242:	e8 f6 72 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80109247:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010924a:	8b 00                	mov    (%eax),%eax
8010924c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80109251:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80109254:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109257:	8b 55 18             	mov    0x18(%ebp),%edx
8010925a:	89 d1                	mov    %edx,%ecx
8010925c:	29 c1                	sub    %eax,%ecx
8010925e:	89 c8                	mov    %ecx,%eax
80109260:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80109265:	77 11                	ja     80109278 <loaduvm+0x90>
      n = sz - i;
80109267:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010926a:	8b 55 18             	mov    0x18(%ebp),%edx
8010926d:	89 d1                	mov    %edx,%ecx
8010926f:	29 c1                	sub    %eax,%ecx
80109271:	89 c8                	mov    %ecx,%eax
80109273:	89 45 f0             	mov    %eax,-0x10(%ebp)
80109276:	eb 07                	jmp    8010927f <loaduvm+0x97>
    else
      n = PGSIZE;
80109278:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010927f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109282:	8b 55 14             	mov    0x14(%ebp),%edx
80109285:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80109288:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010928b:	89 04 24             	mov    %eax,(%esp)
8010928e:	e8 c5 f6 ff ff       	call   80108958 <p2v>
80109293:	8b 55 f0             	mov    -0x10(%ebp),%edx
80109296:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010929a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010929e:	89 44 24 04          	mov    %eax,0x4(%esp)
801092a2:	8b 45 10             	mov    0x10(%ebp),%eax
801092a5:	89 04 24             	mov    %eax,(%esp)
801092a8:	e8 b1 8a ff ff       	call   80101d5e <readi>
801092ad:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801092b0:	74 07                	je     801092b9 <loaduvm+0xd1>
      return -1;
801092b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801092b7:	eb 18                	jmp    801092d1 <loaduvm+0xe9>
{
  uint i, pa, n;
  pte_t *pte;
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801092b9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801092c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801092c3:	3b 45 18             	cmp    0x18(%ebp),%eax
801092c6:	0f 82 47 ff ff ff    	jb     80109213 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
801092cc:	b8 00 00 00 00       	mov    $0x0,%eax
}
801092d1:	83 c4 24             	add    $0x24,%esp
801092d4:	5b                   	pop    %ebx
801092d5:	5d                   	pop    %ebp
801092d6:	c3                   	ret    
...
801092da:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
801092dd:	8b 45 10             	mov    0x10(%ebp),%eax
801092e0:	85 c0                	test   %eax,%eax
801092e2:	79 0a                	jns    801092ee <allocuvm+0x17>
    return 0;
801092e4:	b8 00 00 00 00       	mov    $0x0,%eax
801092e9:	e9 c1 00 00 00       	jmp    801093af <allocuvm+0xd8>
  if(newsz < oldsz)
801092ee:	8b 45 10             	mov    0x10(%ebp),%eax
801092f1:	3b 45 0c             	cmp    0xc(%ebp),%eax
801092f4:	73 08                	jae    801092fe <allocuvm+0x27>
    return oldsz;
801092f6:	8b 45 0c             	mov    0xc(%ebp),%eax
801092f9:	e9 b1 00 00 00       	jmp    801093af <allocuvm+0xd8>
  a = PGROUNDUP(oldsz);
801092fe:	8b 45 0c             	mov    0xc(%ebp),%eax
80109301:	05 ff 0f 00 00       	add    $0xfff,%eax
80109306:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010930b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010930e:	e9 8d 00 00 00       	jmp    801093a0 <allocuvm+0xc9>
    mem = kalloc();
80109313:	e8 f8 97 ff ff       	call   80102b10 <kalloc>
80109318:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
8010931b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010931f:	75 2c                	jne    8010934d <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80109321:	c7 04 24 09 9f 10 80 	movl   $0x80109f09,(%esp)
80109328:	e8 74 70 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010932d:	8b 45 0c             	mov    0xc(%ebp),%eax
80109330:	89 44 24 08          	mov    %eax,0x8(%esp)
80109334:	8b 45 10             	mov    0x10(%ebp),%eax
80109337:	89 44 24 04          	mov    %eax,0x4(%esp)
8010933b:	8b 45 08             	mov    0x8(%ebp),%eax
8010933e:	89 04 24             	mov    %eax,(%esp)
80109341:	e8 6b 00 00 00       	call   801093b1 <deallocuvm>
      return 0;
80109346:	b8 00 00 00 00       	mov    $0x0,%eax
8010934b:	eb 62                	jmp    801093af <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010934d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109354:	00 
80109355:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010935c:	00 
8010935d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109360:	89 04 24             	mov    %eax,(%esp)
80109363:	e8 3e cb ff ff       	call   80105ea6 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80109368:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010936b:	89 04 24             	mov    %eax,(%esp)
8010936e:	e8 d8 f5 ff ff       	call   8010894b <v2p>
80109373:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109376:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010937d:	00 
8010937e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80109382:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109389:	00 
8010938a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010938e:	8b 45 08             	mov    0x8(%ebp),%eax
80109391:	89 04 24             	mov    %eax,(%esp)
80109394:	e8 d8 fa ff ff       	call   80108e71 <mappages>
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
    return oldsz;
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80109399:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801093a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801093a3:	3b 45 10             	cmp    0x10(%ebp),%eax
801093a6:	0f 82 67 ff ff ff    	jb     80109313 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
  ...
  return newsz;
801093ac:	8b 45 10             	mov    0x10(%ebp),%eax
}
801093af:	c9                   	leave  
801093b0:	c3                   	ret    
...
801093b4:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801093b7:	8b 45 10             	mov    0x10(%ebp),%eax
801093ba:	3b 45 0c             	cmp    0xc(%ebp),%eax
801093bd:	72 08                	jb     801093c7 <deallocuvm+0x16>
    return oldsz;
801093bf:	8b 45 0c             	mov    0xc(%ebp),%eax
801093c2:	e9 a4 00 00 00       	jmp    8010946b <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801093c7:	8b 45 10             	mov    0x10(%ebp),%eax
801093ca:	05 ff 0f 00 00       	add    $0xfff,%eax
801093cf:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801093d4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801093d7:	e9 80 00 00 00       	jmp    8010945c <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801093dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801093df:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801093e6:	00 
801093e7:	89 44 24 04          	mov    %eax,0x4(%esp)
801093eb:	8b 45 08             	mov    0x8(%ebp),%eax
801093ee:	89 04 24             	mov    %eax,(%esp)
801093f1:	e8 e5 f9 ff ff       	call   80108ddb <walkpgdir>
801093f6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801093f9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801093fd:	75 09                	jne    80109408 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801093ff:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80109406:	eb 4d                	jmp    80109455 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80109408:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010940b:	8b 00                	mov    (%eax),%eax
8010940d:	83 e0 01             	and    $0x1,%eax
80109410:	84 c0                	test   %al,%al
80109412:	74 41                	je     80109455 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80109414:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109417:	8b 00                	mov    (%eax),%eax
80109419:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010941e:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80109421:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80109425:	75 0c                	jne    80109433 <deallocuvm+0x82>
        panic("kfree");
80109427:	c7 04 24 21 9f 10 80 	movl   $0x80109f21,(%esp)
8010942e:	e8 0a 71 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80109433:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109436:	89 04 24             	mov    %eax,(%esp)
80109439:	e8 1a f5 ff ff       	call   80108958 <p2v>
8010943e:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80109441:	8b 45 e8             	mov    -0x18(%ebp),%eax
80109444:	89 04 24             	mov    %eax,(%esp)
80109447:	e8 2b 96 ff ff       	call   80102a77 <kfree>
      *pte = 0;
...
8010944f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80109455:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010945c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010945f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80109462:	0f 82 74 ff ff ff    	jb     801093dc <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
  ...
  return newsz;
80109468:	8b 45 10             	mov    0x10(%ebp),%eax
}
8010946b:	c9                   	leave  
8010946c:	c3                   	ret    
...
80109470:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80109473:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80109477:	75 0c                	jne    80109485 <freevm+0x18>
    panic("freevm: no pgdir");
80109479:	c7 04 24 27 9f 10 80 	movl   $0x80109f27,(%esp)
80109480:	e8 b8 70 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80109485:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010948c:	00 
8010948d:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80109494:	80 
80109495:	8b 45 08             	mov    0x8(%ebp),%eax
80109498:	89 04 24             	mov    %eax,(%esp)
8010949b:	e8 11 ff ff ff       	call   801093b1 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801094a0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801094a7:	eb 3c                	jmp    801094e5 <freevm+0x78>
    if(pgdir[i] & PTE_P){
801094a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801094ac:	c1 e0 02             	shl    $0x2,%eax
801094af:	03 45 08             	add    0x8(%ebp),%eax
801094b2:	8b 00                	mov    (%eax),%eax
801094b4:	83 e0 01             	and    $0x1,%eax
801094b7:	84 c0                	test   %al,%al
801094b9:	74 26                	je     801094e1 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801094bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801094be:	c1 e0 02             	shl    $0x2,%eax
801094c1:	03 45 08             	add    0x8(%ebp),%eax
801094c4:	8b 00                	mov    (%eax),%eax
801094c6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801094cb:	89 04 24             	mov    %eax,(%esp)
801094ce:	e8 85 f4 ff ff       	call   80108958 <p2v>
801094d3:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801094d6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801094d9:	89 04 24             	mov    %eax,(%esp)
801094dc:	e8 96 95 ff ff       	call   80102a77 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801094e1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801094e5:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801094ec:	76 bb                	jbe    801094a9 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801094f4:	e8 7e 95 ff ff       	call   80102a77 <kfree>
}
801094f9:	c9                   	leave  
801094fa:	c3                   	ret    
...
80109501:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109508:	00 
80109509:	8b 45 0c             	mov    0xc(%ebp),%eax
8010950c:	89 44 24 04          	mov    %eax,0x4(%esp)
80109510:	8b 45 08             	mov    0x8(%ebp),%eax
80109513:	89 04 24             	mov    %eax,(%esp)
80109516:	e8 c0 f8 ff ff       	call   80108ddb <walkpgdir>
8010951b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010951e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80109522:	75 0c                	jne    80109530 <clearpteu+0x35>
    panic("clearpteu");
80109524:	c7 04 24 38 9f 10 80 	movl   $0x80109f38,(%esp)
8010952b:	e8 0d 70 ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80109530:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109533:	8b 00                	mov    (%eax),%eax
80109535:	89 c2                	mov    %eax,%edx
80109537:	83 e2 fb             	and    $0xfffffffb,%edx
8010953a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010953d:	89 10                	mov    %edx,(%eax)
}
8010953f:	c9                   	leave  
80109540:	c3                   	ret    
...
{
80109541:	55                   	push   %ebp
80109542:	89 e5                	mov    %esp,%ebp
80109544:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80109547:	e8 b9 f9 ff ff       	call   80108f05 <setupkvm>
8010954c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010954f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80109553:	75 0a                	jne    8010955f <copyuvm+0x1e>
    return 0;
80109555:	b8 00 00 00 00       	mov    $0x0,%eax
8010955a:	e9 f1 00 00 00       	jmp    80109650 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
8010955f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80109566:	e9 c0 00 00 00       	jmp    8010962b <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010956b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010956e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80109575:	00 
80109576:	89 44 24 04          	mov    %eax,0x4(%esp)
8010957a:	8b 45 08             	mov    0x8(%ebp),%eax
8010957d:	89 04 24             	mov    %eax,(%esp)
80109580:	e8 56 f8 ff ff       	call   80108ddb <walkpgdir>
80109585:	89 45 ec             	mov    %eax,-0x14(%ebp)
80109588:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010958c:	75 0c                	jne    8010959a <copyuvm+0x59>
      panic("copyuvm: pte should exist");
8010958e:	c7 04 24 42 9f 10 80 	movl   $0x80109f42,(%esp)
80109595:	e8 a3 6f ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
8010959a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010959d:	8b 00                	mov    (%eax),%eax
8010959f:	83 e0 01             	and    $0x1,%eax
801095a2:	85 c0                	test   %eax,%eax
801095a4:	75 0c                	jne    801095b2 <copyuvm+0x71>
      panic("copyuvm: page not present");
801095a6:	c7 04 24 5c 9f 10 80 	movl   $0x80109f5c,(%esp)
801095ad:	e8 8b 6f ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801095b2:	8b 45 ec             	mov    -0x14(%ebp),%eax
801095b5:	8b 00                	mov    (%eax),%eax
801095b7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801095bc:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
801095bf:	e8 4c 95 ff ff       	call   80102b10 <kalloc>
801095c4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801095c7:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801095cb:	74 6f                	je     8010963c <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801095cd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801095d0:	89 04 24             	mov    %eax,(%esp)
801095d3:	e8 80 f3 ff ff       	call   80108958 <p2v>
801095d8:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801095df:	00 
801095e0:	89 44 24 04          	mov    %eax,0x4(%esp)
801095e4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801095e7:	89 04 24             	mov    %eax,(%esp)
801095ea:	e8 8a c9 ff ff       	call   80105f79 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
801095ef:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801095f2:	89 04 24             	mov    %eax,(%esp)
801095f5:	e8 51 f3 ff ff       	call   8010894b <v2p>
801095fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
801095fd:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80109604:	00 
80109605:	89 44 24 0c          	mov    %eax,0xc(%esp)
80109609:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80109610:	00 
80109611:	89 54 24 04          	mov    %edx,0x4(%esp)
80109615:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109618:	89 04 24             	mov    %eax,(%esp)
8010961b:	e8 51 f8 ff ff       	call   80108e71 <mappages>
80109620:	85 c0                	test   %eax,%eax
80109622:	78 1b                	js     8010963f <copyuvm+0xfe>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80109624:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010962b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010962e:	3b 45 0c             	cmp    0xc(%ebp),%eax
80109631:	0f 82 34 ff ff ff    	jb     8010956b <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
8010963a:	eb 14                	jmp    80109650 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
8010963c:	90                   	nop
8010963d:	eb 01                	jmp    80109640 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
8010963f:	90                   	nop
...
80109643:	89 04 24             	mov    %eax,(%esp)
80109646:	e8 22 fe ff ff       	call   8010946d <freevm>
  return 0;
8010964b:	b8 00 00 00 00       	mov    $0x0,%eax
}
80109650:	c9                   	leave  
80109651:	c3                   	ret    
...
{
80109652:	55                   	push   %ebp
80109653:	89 e5                	mov    %esp,%ebp
80109655:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80109658:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010965f:	00 
80109660:	8b 45 0c             	mov    0xc(%ebp),%eax
80109663:	89 44 24 04          	mov    %eax,0x4(%esp)
80109667:	8b 45 08             	mov    0x8(%ebp),%eax
8010966a:	89 04 24             	mov    %eax,(%esp)
8010966d:	e8 69 f7 ff ff       	call   80108ddb <walkpgdir>
80109672:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80109675:	8b 45 f4             	mov    -0xc(%ebp),%eax
80109678:	8b 00                	mov    (%eax),%eax
8010967a:	83 e0 01             	and    $0x1,%eax
8010967d:	85 c0                	test   %eax,%eax
8010967f:	75 07                	jne    80109688 <uva2ka+0x36>
    return 0;
80109681:	b8 00 00 00 00       	mov    $0x0,%eax
80109686:	eb 25                	jmp    801096ad <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80109688:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010968b:	8b 00                	mov    (%eax),%eax
8010968d:	83 e0 04             	and    $0x4,%eax
80109690:	85 c0                	test   %eax,%eax
80109692:	75 07                	jne    8010969b <uva2ka+0x49>
    return 0;
80109694:	b8 00 00 00 00       	mov    $0x0,%eax
80109699:	eb 12                	jmp    801096ad <uva2ka+0x5b>
  return (char*)p2v(PTE_ADDR(*pte));
8010969b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010969e:	8b 00                	mov    (%eax),%eax
801096a0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801096a5:	89 04 24             	mov    %eax,(%esp)
801096a8:	e8 ab f2 ff ff       	call   80108958 <p2v>
}
801096ad:	c9                   	leave  
801096ae:	c3                   	ret    
...
{
801096af:	55                   	push   %ebp
801096b0:	89 e5                	mov    %esp,%ebp
801096b2:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
801096b5:	8b 45 10             	mov    0x10(%ebp),%eax
801096b8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801096bb:	e9 8b 00 00 00       	jmp    8010974b <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
801096c0:	8b 45 0c             	mov    0xc(%ebp),%eax
801096c3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801096c8:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
801096cb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801096ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801096d2:	8b 45 08             	mov    0x8(%ebp),%eax
801096d5:	89 04 24             	mov    %eax,(%esp)
801096d8:	e8 75 ff ff ff       	call   80109652 <uva2ka>
801096dd:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801096e0:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801096e4:	75 07                	jne    801096ed <copyout+0x3e>
      return -1;
801096e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801096eb:	eb 6d                	jmp    8010975a <copyout+0xab>
    n = PGSIZE - (va - va0);
801096ed:	8b 45 0c             	mov    0xc(%ebp),%eax
801096f0:	8b 55 ec             	mov    -0x14(%ebp),%edx
801096f3:	89 d1                	mov    %edx,%ecx
801096f5:	29 c1                	sub    %eax,%ecx
801096f7:	89 c8                	mov    %ecx,%eax
801096f9:	05 00 10 00 00       	add    $0x1000,%eax
801096fe:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80109701:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109704:	3b 45 14             	cmp    0x14(%ebp),%eax
80109707:	76 06                	jbe    8010970f <copyout+0x60>
      n = len;
80109709:	8b 45 14             	mov    0x14(%ebp),%eax
8010970c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010970f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109712:	8b 55 0c             	mov    0xc(%ebp),%edx
80109715:	89 d1                	mov    %edx,%ecx
80109717:	29 c1                	sub    %eax,%ecx
80109719:	89 c8                	mov    %ecx,%eax
8010971b:	03 45 e8             	add    -0x18(%ebp),%eax
8010971e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80109721:	89 54 24 08          	mov    %edx,0x8(%esp)
80109725:	8b 55 f4             	mov    -0xc(%ebp),%edx
80109728:	89 54 24 04          	mov    %edx,0x4(%esp)
8010972c:	89 04 24             	mov    %eax,(%esp)
8010972f:	e8 45 c8 ff ff       	call   80105f79 <memmove>
    len -= n;
80109734:	8b 45 f0             	mov    -0x10(%ebp),%eax
80109737:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010973a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010973d:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80109740:	8b 45 ec             	mov    -0x14(%ebp),%eax
80109743:	05 00 10 00 00       	add    $0x1000,%eax
80109748:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
8010974b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010974f:	0f 85 6b ff ff ff    	jne    801096c0 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
  ...
  return 0;
80109755:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010975a:	c9                   	leave  
8010975b:	c3                   	ret    
