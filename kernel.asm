...
801000bd:	e8 fd 4c 00 00       	call   80104dbf <acquire>
...
80100104:	e8 18 4d 00 00       	call   80104e21 <release>
        return b;
...
8010017c:	e8 a0 4c 00 00       	call   80104e21 <release>
      return b;
...
8010023c:	e8 7e 4b 00 00       	call   80104dbf <acquire>
...
8010029d:	e8 15 49 00 00       	call   80104bb7 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 73 4b 00 00       	call   80104e21 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 fe 49 00 00       	call   80104dbf <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 e2 83 10 80 	movl   $0x801083e2,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec eb 83 10 80 	movl   $0x801083eb,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 e6 48 00 00       	call   80104e21 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 f2 83 10 80 	movl   $0x801083f2,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 01 84 10 80 	movl   $0x80108401,(%esp)
...
80100592:	e8 d9 48 00 00       	call   80104e70 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 03 84 10 80 	movl   $0x80108403,(%esp)
...
801006b2:	e8 2a 4a 00 00       	call   801050e1 <memmove>
    pos -= 80;
...
801006e1:	e8 28 49 00 00       	call   8010500e <memset>
  }
...
801007ba:	e8 00 46 00 00       	call   80104dbf <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 6b 44 00 00       	call   80104c5a <procdump>
      break;
...
801008f7:	e8 bb 42 00 00       	call   80104bb7 <wakeup>
        }
      }
      break;
...
8010091e:	e8 fe 44 00 00       	call   80104e21 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 77 44 00 00       	call   80104dbf <acquire>
  while(n > 0){
...
80100961:	e8 bb 44 00 00       	call   80104e21 <release>
        ilock(ip);
...
8010098a:	e8 4f 41 00 00       	call   80104ade <sleep>
...
80100a08:	e8 14 44 00 00       	call   80104e21 <release>
  ilock(ip);
...
80100a3e:	e8 7c 43 00 00       	call   80104dbf <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 a4 43 00 00       	call   80104e21 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 07 84 10 	movl   $0x80108407,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100aa2:	e8 f7 42 00 00       	call   80104d9e <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 0f 84 10 	movl   $0x8010840f,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 a0 dd 10 80 	movl   $0x8010dda0,(%esp)
80100ab6:	e8 e3 42 00 00       	call   80104d9e <initlock>
...
80100b7b:	e8 e5 6f 00 00       	call   80107b65 <setupkvm>
...
80100c14:	e8 1e 73 00 00       	call   80107f37 <allocuvm>
...
80100c51:	e8 f2 71 00 00       	call   80107e48 <loaduvm>
...
80100cbc:	e8 76 72 00 00       	call   80107f37 <allocuvm>
...
80100ce0:	e8 76 74 00 00       	call   8010815b <clearpteu>
  sp = sz;
...
80100d0f:	e8 78 45 00 00       	call   8010528c <strlen>
...
80100d2d:	e8 5a 45 00 00       	call   8010528c <strlen>
...
80100d57:	e8 b3 75 00 00       	call   8010830f <copyout>
...
80100df7:	e8 13 75 00 00       	call   8010830f <copyout>
...
80100e4e:	e8 eb 43 00 00       	call   8010523e <safestrcpy>
...
80100ea0:	e8 b1 6d 00 00       	call   80107c56 <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 1d 72 00 00       	call   801080cd <freevm>
  return 0;
...
80100ee2:	e8 e6 71 00 00       	call   801080cd <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 15 84 10 	movl   $0x80108415,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f15:	e8 84 3e 00 00       	call   80104d9e <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 91 3e 00 00       	call   80104dbf <acquire>
...
80100f52:	e8 ca 3e 00 00       	call   80104e21 <release>
      return f;
...
80100f70:	e8 ac 3e 00 00       	call   80104e21 <release>
  return 0;
...
80100f89:	e8 31 3e 00 00       	call   80104dbf <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 1c 84 10 80 	movl   $0x8010841c,(%esp)
...
80100fba:	e8 62 3e 00 00       	call   80104e21 <release>
  return f;
...
80100fd1:	e8 e9 3d 00 00       	call   80104dbf <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 24 84 10 80 	movl   $0x80108424,(%esp)
...
8010100c:	e8 10 3e 00 00       	call   80104e21 <release>
    return;
...
80101056:	e8 c6 3d 00 00       	call   80104e21 <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 2e 84 10 80 	movl   $0x8010842e,(%esp)
...
801012a3:	c7 04 24 37 84 10 80 	movl   $0x80108437,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 47 84 10 80 	movl   $0x80108447,(%esp)
...
80101320:	e8 bc 3d 00 00       	call   801050e1 <memmove>
  brelse(bp);
...
80101366:	e8 a3 3c 00 00       	call   8010500e <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 51 84 10 80 	movl   $0x80108451,(%esp)
...
80101565:	c7 04 24 67 84 10 80 	movl   $0x80108467,(%esp)
...
801015b9:	c7 44 24 04 7a 84 10 	movl   $0x8010847a,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801015c8:	e8 d1 37 00 00       	call   80104d9e <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 bf 39 00 00       	call   8010500e <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 81 84 10 80 	movl   $0x80108481,(%esp)
...
80101747:	e8 95 39 00 00       	call   801050e1 <memmove>
  log_write(bp);
...
80101771:	e8 49 36 00 00       	call   80104dbf <acquire>
...
801017bb:	e8 61 36 00 00       	call   80104e21 <release>
      return ip;
...
801017ee:	c7 04 24 93 84 10 80 	movl   $0x80108493,(%esp)
...
8010182c:	e8 f0 35 00 00       	call   80104e21 <release>
...
80101843:	e8 77 35 00 00       	call   80104dbf <acquire>
  ip->ref++;
...
8010185e:	e8 be 35 00 00       	call   80104e21 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 a3 84 10 80 	movl   $0x801084a3,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101891:	e8 29 35 00 00       	call   80104dbf <acquire>
...
801018a6:	e8 33 32 00 00       	call   80104ade <sleep>
...
801018d0:	e8 4c 35 00 00       	call   80104e21 <release>
...
8010197b:	e8 61 37 00 00       	call   801050e1 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 a9 84 10 80 	movl   $0x801084a9,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 b8 84 10 80 	movl   $0x801084b8,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019ec:	e8 ce 33 00 00       	call   80104dbf <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 aa 31 00 00       	call   80104bb7 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a14:	e8 08 34 00 00       	call   80104e21 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 92 33 00 00       	call   80104dbf <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 c0 84 10 80 	movl   $0x801084c0,(%esp)
...
80101a8a:	e8 92 33 00 00       	call   80104e21 <release>
    itrunc(ip);
...
80101ab5:	e8 05 33 00 00       	call   80104dbf <acquire>
    ip->flags = 0;
...
80101aca:	e8 e8 30 00 00       	call   80104bb7 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 37 33 00 00       	call   80104e21 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 ca 84 10 80 	movl   $0x801084ca,(%esp)
...
80101e92:	e8 4a 32 00 00       	call   801050e1 <memmove>
    brelse(bp);
...
80101ff8:	e8 e4 30 00 00       	call   801050e1 <memmove>
    log_write(bp);
...
8010207a:	e8 06 31 00 00       	call   80105185 <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 dd 84 10 80 	movl   $0x801084dd,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 ef 84 10 80 	movl   $0x801084ef,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 ef 84 10 80 	movl   $0x801084ef,(%esp)
...
801021fc:	e8 dc 2f 00 00       	call   801051dd <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 fc 84 10 80 	movl   $0x801084fc,(%esp)
...
801022b5:	e8 27 2e 00 00       	call   801050e1 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 0c 2e 00 00       	call   801050e1 <memmove>
    name[len] = 0;
...
8010252c:	c7 44 24 04 04 85 10 	movl   $0x80108504,0x4(%esp)
80102533:	80 
80102534:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
8010253b:	e8 5e 28 00 00       	call   80104d9e <initlock>
  picenable(IRQ_IDE);
...
801025d6:	75 0c                	jne    801025e4 <idestart+0x18>
    panic("idestart");
801025d8:	c7 04 24 08 85 10 80 	movl   $0x80108508,(%esp)
...
801026fe:	e8 bc 26 00 00       	call   80104dbf <acquire>
  if((b = idequeue) == 0){
...
80102718:	e8 04 27 00 00       	call   80104e21 <release>
...
8010278b:	e8 27 24 00 00       	call   80104bb7 <wakeup>
...
801027ad:	e8 6f 26 00 00       	call   80104e21 <release>
}
801027b2:	c9                   	leave  
801027b3:	c3                   	ret    
...
801027c6:	c7 04 24 11 85 10 80 	movl   $0x80108511,(%esp)
...
801027df:	c7 04 24 25 85 10 80 	movl   $0x80108525,(%esp)
...
8010286a:	e8 6f 22 00 00       	call   80104ade <sleep>
...
80102886:	e8 96 25 00 00       	call   80104e21 <release>
}
8010288b:	c9                   	leave  
8010288c:	c3                   	ret    
...
80102916:	c7 04 24 58 85 10 80 	movl   $0x80108558,(%esp)
...
801029d7:	c7 44 24 04 8a 85 10 	movl   $0x8010858a,0x4(%esp)
801029de:	80 
801029df:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
801029e6:	e8 b3 23 00 00       	call   80104d9e <initlock>
  kmem.use_lock = 0;
...
80102a91:	76 0c                	jbe    80102a9f <kfree+0x39>
    panic("kfree");
80102a93:	c7 04 24 8f 85 10 80 	movl   $0x8010858f,(%esp)
...
80102ab5:	e8 54 25 00 00       	call   8010500e <memset>
...
80102aca:	e8 f0 22 00 00       	call   80104dbf <acquire>
  r = (struct run*)v;
...
80102af8:	e8 24 23 00 00       	call   80104e21 <release>
}
80102afd:	c9                   	leave  
80102afe:	c3                   	ret    
...
80102b15:	e8 a5 22 00 00       	call   80104dbf <acquire>
  r = kmem.freelist;
...
80102b42:	e8 da 22 00 00       	call   80104e21 <release>
  return (char*)r;
...
80102ebe:	c7 04 24 98 85 10 80 	movl   $0x80108598,(%esp)
...
80103016:	c7 44 24 04 c4 85 10 	movl   $0x801085c4,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80103025:	e8 74 1d 00 00       	call   80104d9e <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 04 20 00 00       	call   801050e1 <memmove>
...
8010322a:	e8 90 1b 00 00       	call   80104dbf <acquire>
  while (log.busy) {
...
80103240:	e8 99 18 00 00       	call   80104ade <sleep>
...
8010325f:	e8 bd 1b 00 00       	call   80104e21 <release>
}
80103264:	c9                   	leave  
80103265:	c3                   	ret    
...
801032e0:	c7 04 24 c8 85 10 80 	movl   $0x801085c8,(%esp)
...
801032f5:	c7 04 24 de 85 10 80 	movl   $0x801085de,(%esp)
...
80103384:	e8 58 1d 00 00       	call   801050e1 <memmove>
  bwrite(lbuf);
...
80103424:	e8 f9 47 00 00       	call   80107c22 <kvmalloc>
...
8010343b:	e8 85 41 00 00       	call   801075c5 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103450:	c7 04 24 f5 85 10 80 	movl   $0x801085f5,(%esp)
...
8010346b:	e8 a0 34 00 00       	call   80106910 <uartinit>
  pinit();         // process table
80103470:	e8 96 0b 00 00       	call   8010400b <pinit>
  tvinit();        // trap vectors
80103475:	e8 39 30 00 00       	call   801064b3 <tvinit>
  binit();         // buffer cache
...
80103497:	e8 5a 2f 00 00       	call   801063f6 <timerinit>
...
801034c2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801034c5:	e8 6f 47 00 00       	call   80107c39 <switchkvm>
  seginit();
801034ca:	e8 f6 40 00 00       	call   801075c5 <seginit>
  lapicinit(cpunum());
...
801034f7:	c7 04 24 0c 86 10 80 	movl   $0x8010860c,(%esp)
801034fe:	e8 9e ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103503:	e8 1f 31 00 00       	call   80106627 <idtinit>
...
80103523:	e8 0d 14 00 00       	call   80104935 <scheduler>
...
80103555:	e8 87 1b 00 00       	call   801050e1 <memmove>
...
801036e3:	00 
801036e4:	c7 44 24 04 20 86 10 	movl   $0x80108620,0x4(%esp)
801036eb:	80 
801036ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ef:	89 04 24             	mov    %eax,(%esp)
801036f2:	e8 8e 19 00 00       	call   80105085 <memcmp>
...
80103824:	00 
80103825:	c7 44 24 04 25 86 10 	movl   $0x80108625,0x4(%esp)
8010382c:	80 
8010382d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103830:	89 04 24             	mov    %eax,(%esp)
80103833:	e8 4d 18 00 00       	call   80105085 <memcmp>
...
801038fe:	8b 04 85 68 86 10 80 	mov    -0x7fef7998(,%eax,4),%eax
...
80103937:	c7 04 24 2a 86 10 80 	movl   $0x8010862a,(%esp)
...
801039ca:	c7 04 24 48 86 10 80 	movl   $0x80108648,(%esp)
...
80103ccf:	c7 44 24 04 7c 86 10 	movl   $0x8010867c,0x4(%esp)
80103cd6:	80 
80103cd7:	89 04 24             	mov    %eax,(%esp)
80103cda:	e8 bf 10 00 00       	call   80104d9e <initlock>
  (*f0)->type = FD_PIPE;
...
80103d87:	e8 33 10 00 00       	call   80104dbf <acquire>
  if(writable){
...
80103daa:	e8 08 0e 00 00       	call   80104bb7 <wakeup>
...
80103dc9:	e8 e9 0d 00 00       	call   80104bb7 <wakeup>
  }
...
80103dee:	e8 2e 10 00 00       	call   80104e21 <release>
    kfree((char*)p);
...
80103e06:	e8 16 10 00 00       	call   80104e21 <release>
}
80103e0b:	c9                   	leave  
80103e0c:	c3                   	ret    
...
80103e1a:	e8 a0 0f 00 00       	call   80104dbf <acquire>
  for(i = 0; i < n; i++){
...
80103e4b:	e8 d1 0f 00 00       	call   80104e21 <release>
        return -1;
...
80103e65:	e8 4d 0d 00 00       	call   80104bb7 <wakeup>
...
80103e7d:	e8 5c 0c 00 00       	call   80104ade <sleep>
...
80103ee4:	e8 ce 0c 00 00       	call   80104bb7 <wakeup>
  release(&p->lock);
80103ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80103eec:	89 04 24             	mov    %eax,(%esp)
80103eef:	e8 2d 0f 00 00       	call   80104e21 <release>
  return n;
...
80103f0a:	e8 b0 0e 00 00       	call   80104dbf <acquire>
...
80103f24:	e8 f8 0e 00 00       	call   80104e21 <release>
      return -1;
...
80103f46:	e8 93 0b 00 00       	call   80104ade <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fd6:	e8 dc 0b 00 00       	call   80104bb7 <wakeup>
  release(&p->lock);
80103fdb:	8b 45 08             	mov    0x8(%ebp),%eax
80103fde:	89 04 24             	mov    %eax,(%esp)
80103fe1:	e8 3b 0e 00 00       	call   80104e21 <release>
  return i;
...
80104011:	c7 44 24 04 81 86 10 	movl   $0x80108681,0x4(%esp)
80104018:	80 
80104019:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104020:	e8 79 0d 00 00       	call   80104d9e <initlock>
}
80104025:	c9                   	leave  
80104026:	c3                   	ret    
...
80104034:	e8 86 0d 00 00       	call   80104dbf <acquire>
...
80104060:	e8 bc 0d 00 00       	call   80104e21 <release>
  return 0;
...
80104094:	e8 88 0d 00 00       	call   80104e21 <release>
...
801040de:	ba 68 64 10 80       	mov    $0x80106468,%edx
...
8010410e:	e8 fb 0e 00 00       	call   8010500e <memset>
  p->context->eip = (uint)forkret;
80104113:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104116:	8b 40 1c             	mov    0x1c(%eax),%eax
80104119:	ba b2 4a 10 80       	mov    $0x80104ab2,%edx
...
80104143:	e8 1d 3a 00 00       	call   80107b65 <setupkvm>
...
80104158:	c7 04 24 88 86 10 80 	movl   $0x80108688,(%esp)
...
8010417e:	e8 3a 3c 00 00       	call   80107dbd <inituvm>
  p->sz = PGSIZE;
...
801041a5:	e8 64 0e 00 00       	call   8010500e <memset>
...
8010421e:	00 
8010421f:	c7 44 24 04 a1 86 10 	movl   $0x801086a1,0x4(%esp)
80104226:	80 
80104227:	89 04 24             	mov    %eax,(%esp)
8010422a:	e8 0f 10 00 00       	call   8010523e <safestrcpy>
  p->cwd = namei("/");
8010422f:	c7 04 24 aa 86 10 80 	movl   $0x801086aa,(%esp)
...
80104283:	e8 af 3c 00 00       	call   80107f37 <allocuvm>
...
801042bd:	e8 4f 3d 00 00       	call   80108011 <deallocuvm>
...
801042e6:	e8 6b 39 00 00       	call   80107c56 <switchuvm>
  return 0;
...
801042f8:	83 ec 4c             	sub    $0x4c,%esp
  int i, pid,fd;
  struct proc *np;
...
80104300:	89 45 dc             	mov    %eax,-0x24(%ebp)
80104303:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
80104307:	75 0a                	jne    80104313 <fork+0x21>
    return -1;
80104309:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010430e:	e9 53 03 00 00       	jmp    80104666 <fork+0x374>
  if(np->pid > 0)
80104313:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104316:	8b 40 10             	mov    0x10(%eax),%eax
80104319:	85 c0                	test   %eax,%eax
8010431b:	0f 8e 0b 02 00 00    	jle    8010452c <fork+0x23a>
  {
    begin_trans();
80104321:	e8 f7 ee ff ff       	call   8010321d <begin_trans>
    int i = 0;
80104326:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
    char name[8];
    name[2] = '.'; name[3] = 's'; name[4] = 'w'; name[5] = 'a'; name[6] = 'p'; name[7] = 0;
8010432d:	c6 45 c6 2e          	movb   $0x2e,-0x3a(%ebp)
80104331:	c6 45 c7 73          	movb   $0x73,-0x39(%ebp)
80104335:	c6 45 c8 77          	movb   $0x77,-0x38(%ebp)
80104339:	c6 45 c9 61          	movb   $0x61,-0x37(%ebp)
8010433d:	c6 45 ca 70          	movb   $0x70,-0x36(%ebp)
80104341:	c6 45 cb 00          	movb   $0x0,-0x35(%ebp)
    name[1] = (char)(((int)'0')+np->pid % 10);
80104345:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104348:	8b 48 10             	mov    0x10(%eax),%ecx
8010434b:	ba 67 66 66 66       	mov    $0x66666667,%edx
80104350:	89 c8                	mov    %ecx,%eax
80104352:	f7 ea                	imul   %edx
80104354:	c1 fa 02             	sar    $0x2,%edx
80104357:	89 c8                	mov    %ecx,%eax
80104359:	c1 f8 1f             	sar    $0x1f,%eax
8010435c:	29 c2                	sub    %eax,%edx
8010435e:	89 d0                	mov    %edx,%eax
80104360:	c1 e0 02             	shl    $0x2,%eax
80104363:	01 d0                	add    %edx,%eax
80104365:	01 c0                	add    %eax,%eax
80104367:	89 ca                	mov    %ecx,%edx
80104369:	29 c2                	sub    %eax,%edx
8010436b:	89 d0                	mov    %edx,%eax
8010436d:	83 c0 30             	add    $0x30,%eax
80104370:	88 45 c5             	mov    %al,-0x3b(%ebp)
    if((i=np->pid/10) == 0)
80104373:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104376:	8b 48 10             	mov    0x10(%eax),%ecx
80104379:	ba 67 66 66 66       	mov    $0x66666667,%edx
8010437e:	89 c8                	mov    %ecx,%eax
80104380:	f7 ea                	imul   %edx
80104382:	c1 fa 02             	sar    $0x2,%edx
80104385:	89 c8                	mov    %ecx,%eax
80104387:	c1 f8 1f             	sar    $0x1f,%eax
8010438a:	89 d1                	mov    %edx,%ecx
8010438c:	29 c1                	sub    %eax,%ecx
8010438e:	89 c8                	mov    %ecx,%eax
80104390:	89 45 d8             	mov    %eax,-0x28(%ebp)
80104393:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
80104397:	75 06                	jne    8010439f <fork+0xad>
      name[0] = '0';
80104399:	c6 45 c4 30          	movb   $0x30,-0x3c(%ebp)
8010439d:	eb 09                	jmp    801043a8 <fork+0xb6>
    else
      name[0] = (char)(((int)'0')+i);
8010439f:	8b 45 d8             	mov    -0x28(%ebp),%eax
801043a2:	83 c0 30             	add    $0x30,%eax
801043a5:	88 45 c4             	mov    %al,-0x3c(%ebp)
    char path = '/';
801043a8:	c6 45 c3 2f          	movb   $0x2f,-0x3d(%ebp)
    struct inode *ip, *dp;
    if((dp = nameiparent(&path, name)) == 0)
801043ac:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801043af:	89 44 24 04          	mov    %eax,0x4(%esp)
801043b3:	8d 45 c3             	lea    -0x3d(%ebp),%eax
801043b6:	89 04 24             	mov    %eax,(%esp)
801043b9:	e8 6e e0 ff ff       	call   8010242c <nameiparent>
801043be:	89 45 d4             	mov    %eax,-0x2c(%ebp)
801043c1:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
801043c5:	75 0a                	jne    801043d1 <fork+0xdf>
      return 0;
801043c7:	b8 00 00 00 00       	mov    $0x0,%eax
801043cc:	e9 95 02 00 00       	jmp    80104666 <fork+0x374>

    if((ip = ialloc(dp->dev, T_FILE)) == 0)
801043d1:	8b 45 d4             	mov    -0x2c(%ebp),%eax
801043d4:	8b 00                	mov    (%eax),%eax
801043d6:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801043dd:	00 
801043de:	89 04 24             	mov    %eax,(%esp)
801043e1:	e8 e9 d1 ff ff       	call   801015cf <ialloc>
801043e6:	89 45 d0             	mov    %eax,-0x30(%ebp)
801043e9:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
801043ed:	75 0c                	jne    801043fb <fork+0x109>
      panic("create: ialloc");
801043ef:	c7 04 24 ac 86 10 80 	movl   $0x801086ac,(%esp)
801043f6:	e8 42 c1 ff ff       	call   8010053d <panic>
    

    ilock(ip);
801043fb:	8b 45 d0             	mov    -0x30(%ebp),%eax
801043fe:	89 04 24             	mov    %eax,(%esp)
80104401:	e8 62 d4 ff ff       	call   80101868 <ilock>
    ip->major = 0;
80104406:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104409:	66 c7 40 12 00 00    	movw   $0x0,0x12(%eax)
    ip->minor = 0;
8010440f:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104412:	66 c7 40 14 00 00    	movw   $0x0,0x14(%eax)
    ip->nlink = 1;
80104418:	8b 45 d0             	mov    -0x30(%ebp),%eax
8010441b:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
    iupdate(ip);
80104421:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104424:	89 04 24             	mov    %eax,(%esp)
80104427:	e8 80 d2 ff ff       	call   801016ac <iupdate>

    if(ip == 0)
8010442c:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
80104430:	75 0a                	jne    8010443c <fork+0x14a>
      return 0;
80104432:	b8 00 00 00 00       	mov    $0x0,%eax
80104437:	e9 2a 02 00 00       	jmp    80104666 <fork+0x374>
  
    
    
    if((np->swap = filealloc()) == 0)
8010443c:	e8 db ca ff ff       	call   80100f1c <filealloc>
80104441:	8b 55 dc             	mov    -0x24(%ebp),%edx
80104444:	89 42 7c             	mov    %eax,0x7c(%edx)
80104447:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010444a:	8b 40 7c             	mov    0x7c(%eax),%eax
8010444d:	85 c0                	test   %eax,%eax
8010444f:	75 2d                	jne    8010447e <fork+0x18c>
    {
      if(np->swap)
80104451:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104454:	8b 40 7c             	mov    0x7c(%eax),%eax
80104457:	85 c0                	test   %eax,%eax
80104459:	74 0e                	je     80104469 <fork+0x177>
	fileclose(np->swap);
8010445b:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010445e:	8b 40 7c             	mov    0x7c(%eax),%eax
80104461:	89 04 24             	mov    %eax,(%esp)
80104464:	e8 5b cb ff ff       	call   80100fc4 <fileclose>
      iunlockput(ip);
80104469:	8b 45 d0             	mov    -0x30(%ebp),%eax
8010446c:	89 04 24             	mov    %eax,(%esp)
8010446f:	e8 78 d6 ff ff       	call   80101aec <iunlockput>
      return 0;
80104474:	b8 00 00 00 00       	mov    $0x0,%eax
80104479:	e9 e8 01 00 00       	jmp    80104666 <fork+0x374>
    }
    iunlock(ip);
8010447e:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104481:	89 04 24             	mov    %eax,(%esp)
80104484:	e8 2d d5 ff ff       	call   801019b6 <iunlock>

    np->swap->type = FD_INODE;
80104489:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010448c:	8b 40 7c             	mov    0x7c(%eax),%eax
8010448f:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
    np->swap->ip = ip;
80104495:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104498:	8b 40 7c             	mov    0x7c(%eax),%eax
8010449b:	8b 55 d0             	mov    -0x30(%ebp),%edx
8010449e:	89 50 10             	mov    %edx,0x10(%eax)
    np->swap->off = 0;
801044a1:	8b 45 dc             	mov    -0x24(%ebp),%eax
801044a4:	8b 40 7c             	mov    0x7c(%eax),%eax
801044a7:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
    np->swap->readable = !(O_WRONLY);
801044ae:	8b 45 dc             	mov    -0x24(%ebp),%eax
801044b1:	8b 40 7c             	mov    0x7c(%eax),%eax
801044b4:	c6 40 08 00          	movb   $0x0,0x8(%eax)
    np->swap->writable = (O_WRONLY || O_RDWR);
801044b8:	8b 45 dc             	mov    -0x24(%ebp),%eax
801044bb:	8b 40 7c             	mov    0x7c(%eax),%eax
801044be:	c6 40 09 01          	movb   $0x1,0x9(%eax)
    commit_trans();
801044c2:	e8 9f ed ff ff       	call   80103266 <commit_trans>
    for(fd = 0; fd < NOFILE; fd++){
801044c7:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
801044ce:	eb 2a                	jmp    801044fa <fork+0x208>
    if(np->ofile[fd] == 0){
801044d0:	8b 45 dc             	mov    -0x24(%ebp),%eax
801044d3:	8b 55 e0             	mov    -0x20(%ebp),%edx
801044d6:	83 c2 08             	add    $0x8,%edx
801044d9:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801044dd:	85 c0                	test   %eax,%eax
801044df:	75 15                	jne    801044f6 <fork+0x204>
      np->ofile[fd] = np->swap;
801044e1:	8b 45 dc             	mov    -0x24(%ebp),%eax
801044e4:	8b 50 7c             	mov    0x7c(%eax),%edx
801044e7:	8b 45 dc             	mov    -0x24(%ebp),%eax
801044ea:	8b 4d e0             	mov    -0x20(%ebp),%ecx
801044ed:	83 c1 08             	add    $0x8,%ecx
801044f0:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      break;
801044f4:	eb 0a                	jmp    80104500 <fork+0x20e>
    np->swap->ip = ip;
    np->swap->off = 0;
    np->swap->readable = !(O_WRONLY);
    np->swap->writable = (O_WRONLY || O_RDWR);
    commit_trans();
    for(fd = 0; fd < NOFILE; fd++){
801044f6:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
801044fa:	83 7d e0 0f          	cmpl   $0xf,-0x20(%ebp)
801044fe:	7e d0                	jle    801044d0 <fork+0x1de>
    if(np->ofile[fd] == 0){
      np->ofile[fd] = np->swap;
      break;
    }
...
80104500:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104503:	8b 40 7c             	mov    0x7c(%eax),%eax
80104506:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
8010450d:	00 
8010450e:	c7 44 24 04 bb 86 10 	movl   $0x801086bb,0x4(%esp)
80104515:	80 
80104516:	89 04 24             	mov    %eax,(%esp)
80104519:	e8 87 cc ff ff       	call   801011a5 <filewrite>
    fileclose(np->swap);
8010451e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104521:	8b 40 7c             	mov    0x7c(%eax),%eax
80104524:	89 04 24             	mov    %eax,(%esp)
80104527:	e8 98 ca ff ff       	call   80100fc4 <fileclose>
  }
  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
8010452c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104532:	8b 10                	mov    (%eax),%edx
...
80104544:	e8 58 3c 00 00       	call   801081a1 <copyuvm>
80104549:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010454c:	89 42 04             	mov    %eax,0x4(%edx)
8010454f:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104552:	8b 40 04             	mov    0x4(%eax),%eax
80104555:	85 c0                	test   %eax,%eax
80104557:	75 2c                	jne    80104585 <fork+0x293>
    kfree(np->kstack);
80104559:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010455c:	8b 40 08             	mov    0x8(%eax),%eax
8010455f:	89 04 24             	mov    %eax,(%esp)
80104562:	e8 ff e4 ff ff       	call   80102a66 <kfree>
    np->kstack = 0;
80104567:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010456a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
80104571:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104574:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
8010457b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104580:	e9 e1 00 00 00       	jmp    80104666 <fork+0x374>
  }
  np->sz = proc->sz;
80104585:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010458b:	8b 10                	mov    (%eax),%edx
8010458d:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104590:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104592:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104599:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010459c:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
8010459f:	8b 45 dc             	mov    -0x24(%ebp),%eax
801045a2:	8b 50 18             	mov    0x18(%eax),%edx
...
801045d1:	eb 3d                	jmp    80104610 <fork+0x31e>
    if(proc->ofile[i])
801045d3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045d9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801045dc:	83 c2 08             	add    $0x8,%edx
801045df:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801045e3:	85 c0                	test   %eax,%eax
801045e5:	74 25                	je     8010460c <fork+0x31a>
      np->ofile[i] = filedup(proc->ofile[i]);
801045e7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045ed:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801045f0:	83 c2 08             	add    $0x8,%edx
801045f3:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801045f7:	89 04 24             	mov    %eax,(%esp)
801045fa:	e8 7d c9 ff ff       	call   80100f7c <filedup>
801045ff:	8b 55 dc             	mov    -0x24(%ebp),%edx
80104602:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104605:	83 c1 08             	add    $0x8,%ecx
80104608:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
8010460c:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104610:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104614:	7e bd                	jle    801045d3 <fork+0x2e1>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
80104616:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010461c:	8b 40 68             	mov    0x68(%eax),%eax
8010461f:	89 04 24             	mov    %eax,(%esp)
80104622:	e8 0f d2 ff ff       	call   80101836 <idup>
80104627:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010462a:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
8010462d:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104630:	8b 40 10             	mov    0x10(%eax),%eax
80104633:	89 45 cc             	mov    %eax,-0x34(%ebp)
  np->state = RUNNABLE;
80104636:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104639:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104640:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104646:	8d 50 6c             	lea    0x6c(%eax),%edx
80104649:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010464c:	83 c0 6c             	add    $0x6c,%eax
8010464f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104656:	00 
80104657:	89 54 24 04          	mov    %edx,0x4(%esp)
8010465b:	89 04 24             	mov    %eax,(%esp)
8010465e:	e8 db 0b 00 00       	call   8010523e <safestrcpy>
  return pid;
80104663:	8b 45 cc             	mov    -0x34(%ebp),%eax
}
80104666:	83 c4 4c             	add    $0x4c,%esp
80104669:	5b                   	pop    %ebx
8010466a:	5e                   	pop    %esi
8010466b:	5f                   	pop    %edi
8010466c:	5d                   	pop    %ebp
...
80104671:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int fd;

  if(proc == initproc)
80104674:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010467b:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104680:	39 c2                	cmp    %eax,%edx
80104682:	75 0c                	jne    80104690 <exit+0x22>
    panic("init exiting");
80104684:	c7 04 24 bf 86 10 80 	movl   $0x801086bf,(%esp)
8010468b:	e8 ad be ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104690:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104697:	eb 44                	jmp    801046dd <exit+0x6f>
    if(proc->ofile[fd]){
80104699:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010469f:	8b 55 f0             	mov    -0x10(%ebp),%edx
801046a2:	83 c2 08             	add    $0x8,%edx
801046a5:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801046a9:	85 c0                	test   %eax,%eax
801046ab:	74 2c                	je     801046d9 <exit+0x6b>
...
801046c0:	e8 ff c8 ff ff       	call   80100fc4 <fileclose>
      proc->ofile[fd] = 0;
801046c5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046cb:	8b 55 f0             	mov    -0x10(%ebp),%edx
801046ce:	83 c2 08             	add    $0x8,%edx
801046d1:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801046d8:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801046d9:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801046dd:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801046e1:	7e b6                	jle    80104699 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
801046ef:	e8 27 d3 ff ff       	call   80101a1b <iput>
  proc->cwd = 0;
801046f4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046fa:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104701:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104708:	e8 b2 06 00 00       	call   80104dbf <acquire>
...
80104719:	e8 5b 04 00 00       	call   80104b79 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010471e:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104725:	eb 38                	jmp    8010475f <exit+0xf1>
    if(p->parent == proc){
80104727:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010472a:	8b 50 14             	mov    0x14(%eax),%edx
8010472d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104733:	39 c2                	cmp    %eax,%edx
80104735:	75 24                	jne    8010475b <exit+0xed>
      p->parent = initproc;
80104737:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
...
80104749:	83 f8 05             	cmp    $0x5,%eax
8010474c:	75 0d                	jne    8010475b <exit+0xed>
        wakeup1(initproc);
8010474e:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104753:	89 04 24             	mov    %eax,(%esp)
80104756:	e8 1e 04 00 00       	call   80104b79 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010475b:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
8010475f:	81 7d f4 54 1f 11 80 	cmpl   $0x80111f54,-0xc(%ebp)
80104766:	72 bf                	jb     80104727 <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
8010476e:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104775:	e8 54 02 00 00       	call   801049ce <sched>
  panic("zombie exit");
8010477a:	c7 04 24 cc 86 10 80 	movl   $0x801086cc,(%esp)
80104781:	e8 b7 bd ff ff       	call   8010053d <panic>
...
80104789:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010478c:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104793:	e8 27 06 00 00       	call   80104dbf <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104798:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010479f:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
801047a6:	e9 9a 00 00 00       	jmp    80104845 <wait+0xbf>
      if(p->parent != proc)
801047ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047ae:	8b 50 14             	mov    0x14(%eax),%edx
801047b1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047b7:	39 c2                	cmp    %eax,%edx
801047b9:	0f 85 81 00 00 00    	jne    80104840 <wait+0xba>
        continue;
      havekids = 1;
...
801047fb:	e8 cd 38 00 00       	call   801080cd <freevm>
        p->state = UNUSED;
80104800:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104803:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
8010480a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010480d:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104814:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104817:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
8010481e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104821:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104825:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104828:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
8010482f:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104836:	e8 e6 05 00 00       	call   80104e21 <release>
        return pid;
8010483b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010483e:	eb 53                	jmp    80104893 <wait+0x10d>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104840:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104841:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
80104845:	81 7d f4 54 1f 11 80 	cmpl   $0x80111f54,-0xc(%ebp)
8010484c:	0f 82 59 ff ff ff    	jb     801047ab <wait+0x25>
        return pid;
      }
    }
...
80104856:	74 0d                	je     80104865 <wait+0xdf>
...
80104863:	74 13                	je     80104878 <wait+0xf2>
      release(&ptable.lock);
80104865:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010486c:	e8 b0 05 00 00       	call   80104e21 <release>
      return -1;
80104871:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104876:	eb 1b                	jmp    80104893 <wait+0x10d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104878:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010487e:	c7 44 24 04 20 ff 10 	movl   $0x8010ff20,0x4(%esp)
80104885:	80 
80104886:	89 04 24             	mov    %eax,(%esp)
80104889:	e8 50 02 00 00       	call   80104ade <sleep>
  }
8010488e:	e9 05 ff ff ff       	jmp    80104798 <wait+0x12>
}
80104893:	c9                   	leave  
80104894:	c3                   	ret    

80104895 <register_handler>:
...
801048a1:	8b 40 18             	mov    0x18(%eax),%eax
801048a4:	8b 40 44             	mov    0x44(%eax),%eax
801048a7:	89 c2                	mov    %eax,%edx
801048a9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048af:	8b 40 04             	mov    0x4(%eax),%eax
801048b2:	89 54 24 04          	mov    %edx,0x4(%esp)
801048b6:	89 04 24             	mov    %eax,(%esp)
801048b9:	e8 f4 39 00 00       	call   801082b2 <uva2ka>
801048be:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if ((proc->tf->esp & 0xFFF) == 0)
801048c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048c7:	8b 40 18             	mov    0x18(%eax),%eax
801048ca:	8b 40 44             	mov    0x44(%eax),%eax
801048cd:	25 ff 0f 00 00       	and    $0xfff,%eax
801048d2:	85 c0                	test   %eax,%eax
801048d4:	75 0c                	jne    801048e2 <register_handler+0x4d>
    panic("esp_offset == 0");
801048d6:	c7 04 24 d8 86 10 80 	movl   $0x801086d8,(%esp)
801048dd:	e8 5b bc ff ff       	call   8010053d <panic>

    /* open a new frame */
  *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF))
801048e2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048e8:	8b 40 18             	mov    0x18(%eax),%eax
801048eb:	8b 40 44             	mov    0x44(%eax),%eax
801048ee:	83 e8 04             	sub    $0x4,%eax
801048f1:	25 ff 0f 00 00       	and    $0xfff,%eax
801048f6:	03 45 f4             	add    -0xc(%ebp),%eax
          = proc->tf->eip;
801048f9:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104900:	8b 52 18             	mov    0x18(%edx),%edx
80104903:	8b 52 38             	mov    0x38(%edx),%edx
80104906:	89 10                	mov    %edx,(%eax)
  proc->tf->esp -= 4;
80104908:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010490e:	8b 40 18             	mov    0x18(%eax),%eax
80104911:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104918:	8b 52 18             	mov    0x18(%edx),%edx
8010491b:	8b 52 44             	mov    0x44(%edx),%edx
8010491e:	83 ea 04             	sub    $0x4,%edx
80104921:	89 50 44             	mov    %edx,0x44(%eax)
...
80104930:	89 50 38             	mov    %edx,0x38(%eax)
}
80104933:	c9                   	leave  
80104934:	c3                   	ret    
...
80104938:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  for(;;){
    // Enable interrupts on this processor.
    sti();
8010493b:	e8 c5 f6 ff ff       	call   80104005 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104940:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104947:	e8 73 04 00 00       	call   80104dbf <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010494c:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104953:	eb 5f                	jmp    801049b4 <scheduler+0x7f>
      if(p->state != RUNNABLE)
80104955:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104958:	8b 40 0c             	mov    0xc(%eax),%eax
8010495b:	83 f8 03             	cmp    $0x3,%eax
8010495e:	75 4f                	jne    801049af <scheduler+0x7a>
        continue;
...
80104963:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
80104969:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010496c:	89 04 24             	mov    %eax,(%esp)
8010496f:	e8 e2 32 00 00       	call   80107c56 <switchuvm>
      p->state = RUNNING;
80104974:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104977:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
8010497e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104984:	8b 40 1c             	mov    0x1c(%eax),%eax
80104987:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010498e:	83 c2 04             	add    $0x4,%edx
80104991:	89 44 24 04          	mov    %eax,0x4(%esp)
80104995:	89 14 24             	mov    %edx,(%esp)
80104998:	e8 17 09 00 00       	call   801052b4 <swtch>
      switchkvm();
8010499d:	e8 97 32 00 00       	call   80107c39 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
801049a2:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801049a9:	00 00 00 00 
801049ad:	eb 01                	jmp    801049b0 <scheduler+0x7b>
...
801049b4:	81 7d f4 54 1f 11 80 	cmpl   $0x80111f54,-0xc(%ebp)
801049bb:	72 98                	jb     80104955 <scheduler+0x20>
...
801049c4:	e8 58 04 00 00       	call   80104e21 <release>

  }
801049c9:	e9 6d ff ff ff       	jmp    8010493b <scheduler+0x6>
...
801049d4:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801049db:	e8 fd 04 00 00       	call   80104edd <holding>
801049e0:	85 c0                	test   %eax,%eax
801049e2:	75 0c                	jne    801049f0 <sched+0x22>
    panic("sched ptable.lock");
801049e4:	c7 04 24 e8 86 10 80 	movl   $0x801086e8,(%esp)
801049eb:	e8 4d bb ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
801049f0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049f6:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801049fc:	83 f8 01             	cmp    $0x1,%eax
801049ff:	74 0c                	je     80104a0d <sched+0x3f>
    panic("sched locks");
80104a01:	c7 04 24 fa 86 10 80 	movl   $0x801086fa,(%esp)
80104a08:	e8 30 bb ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80104a0d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a13:	8b 40 0c             	mov    0xc(%eax),%eax
80104a16:	83 f8 04             	cmp    $0x4,%eax
80104a19:	75 0c                	jne    80104a27 <sched+0x59>
    panic("sched running");
80104a1b:	c7 04 24 06 87 10 80 	movl   $0x80108706,(%esp)
80104a22:	e8 16 bb ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104a27:	e8 c4 f5 ff ff       	call   80103ff0 <readeflags>
80104a2c:	25 00 02 00 00       	and    $0x200,%eax
80104a31:	85 c0                	test   %eax,%eax
80104a33:	74 0c                	je     80104a41 <sched+0x73>
    panic("sched interruptible");
80104a35:	c7 04 24 14 87 10 80 	movl   $0x80108714,(%esp)
80104a3c:	e8 fc ba ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80104a41:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a47:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104a4d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104a50:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a56:	8b 40 04             	mov    0x4(%eax),%eax
80104a59:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104a60:	83 c2 1c             	add    $0x1c,%edx
80104a63:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a67:	89 14 24             	mov    %edx,(%esp)
80104a6a:	e8 45 08 00 00       	call   801052b4 <swtch>
  cpu->intena = intena;
80104a6f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a75:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a78:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104a7e:	c9                   	leave  
80104a7f:	c3                   	ret    
...
80104a83:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
80104a86:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104a8d:	e8 2d 03 00 00       	call   80104dbf <acquire>
  proc->state = RUNNABLE;
80104a92:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a98:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104a9f:	e8 2a ff ff ff       	call   801049ce <sched>
  release(&ptable.lock);
80104aa4:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104aab:	e8 71 03 00 00       	call   80104e21 <release>
}
80104ab0:	c9                   	leave  
80104ab1:	c3                   	ret    
...
80104ab5:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104ab8:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104abf:	e8 5d 03 00 00       	call   80104e21 <release>

  if (first) {
80104ac4:	a1 20 b0 10 80       	mov    0x8010b020,%eax
...
80104acb:	74 0f                	je     80104adc <forkret+0x2a>
    ...
    // be run from main().
    first = 0;
80104acd:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
80104ad4:	00 00 00 
    initlog();
80104ad7:	e8 34 e5 ff ff       	call   80103010 <initlog>
  }
...
80104aec:	75 0c                	jne    80104afa <sleep+0x1c>
    panic("sleep");
80104aee:	c7 04 24 28 87 10 80 	movl   $0x80108728,(%esp)
80104af5:	e8 43 ba ff ff       	call   8010053d <panic>

  if(lk == 0)
80104afa:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104afe:	75 0c                	jne    80104b0c <sleep+0x2e>
    panic("sleep without lk");
80104b00:	c7 04 24 2e 87 10 80 	movl   $0x8010872e,(%esp)
80104b07:	e8 31 ba ff ff       	call   8010053d <panic>
...
80104b0c:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
80104b13:	74 17                	je     80104b2c <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104b15:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104b1c:	e8 9e 02 00 00       	call   80104dbf <acquire>
    release(lk);
80104b21:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b24:	89 04 24             	mov    %eax,(%esp)
80104b27:	e8 f5 02 00 00       	call   80104e21 <release>
  }
...
80104b3e:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
 ...
 // proc->state = SLEEPING_SUSPENDED;
  sched();
80104b45:	e8 84 fe ff ff       	call   801049ce <sched>

  // Tidy up.
  proc->chan = 0;
80104b4a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b50:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104b57:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
80104b5e:	74 17                	je     80104b77 <sleep+0x99>
    release(&ptable.lock);
80104b60:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104b67:	e8 b5 02 00 00       	call   80104e21 <release>
    acquire(lk);
80104b6c:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b6f:	89 04 24             	mov    %eax,(%esp)
80104b72:	e8 48 02 00 00       	call   80104dbf <acquire>
  }
}
80104b77:	c9                   	leave  
80104b78:	c3                   	ret    
...
80104b7c:	83 ec 10             	sub    $0x10,%esp
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b7f:	c7 45 fc 54 ff 10 80 	movl   $0x8010ff54,-0x4(%ebp)
80104b86:	eb 24                	jmp    80104bac <wakeup1+0x33>
    if(p->state == SLEEPING && p->chan == chan)
80104b88:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b8b:	8b 40 0c             	mov    0xc(%eax),%eax
80104b8e:	83 f8 02             	cmp    $0x2,%eax
80104b91:	75 15                	jne    80104ba8 <wakeup1+0x2f>
80104b93:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b96:	8b 40 20             	mov    0x20(%eax),%eax
80104b99:	3b 45 08             	cmp    0x8(%ebp),%eax
80104b9c:	75 0a                	jne    80104ba8 <wakeup1+0x2f>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104ba8:	83 6d fc 80          	subl   $0xffffff80,-0x4(%ebp)
80104bac:	81 7d fc 54 1f 11 80 	cmpl   $0x80111f54,-0x4(%ebp)
80104bb3:	72 d3                	jb     80104b88 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104bb5:	c9                   	leave  
...
80104bba:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104bbd:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104bc4:	e8 f6 01 00 00       	call   80104dbf <acquire>
  wakeup1(chan);
80104bc9:	8b 45 08             	mov    0x8(%ebp),%eax
80104bcc:	89 04 24             	mov    %eax,(%esp)
80104bcf:	e8 a5 ff ff ff       	call   80104b79 <wakeup1>
  release(&ptable.lock);
80104bd4:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104bdb:	e8 41 02 00 00       	call   80104e21 <release>
}
80104be0:	c9                   	leave  
80104be1:	c3                   	ret    
...
80104be5:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104be8:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104bef:	e8 cb 01 00 00       	call   80104dbf <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bf4:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104bfb:	eb 41                	jmp    80104c3e <kill+0x5c>
    if(p->pid == pid){
80104bfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c00:	8b 40 10             	mov    0x10(%eax),%eax
80104c03:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c06:	75 32                	jne    80104c3a <kill+0x58>
      p->killed = 1;
80104c08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c0b:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104c12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c15:	8b 40 0c             	mov    0xc(%eax),%eax
80104c18:	83 f8 02             	cmp    $0x2,%eax
80104c1b:	75 0a                	jne    80104c27 <kill+0x45>
        p->state = RUNNABLE;
80104c1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c20:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104c27:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104c2e:	e8 ee 01 00 00       	call   80104e21 <release>
      return 0;
80104c33:	b8 00 00 00 00       	mov    $0x0,%eax
80104c38:	eb 1e                	jmp    80104c58 <kill+0x76>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c3a:	83 6d f4 80          	subl   $0xffffff80,-0xc(%ebp)
80104c3e:	81 7d f4 54 1f 11 80 	cmpl   $0x80111f54,-0xc(%ebp)
80104c45:	72 b6                	jb     80104bfd <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104c47:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104c4e:	e8 ce 01 00 00       	call   80104e21 <release>
  return -1;
...
80104c5d:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c60:	c7 45 f0 54 ff 10 80 	movl   $0x8010ff54,-0x10(%ebp)
80104c67:	e9 d8 00 00 00       	jmp    80104d44 <procdump+0xea>
    if(p->state == UNUSED)
80104c6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c6f:	8b 40 0c             	mov    0xc(%eax),%eax
80104c72:	85 c0                	test   %eax,%eax
80104c74:	0f 84 c5 00 00 00    	je     80104d3f <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104c7a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c7d:	8b 40 0c             	mov    0xc(%eax),%eax
80104c80:	83 f8 05             	cmp    $0x5,%eax
80104c83:	77 23                	ja     80104ca8 <procdump+0x4e>
80104c85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c88:	8b 40 0c             	mov    0xc(%eax),%eax
80104c8b:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104c92:	85 c0                	test   %eax,%eax
80104c94:	74 12                	je     80104ca8 <procdump+0x4e>
      state = states[p->state];
80104c96:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c99:	8b 40 0c             	mov    0xc(%eax),%eax
80104c9c:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104ca3:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104ca6:	eb 07                	jmp    80104caf <procdump+0x55>
    else
      state = "???";
80104ca8:	c7 45 ec 3f 87 10 80 	movl   $0x8010873f,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104caf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cb2:	8d 50 6c             	lea    0x6c(%eax),%edx
80104cb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cb8:	8b 40 10             	mov    0x10(%eax),%eax
80104cbb:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104cbf:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104cc2:	89 54 24 08          	mov    %edx,0x8(%esp)
80104cc6:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cca:	c7 04 24 43 87 10 80 	movl   $0x80108743,(%esp)
80104cd1:	e8 cb b6 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104cd6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cd9:	8b 40 0c             	mov    0xc(%eax),%eax
80104cdc:	83 f8 02             	cmp    $0x2,%eax
80104cdf:	75 50                	jne    80104d31 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104ce1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ce4:	8b 40 1c             	mov    0x1c(%eax),%eax
80104ce7:	8b 40 0c             	mov    0xc(%eax),%eax
80104cea:	83 c0 08             	add    $0x8,%eax
80104ced:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104cf0:	89 54 24 04          	mov    %edx,0x4(%esp)
80104cf4:	89 04 24             	mov    %eax,(%esp)
80104cf7:	e8 74 01 00 00       	call   80104e70 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cfc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104d03:	eb 1b                	jmp    80104d20 <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104d05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d08:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d0c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d10:	c7 04 24 4c 87 10 80 	movl   $0x8010874c,(%esp)
80104d17:	e8 85 b6 ff ff       	call   801003a1 <cprintf>
    ...
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104d1c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104d20:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104d24:	7f 0b                	jg     80104d31 <procdump+0xd7>
80104d26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d29:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104d2d:	85 c0                	test   %eax,%eax
80104d2f:	75 d4                	jne    80104d05 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104d31:	c7 04 24 50 87 10 80 	movl   $0x80108750,(%esp)
80104d38:	e8 64 b6 ff ff       	call   801003a1 <cprintf>
80104d3d:	eb 01                	jmp    80104d40 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104d3f:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d40:	83 6d f0 80          	subl   $0xffffff80,-0x10(%ebp)
80104d44:	81 7d f0 54 1f 11 80 	cmpl   $0x80111f54,-0x10(%ebp)
80104d4b:	0f 82 1b ff ff ff    	jb     80104c6c <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104d53 <createInternalProcess>:
...
80104d5f:	9c                   	pushf  
80104d60:	5b                   	pop    %ebx
80104d61:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
80104d64:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104d7d:	83 ec 10             	sub    $0x10,%esp
  uint result;
  
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
               "+m" (*addr), "=a" (result) :
80104d80:	8b 55 08             	mov    0x8(%ebp),%edx
xchg(volatile uint *addr, uint newval)
{
  uint result;
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
80104d83:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80104d86:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104d90:	89 c3                	mov    %eax,%ebx
80104d92:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104d95:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104dc5:	e8 3d 01 00 00       	call   80104f07 <pushcli>
  if(holding(lk))
80104dca:	8b 45 08             	mov    0x8(%ebp),%eax
80104dcd:	89 04 24             	mov    %eax,(%esp)
80104dd0:	e8 08 01 00 00       	call   80104edd <holding>
80104dd5:	85 c0                	test   %eax,%eax
80104dd7:	74 0c                	je     80104de5 <acquire+0x26>
    panic("acquire");
80104dd9:	c7 04 24 7c 87 10 80 	movl   $0x8010877c,(%esp)
...
80104df4:	e8 80 ff ff ff       	call   80104d79 <xchg>
80104df9:	85 c0                	test   %eax,%eax
80104dfb:	75 e9                	jne    80104de6 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104dfd:	8b 45 08             	mov    0x8(%ebp),%eax
80104e00:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104e07:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104e0a:	8b 45 08             	mov    0x8(%ebp),%eax
80104e0d:	83 c0 0c             	add    $0xc,%eax
80104e10:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e14:	8d 45 08             	lea    0x8(%ebp),%eax
80104e17:	89 04 24             	mov    %eax,(%esp)
80104e1a:	e8 51 00 00 00       	call   80104e70 <getcallerpcs>
}
80104e1f:	c9                   	leave  
80104e20:	c3                   	ret    
...
80104e2d:	e8 ab 00 00 00       	call   80104edd <holding>
80104e32:	85 c0                	test   %eax,%eax
80104e34:	75 0c                	jne    80104e42 <release+0x21>
    panic("release");
80104e36:	c7 04 24 84 87 10 80 	movl   $0x80108784,(%esp)
80104e3d:	e8 fb b6 ff ff       	call   8010053d <panic>
...
80104e4f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104e64:	e8 10 ff ff ff       	call   80104d79 <xchg>

  popcli();
80104e69:	e8 e1 00 00 00       	call   80104f4f <popcli>
}
80104e6e:	c9                   	leave  
80104e6f:	c3                   	ret    
...
80104e79:	83 e8 08             	sub    $0x8,%eax
80104e7c:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104e7f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104e86:	eb 32                	jmp    80104eba <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104e88:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104e8c:	74 47                	je     80104ed5 <getcallerpcs+0x65>
80104e8e:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104e95:	76 3e                	jbe    80104ed5 <getcallerpcs+0x65>
80104e97:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104e9b:	74 38                	je     80104ed5 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104e9d:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104ea0:	c1 e0 02             	shl    $0x2,%eax
80104ea3:	03 45 0c             	add    0xc(%ebp),%eax
80104ea6:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104ea9:	8b 52 04             	mov    0x4(%edx),%edx
80104eac:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80104eae:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104eb1:	8b 00                	mov    (%eax),%eax
80104eb3:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104eb6:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104eba:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104ebe:	7e c8                	jle    80104e88 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104ec0:	eb 13                	jmp    80104ed5 <getcallerpcs+0x65>
    pcs[i] = 0;
80104ec2:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104ec5:	c1 e0 02             	shl    $0x2,%eax
80104ec8:	03 45 0c             	add    0xc(%ebp),%eax
80104ecb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  for(; i < 10; i++)
80104ed1:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104ed5:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104ed9:	7e e7                	jle    80104ec2 <getcallerpcs+0x52>
    pcs[i] = 0;
}
80104edb:	c9                   	leave  
80104edc:	c3                   	ret    
...
80104ee7:	74 17                	je     80104f00 <holding+0x23>
80104ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80104eec:	8b 50 08             	mov    0x8(%eax),%edx
80104eef:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ef5:	39 c2                	cmp    %eax,%edx
80104ef7:	75 07                	jne    80104f00 <holding+0x23>
80104ef9:	b8 01 00 00 00       	mov    $0x1,%eax
80104efe:	eb 05                	jmp    80104f05 <holding+0x28>
...
80104f0a:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104f0d:	e8 46 fe ff ff       	call   80104d58 <readeflags>
80104f12:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104f15:	e8 53 fe ff ff       	call   80104d6d <cli>
  if(cpu->ncli++ == 0)
80104f1a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f20:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104f26:	85 d2                	test   %edx,%edx
80104f28:	0f 94 c1             	sete   %cl
80104f2b:	83 c2 01             	add    $0x1,%edx
80104f2e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104f34:	84 c9                	test   %cl,%cl
80104f36:	74 15                	je     80104f4d <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80104f38:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f3e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f41:	81 e2 00 02 00 00    	and    $0x200,%edx
80104f47:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104f4d:	c9                   	leave  
80104f4e:	c3                   	ret    
...
80104f52:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104f55:	e8 fe fd ff ff       	call   80104d58 <readeflags>
80104f5a:	25 00 02 00 00       	and    $0x200,%eax
80104f5f:	85 c0                	test   %eax,%eax
80104f61:	74 0c                	je     80104f6f <popcli+0x20>
    panic("popcli - interruptible");
80104f63:	c7 04 24 8c 87 10 80 	movl   $0x8010878c,(%esp)
80104f6a:	e8 ce b5 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80104f6f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f75:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104f7b:	83 ea 01             	sub    $0x1,%edx
80104f7e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104f84:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104f8a:	85 c0                	test   %eax,%eax
80104f8c:	79 0c                	jns    80104f9a <popcli+0x4b>
    panic("popcli");
80104f8e:	c7 04 24 a3 87 10 80 	movl   $0x801087a3,(%esp)
80104f95:	e8 a3 b5 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104f9a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fa0:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104fa6:	85 c0                	test   %eax,%eax
80104fa8:	75 15                	jne    80104fbf <popcli+0x70>
80104faa:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fb0:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104fb6:	85 c0                	test   %eax,%eax
80104fb8:	74 05                	je     80104fbf <popcli+0x70>
    sti();
80104fba:	e8 b4 fd ff ff       	call   80104d73 <sti>
}
80104fbf:	c9                   	leave  
80104fc0:	c3                   	ret    
80104fc1:	00 00                	add    %al,(%eax)
	...
...
80104fc9:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104fcc:	8b 55 10             	mov    0x10(%ebp),%edx
80104fcf:	8b 45 0c             	mov    0xc(%ebp),%eax
80104fd2:	89 cb                	mov    %ecx,%ebx
80104fd4:	89 df                	mov    %ebx,%edi
80104fd6:	89 d1                	mov    %edx,%ecx
80104fd8:	fc                   	cld    
80104fd9:	f3 aa                	rep stos %al,%es:(%edi)
80104fdb:	89 ca                	mov    %ecx,%edx
80104fdd:	89 fb                	mov    %edi,%ebx
80104fdf:	89 5d 08             	mov    %ebx,0x8(%ebp)
80104fe2:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80104ffd:	fc                   	cld    
80104ffe:	f3 ab                	rep stos %eax,%es:(%edi)
...
8010501c:	75 49                	jne    80105067 <memset+0x59>
8010501e:	8b 45 10             	mov    0x10(%ebp),%eax
80105021:	83 e0 03             	and    $0x3,%eax
80105024:	85 c0                	test   %eax,%eax
80105026:	75 3f                	jne    80105067 <memset+0x59>
    c &= 0xFF;
80105028:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010502f:	8b 45 10             	mov    0x10(%ebp),%eax
80105032:	c1 e8 02             	shr    $0x2,%eax
80105035:	89 c2                	mov    %eax,%edx
80105037:	8b 45 0c             	mov    0xc(%ebp),%eax
8010503a:	89 c1                	mov    %eax,%ecx
8010503c:	c1 e1 18             	shl    $0x18,%ecx
8010503f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105042:	c1 e0 10             	shl    $0x10,%eax
80105045:	09 c1                	or     %eax,%ecx
80105047:	8b 45 0c             	mov    0xc(%ebp),%eax
8010504a:	c1 e0 08             	shl    $0x8,%eax
8010504d:	09 c8                	or     %ecx,%eax
8010504f:	0b 45 0c             	or     0xc(%ebp),%eax
80105052:	89 54 24 08          	mov    %edx,0x8(%esp)
80105056:	89 44 24 04          	mov    %eax,0x4(%esp)
8010505a:	8b 45 08             	mov    0x8(%ebp),%eax
8010505d:	89 04 24             	mov    %eax,(%esp)
80105060:	e8 84 ff ff ff       	call   80104fe9 <stosl>
80105065:	eb 19                	jmp    80105080 <memset+0x72>
  } else
    stosb(dst, c, n);
80105067:	8b 45 10             	mov    0x10(%ebp),%eax
8010506a:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010507b:	e8 44 ff ff ff       	call   80104fc4 <stosb>
  return dst;
...
80105094:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105097:	eb 32                	jmp    801050cb <memcmp+0x46>
    if(*s1 != *s2)
80105099:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010509c:	0f b6 10             	movzbl (%eax),%edx
8010509f:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050a2:	0f b6 00             	movzbl (%eax),%eax
801050a5:	38 c2                	cmp    %al,%dl
801050a7:	74 1a                	je     801050c3 <memcmp+0x3e>
      return *s1 - *s2;
801050a9:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050ac:	0f b6 00             	movzbl (%eax),%eax
801050af:	0f b6 d0             	movzbl %al,%edx
801050b2:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050b5:	0f b6 00             	movzbl (%eax),%eax
801050b8:	0f b6 c0             	movzbl %al,%eax
801050bb:	89 d1                	mov    %edx,%ecx
801050bd:	29 c1                	sub    %eax,%ecx
801050bf:	89 c8                	mov    %ecx,%eax
801050c1:	eb 1c                	jmp    801050df <memcmp+0x5a>
    s1++, s2++;
801050c3:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801050c7:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
801050cb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801050cf:	0f 95 c0             	setne  %al
801050d2:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801050d6:	84 c0                	test   %al,%al
801050d8:	75 bf                	jne    80105099 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801050e4:	83 ec 10             	sub    $0x10,%esp
  const char *s;
  char *d;
...
801050f0:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801050f3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050f6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801050f9:	73 54                	jae    8010514f <memmove+0x6e>
801050fb:	8b 45 10             	mov    0x10(%ebp),%eax
801050fe:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105101:	01 d0                	add    %edx,%eax
80105103:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105106:	76 47                	jbe    8010514f <memmove+0x6e>
    s += n;
80105108:	8b 45 10             	mov    0x10(%ebp),%eax
8010510b:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010510e:	8b 45 10             	mov    0x10(%ebp),%eax
80105111:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105114:	eb 13                	jmp    80105129 <memmove+0x48>
      *--d = *--s;
80105116:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010511a:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010511e:	8b 45 fc             	mov    -0x4(%ebp),%eax
...
8010512d:	0f 95 c0             	setne  %al
80105130:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105134:	84 c0                	test   %al,%al
80105136:	75 de                	jne    80105116 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105138:	eb 25                	jmp    8010515f <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
8010513d:	0f b6 10             	movzbl (%eax),%edx
80105140:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105143:	88 10                	mov    %dl,(%eax)
80105145:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105149:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010514d:	eb 01                	jmp    80105150 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105154:	0f 95 c0             	setne  %al
80105157:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010515b:	84 c0                	test   %al,%al
8010515d:	75 db                	jne    8010513a <memmove+0x59>
      *d++ = *s++;
...
8010517e:	e8 5e ff ff ff       	call   801050e1 <memmove>
}
80105183:	c9                   	leave  
80105184:	c3                   	ret    
...
80105186:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105188:	eb 0c                	jmp    80105196 <strncmp+0x11>
    n--, p++, q++;
8010518a:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010518e:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105192:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801051b2:	38 c2                	cmp    %al,%dl
801051b4:	74 d4                	je     8010518a <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801051b6:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801051ba:	75 07                	jne    801051c3 <strncmp+0x3e>
    return 0;
801051bc:	b8 00 00 00 00       	mov    $0x0,%eax
801051c1:	eb 18                	jmp    801051db <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
801051c3:	8b 45 08             	mov    0x8(%ebp),%eax
801051c6:	0f b6 00             	movzbl (%eax),%eax
801051c9:	0f b6 d0             	movzbl %al,%edx
...
801051e6:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801051e9:	90                   	nop
801051ea:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801051ee:	0f 9f c0             	setg   %al
801051f1:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801051f5:	84 c0                	test   %al,%al
801051f7:	74 30                	je     80105229 <strncpy+0x4c>
...
8010520a:	84 c0                	test   %al,%al
8010520c:	0f 95 c0             	setne  %al
8010520f:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105213:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105217:	84 c0                	test   %al,%al
80105219:	75 cf                	jne    801051ea <strncpy+0xd>
    ;
  while(n-- > 0)
8010521b:	eb 0c                	jmp    80105229 <strncpy+0x4c>
    *s++ = 0;
8010521d:	8b 45 08             	mov    0x8(%ebp),%eax
80105220:	c6 00 00             	movb   $0x0,(%eax)
80105223:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105227:	eb 01                	jmp    8010522a <strncpy+0x4d>
  char *os;
...
8010522e:	0f 9f c0             	setg   %al
80105231:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105235:	84 c0                	test   %al,%al
80105237:	75 e4                	jne    8010521d <strncpy+0x40>
    *s++ = 0;
  return os;
...
8010524e:	7f 05                	jg     80105255 <safestrcpy+0x17>
    return os;
80105250:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105253:	eb 35                	jmp    8010528a <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105255:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105259:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010525d:	7e 22                	jle    80105281 <safestrcpy+0x43>
...
80105272:	0f 95 c0             	setne  %al
80105275:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105279:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010527d:	84 c0                	test   %al,%al
8010527f:	75 d4                	jne    80105255 <safestrcpy+0x17>
    ;
  *s = 0;
...
8010528f:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80105292:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105299:	eb 04                	jmp    8010529f <strlen+0x13>
8010529b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010529f:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052a2:	03 45 08             	add    0x8(%ebp),%eax
801052a5:	0f b6 00             	movzbl (%eax),%eax
801052a8:	84 c0                	test   %al,%al
801052aa:	75 ef                	jne    8010529b <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801052b4:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801052b8:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801052bf:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801052c0:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801052c2:	89 d4                	mov    %edx,%esp
...
801052d4:	3b 45 0c             	cmp    0xc(%ebp),%eax
801052d7:	76 0f                	jbe    801052e8 <fetchint+0x1c>
...
801052e6:	76 07                	jbe    801052ef <fetchint+0x23>
    return -1;
801052e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052ed:	eb 0f                	jmp    801052fe <fetchint+0x32>
  *ip = *(int*)(addr);
801052ef:	8b 45 0c             	mov    0xc(%ebp),%eax
801052f2:	8b 10                	mov    (%eax),%edx
801052f4:	8b 45 10             	mov    0x10(%ebp),%eax
801052f7:	89 10                	mov    %edx,(%eax)
  return 0;
...
8010530b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010530e:	77 07                	ja     80105317 <fetchstr+0x17>
    return -1;
80105310:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105315:	eb 45                	jmp    8010535c <fetchstr+0x5c>
  *pp = (char*)addr;
80105317:	8b 55 0c             	mov    0xc(%ebp),%edx
8010531a:	8b 45 10             	mov    0x10(%ebp),%eax
8010531d:	89 10                	mov    %edx,(%eax)
  ep = (char*)p->sz;
...
80105349:	eb 11                	jmp    8010535c <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
8010534b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010534f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105352:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105355:	72 da                	jb     80105331 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010536d:	8b 50 44             	mov    0x44(%eax),%edx
80105370:	8b 45 08             	mov    0x8(%ebp),%eax
80105373:	c1 e0 02             	shl    $0x2,%eax
80105376:	01 d0                	add    %edx,%eax
80105378:	8d 48 04             	lea    0x4(%eax),%ecx
8010537b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105381:	8b 55 0c             	mov    0xc(%ebp),%edx
80105384:	89 54 24 08          	mov    %edx,0x8(%esp)
80105388:	89 4c 24 04          	mov    %ecx,0x4(%esp)
8010538c:	89 04 24             	mov    %eax,(%esp)
8010538f:	e8 38 ff ff ff       	call   801052cc <fetchint>
}
80105394:	c9                   	leave  
80105395:	c3                   	ret    
...
8010543f:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105442:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105448:	8b 40 18             	mov    0x18(%eax),%eax
8010544b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010544e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
80105451:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105455:	78 2e                	js     80105485 <syscall+0x4a>
80105457:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
8010545b:	7f 28                	jg     80105485 <syscall+0x4a>
8010545d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105460:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105467:	85 c0                	test   %eax,%eax
80105469:	74 1a                	je     80105485 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
8010546b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105471:	8b 58 18             	mov    0x18(%eax),%ebx
80105474:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105477:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010547e:	ff d0                	call   *%eax
80105480:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105483:	eb 73                	jmp    801054f8 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105485:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105489:	7e 30                	jle    801054bb <syscall+0x80>
8010548b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010548e:	83 f8 15             	cmp    $0x15,%eax
80105491:	77 28                	ja     801054bb <syscall+0x80>
80105493:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105496:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010549d:	85 c0                	test   %eax,%eax
8010549f:	74 1a                	je     801054bb <syscall+0x80>
    proc->tf->eax = syscalls[num]();
801054a1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054a7:	8b 58 18             	mov    0x18(%eax),%ebx
801054aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054ad:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801054b4:	ff d0                	call   *%eax
801054b6:	89 43 1c             	mov    %eax,0x1c(%ebx)
801054b9:	eb 3d                	jmp    801054f8 <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801054bb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054c1:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
801054cd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801054d0:	89 54 24 0c          	mov    %edx,0xc(%esp)
801054d4:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801054d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801054dc:	c7 04 24 aa 87 10 80 	movl   $0x801087aa,(%esp)
801054e3:	e8 b9 ae ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801054e8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054ee:	8b 40 18             	mov    0x18(%eax),%eax
801054f1:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80105513:	e8 46 fe ff ff       	call   8010535e <argint>
80105518:	85 c0                	test   %eax,%eax
8010551a:	79 07                	jns    80105523 <argfd+0x23>
    return -1;
8010551c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105521:	eb 50                	jmp    80105573 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105523:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105526:	85 c0                	test   %eax,%eax
80105528:	78 21                	js     8010554b <argfd+0x4b>
8010552a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010552d:	83 f8 0f             	cmp    $0xf,%eax
80105530:	7f 19                	jg     8010554b <argfd+0x4b>
80105532:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105538:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010553b:	83 c2 08             	add    $0x8,%edx
8010553e:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105542:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105545:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105549:	75 07                	jne    80105552 <argfd+0x52>
    return -1;
8010554b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105550:	eb 21                	jmp    80105573 <argfd+0x73>
  if(pfd)
80105552:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105556:	74 08                	je     80105560 <argfd+0x60>
    *pfd = fd;
80105558:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010555b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010555e:	89 10                	mov    %edx,(%eax)
  if(pf)
80105560:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105564:	74 08                	je     8010556e <argfd+0x6e>
    *pf = f;
...
80105578:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010557b:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105582:	eb 30                	jmp    801055b4 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105584:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010558a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010558d:	83 c2 08             	add    $0x8,%edx
80105590:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105594:	85 c0                	test   %eax,%eax
80105596:	75 18                	jne    801055b0 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105598:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010559e:	8b 55 fc             	mov    -0x4(%ebp),%edx
801055a1:	8d 4a 08             	lea    0x8(%edx),%ecx
801055a4:	8b 55 08             	mov    0x8(%ebp),%edx
801055a7:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801055ab:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055ae:	eb 0f                	jmp    801055bf <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
801055b0:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055b4:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801055b8:	7e ca                	jle    80105584 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801055dd:	e8 1e ff ff ff       	call   80105500 <argfd>
801055e2:	85 c0                	test   %eax,%eax
801055e4:	79 07                	jns    801055ed <sys_dup+0x2c>
    return -1;
801055e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055eb:	eb 29                	jmp    80105616 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801055ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055f0:	89 04 24             	mov    %eax,(%esp)
801055f3:	e8 7d ff ff ff       	call   80105575 <fdalloc>
801055f8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801055fb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801055ff:	79 07                	jns    80105608 <sys_dup+0x47>
    return -1;
80105601:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105606:	eb 0e                	jmp    80105616 <sys_dup+0x55>
  filedup(f);
80105608:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010560b:	89 04 24             	mov    %eax,(%esp)
8010560e:	e8 69 b9 ff ff       	call   80100f7c <filedup>
  return fd;
...
80105634:	e8 c7 fe ff ff       	call   80105500 <argfd>
80105639:	85 c0                	test   %eax,%eax
8010563b:	78 35                	js     80105672 <sys_read+0x5a>
8010563d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105640:	89 44 24 04          	mov    %eax,0x4(%esp)
80105644:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010564b:	e8 0e fd ff ff       	call   8010535e <argint>
80105650:	85 c0                	test   %eax,%eax
80105652:	78 1e                	js     80105672 <sys_read+0x5a>
...
80105669:	e8 28 fd ff ff       	call   80105396 <argptr>
8010566e:	85 c0                	test   %eax,%eax
80105670:	79 07                	jns    80105679 <sys_read+0x61>
    return -1;
80105672:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105677:	eb 19                	jmp    80105692 <sys_read+0x7a>
...
8010568d:	e8 57 ba ff ff       	call   801010e9 <fileread>
}
80105692:	c9                   	leave  
80105693:	c3                   	ret    
...
801056a1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801056a8:	00 
801056a9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056b0:	e8 4b fe ff ff       	call   80105500 <argfd>
801056b5:	85 c0                	test   %eax,%eax
801056b7:	78 35                	js     801056ee <sys_write+0x5a>
801056b9:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801056c0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801056c7:	e8 92 fc ff ff       	call   8010535e <argint>
801056cc:	85 c0                	test   %eax,%eax
801056ce:	78 1e                	js     801056ee <sys_write+0x5a>
...
801056de:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801056e5:	e8 ac fc ff ff       	call   80105396 <argptr>
801056ea:	85 c0                	test   %eax,%eax
801056ec:	79 07                	jns    801056f5 <sys_write+0x61>
    return -1;
801056ee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056f3:	eb 19                	jmp    8010570e <sys_write+0x7a>
  return filewrite(f, p, n);
801056f5:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801056f8:	8b 55 ec             	mov    -0x14(%ebp),%edx
801056fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056fe:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105702:	89 54 24 04          	mov    %edx,0x4(%esp)
80105706:	89 04 24             	mov    %eax,(%esp)
80105709:	e8 97 ba ff ff       	call   801011a5 <filewrite>
}
8010570e:	c9                   	leave  
8010570f:	c3                   	ret    
...
80105724:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010572b:	e8 d0 fd ff ff       	call   80105500 <argfd>
80105730:	85 c0                	test   %eax,%eax
80105732:	79 07                	jns    8010573b <sys_close+0x2b>
    return -1;
80105734:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105739:	eb 24                	jmp    8010575f <sys_close+0x4f>
  proc->ofile[fd] = 0;
8010573b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105741:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105744:	83 c2 08             	add    $0x8,%edx
80105747:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010574e:	00 
  fileclose(f);
8010574f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105752:	89 04 24             	mov    %eax,(%esp)
80105755:	e8 6a b8 ff ff       	call   80100fc4 <fileclose>
  return 0;
...
8010576e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105775:	00 
80105776:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010577d:	e8 7e fd ff ff       	call   80105500 <argfd>
80105782:	85 c0                	test   %eax,%eax
80105784:	78 1f                	js     801057a5 <sys_fstat+0x44>
80105786:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010578d:	00 
8010578e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105791:	89 44 24 04          	mov    %eax,0x4(%esp)
80105795:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010579c:	e8 f5 fb ff ff       	call   80105396 <argptr>
801057a1:	85 c0                	test   %eax,%eax
801057a3:	79 07                	jns    801057ac <sys_fstat+0x4b>
    return -1;
801057a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057aa:	eb 12                	jmp    801057be <sys_fstat+0x5d>
  return filestat(f, st);
801057ac:	8b 55 f0             	mov    -0x10(%ebp),%edx
801057af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057b2:	89 54 24 04          	mov    %edx,0x4(%esp)
801057b6:	89 04 24             	mov    %eax,(%esp)
801057b9:	e8 dc b8 ff ff       	call   8010109a <filestat>
}
801057be:	c9                   	leave  
801057bf:	c3                   	ret    
...
801057c6:	8d 45 d8             	lea    -0x28(%ebp),%eax
801057c9:	89 44 24 04          	mov    %eax,0x4(%esp)
801057cd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057d4:	e8 1f fc ff ff       	call   801053f8 <argstr>
801057d9:	85 c0                	test   %eax,%eax
801057db:	78 17                	js     801057f4 <sys_link+0x34>
801057dd:	8d 45 dc             	lea    -0x24(%ebp),%eax
801057e0:	89 44 24 04          	mov    %eax,0x4(%esp)
801057e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057eb:	e8 08 fc ff ff       	call   801053f8 <argstr>
801057f0:	85 c0                	test   %eax,%eax
801057f2:	79 0a                	jns    801057fe <sys_link+0x3e>
    return -1;
801057f4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057f9:	e9 3c 01 00 00       	jmp    8010593a <sys_link+0x17a>
  if((ip = namei(old)) == 0)
801057fe:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105801:	89 04 24             	mov    %eax,(%esp)
80105804:	e8 01 cc ff ff       	call   8010240a <namei>
80105809:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010580c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105810:	75 0a                	jne    8010581c <sys_link+0x5c>
    return -1;
80105812:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105817:	e9 1e 01 00 00       	jmp    8010593a <sys_link+0x17a>

  begin_trans();
8010581c:	e8 fc d9 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
80105821:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105824:	89 04 24             	mov    %eax,(%esp)
80105827:	e8 3c c0 ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
8010582c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010582f:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105833:	66 83 f8 01          	cmp    $0x1,%ax
80105837:	75 1a                	jne    80105853 <sys_link+0x93>
    iunlockput(ip);
80105839:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010583c:	89 04 24             	mov    %eax,(%esp)
8010583f:	e8 a8 c2 ff ff       	call   80101aec <iunlockput>
    commit_trans();
80105844:	e8 1d da ff ff       	call   80103266 <commit_trans>
    return -1;
80105849:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010584e:	e9 e7 00 00 00       	jmp    8010593a <sys_link+0x17a>
  }

  ip->nlink++;
80105853:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105856:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010585a:	8d 50 01             	lea    0x1(%eax),%edx
8010585d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105860:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105864:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105867:	89 04 24             	mov    %eax,(%esp)
8010586a:	e8 3d be ff ff       	call   801016ac <iupdate>
  iunlock(ip);
8010586f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105872:	89 04 24             	mov    %eax,(%esp)
80105875:	e8 3c c1 ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010587a:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010587d:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105880:	89 54 24 04          	mov    %edx,0x4(%esp)
80105884:	89 04 24             	mov    %eax,(%esp)
80105887:	e8 a0 cb ff ff       	call   8010242c <nameiparent>
8010588c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010588f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105893:	74 68                	je     801058fd <sys_link+0x13d>
    goto bad;
  ilock(dp);
80105895:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105898:	89 04 24             	mov    %eax,(%esp)
8010589b:	e8 c8 bf ff ff       	call   80101868 <ilock>
...
801058aa:	39 c2                	cmp    %eax,%edx
801058ac:	75 20                	jne    801058ce <sys_link+0x10e>
801058ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b1:	8b 40 04             	mov    0x4(%eax),%eax
801058b4:	89 44 24 08          	mov    %eax,0x8(%esp)
801058b8:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801058bb:	89 44 24 04          	mov    %eax,0x4(%esp)
801058bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058c2:	89 04 24             	mov    %eax,(%esp)
801058c5:	e8 7f c8 ff ff       	call   80102149 <dirlink>
801058ca:	85 c0                	test   %eax,%eax
801058cc:	79 0d                	jns    801058db <sys_link+0x11b>
    iunlockput(dp);
801058ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058d1:	89 04 24             	mov    %eax,(%esp)
801058d4:	e8 13 c2 ff ff       	call   80101aec <iunlockput>
    goto bad;
801058d9:	eb 23                	jmp    801058fe <sys_link+0x13e>
  }
  iunlockput(dp);
801058db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058de:	89 04 24             	mov    %eax,(%esp)
801058e1:	e8 06 c2 ff ff       	call   80101aec <iunlockput>
  iput(ip);
801058e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058e9:	89 04 24             	mov    %eax,(%esp)
801058ec:	e8 2a c1 ff ff       	call   80101a1b <iput>

  commit_trans();
801058f1:	e8 70 d9 ff ff       	call   80103266 <commit_trans>

  return 0;
801058f6:	b8 00 00 00 00       	mov    $0x0,%eax
801058fb:	eb 3d                	jmp    8010593a <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105904:	e8 5f bf ff ff       	call   80101868 <ilock>
  ip->nlink--;
...
80105916:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010591a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010591d:	89 04 24             	mov    %eax,(%esp)
80105920:	e8 87 bd ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105925:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105928:	89 04 24             	mov    %eax,(%esp)
8010592b:	e8 bc c1 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105930:	e8 31 d9 ff ff       	call   80103266 <commit_trans>
  return -1;
...
8010593f:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105942:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105949:	eb 4b                	jmp    80105996 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010594b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010594e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105955:	00 
80105956:	89 44 24 08          	mov    %eax,0x8(%esp)
8010595a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010595d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105961:	8b 45 08             	mov    0x8(%ebp),%eax
80105964:	89 04 24             	mov    %eax,(%esp)
80105967:	e8 f2 c3 ff ff       	call   80101d5e <readi>
8010596c:	83 f8 10             	cmp    $0x10,%eax
8010596f:	74 0c                	je     8010597d <isdirempty+0x41>
      panic("isdirempty: readi");
80105971:	c7 04 24 c6 87 10 80 	movl   $0x801087c6,(%esp)
80105978:	e8 c0 ab ff ff       	call   8010053d <panic>
    if(de.inum != 0)
8010597d:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105981:	66 85 c0             	test   %ax,%ax
80105984:	74 07                	je     8010598d <isdirempty+0x51>
      return 0;
80105986:	b8 00 00 00 00       	mov    $0x0,%eax
8010598b:	eb 1b                	jmp    801059a8 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801059ad:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801059b0:	8d 45 cc             	lea    -0x34(%ebp),%eax
801059b3:	89 44 24 04          	mov    %eax,0x4(%esp)
801059b7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059be:	e8 35 fa ff ff       	call   801053f8 <argstr>
801059c3:	85 c0                	test   %eax,%eax
801059c5:	79 0a                	jns    801059d1 <sys_unlink+0x27>
    return -1;
801059c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059cc:	e9 aa 01 00 00       	jmp    80105b7b <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
801059d1:	8b 45 cc             	mov    -0x34(%ebp),%eax
801059d4:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801059d7:	89 54 24 04          	mov    %edx,0x4(%esp)
801059db:	89 04 24             	mov    %eax,(%esp)
801059de:	e8 49 ca ff ff       	call   8010242c <nameiparent>
801059e3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059e6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801059ea:	75 0a                	jne    801059f6 <sys_unlink+0x4c>
    return -1;
801059ec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059f1:	e9 85 01 00 00       	jmp    80105b7b <sys_unlink+0x1d1>

  begin_trans();
801059f6:	e8 22 d8 ff ff       	call   8010321d <begin_trans>

  ilock(dp);
801059fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059fe:	89 04 24             	mov    %eax,(%esp)
80105a01:	e8 62 be ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a06:	c7 44 24 04 d8 87 10 	movl   $0x801087d8,0x4(%esp)
80105a0d:	80 
80105a0e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a11:	89 04 24             	mov    %eax,(%esp)
80105a14:	e8 46 c6 ff ff       	call   8010205f <namecmp>
80105a19:	85 c0                	test   %eax,%eax
80105a1b:	0f 84 45 01 00 00    	je     80105b66 <sys_unlink+0x1bc>
80105a21:	c7 44 24 04 da 87 10 	movl   $0x801087da,0x4(%esp)
80105a28:	80 
80105a29:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a2c:	89 04 24             	mov    %eax,(%esp)
80105a2f:	e8 2b c6 ff ff       	call   8010205f <namecmp>
80105a34:	85 c0                	test   %eax,%eax
80105a36:	0f 84 2a 01 00 00    	je     80105b66 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105a3c:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105a50:	e8 2c c6 ff ff       	call   80102081 <dirlookup>
80105a55:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105a58:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105a5c:	0f 84 03 01 00 00    	je     80105b65 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105a62:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a65:	89 04 24             	mov    %eax,(%esp)
80105a68:	e8 fb bd ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80105a6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a70:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105a74:	66 85 c0             	test   %ax,%ax
80105a77:	7f 0c                	jg     80105a85 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105a79:	c7 04 24 dd 87 10 80 	movl   $0x801087dd,(%esp)
80105a80:	e8 b8 aa ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105a85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a88:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105a8c:	66 83 f8 01          	cmp    $0x1,%ax
80105a90:	75 1f                	jne    80105ab1 <sys_unlink+0x107>
80105a92:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a95:	89 04 24             	mov    %eax,(%esp)
80105a98:	e8 9f fe ff ff       	call   8010593c <isdirempty>
80105a9d:	85 c0                	test   %eax,%eax
80105a9f:	75 10                	jne    80105ab1 <sys_unlink+0x107>
    iunlockput(ip);
80105aa1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aa4:	89 04 24             	mov    %eax,(%esp)
80105aa7:	e8 40 c0 ff ff       	call   80101aec <iunlockput>
    goto bad;
80105aac:	e9 b5 00 00 00       	jmp    80105b66 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105ab1:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105ab8:	00 
80105ab9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ac0:	00 
80105ac1:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105ac4:	89 04 24             	mov    %eax,(%esp)
80105ac7:	e8 42 f5 ff ff       	call   8010500e <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105acc:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105acf:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ad6:	00 
80105ad7:	89 44 24 08          	mov    %eax,0x8(%esp)
80105adb:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105ade:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ae2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ae5:	89 04 24             	mov    %eax,(%esp)
80105ae8:	e8 dc c3 ff ff       	call   80101ec9 <writei>
80105aed:	83 f8 10             	cmp    $0x10,%eax
80105af0:	74 0c                	je     80105afe <sys_unlink+0x154>
    panic("unlink: writei");
80105af2:	c7 04 24 ef 87 10 80 	movl   $0x801087ef,(%esp)
80105af9:	e8 3f aa ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105afe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b01:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b05:	66 83 f8 01          	cmp    $0x1,%ax
80105b09:	75 1c                	jne    80105b27 <sys_unlink+0x17d>
    dp->nlink--;
80105b0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b0e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b12:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105b22:	e8 85 bb ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
80105b27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b2a:	89 04 24             	mov    %eax,(%esp)
80105b2d:	e8 ba bf ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
80105b32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b35:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b39:	8d 50 ff             	lea    -0x1(%eax),%edx
80105b3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3f:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105b43:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b46:	89 04 24             	mov    %eax,(%esp)
80105b49:	e8 5e bb ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105b4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b51:	89 04 24             	mov    %eax,(%esp)
80105b54:	e8 93 bf ff ff       	call   80101aec <iunlockput>

  commit_trans();
80105b59:	e8 08 d7 ff ff       	call   80103266 <commit_trans>

  return 0;
80105b5e:	b8 00 00 00 00       	mov    $0x0,%eax
80105b63:	eb 16                	jmp    80105b7b <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105b6c:	e8 7b bf ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105b71:	e8 f0 d6 ff ff       	call   80103266 <commit_trans>
  return -1;
...
80105b80:	83 ec 48             	sub    $0x48,%esp
80105b83:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105b86:	8b 55 10             	mov    0x10(%ebp),%edx
80105b89:	8b 45 14             	mov    0x14(%ebp),%eax
80105b8c:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105b90:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105b94:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105b98:	8d 45 de             	lea    -0x22(%ebp),%eax
80105b9b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b9f:	8b 45 08             	mov    0x8(%ebp),%eax
80105ba2:	89 04 24             	mov    %eax,(%esp)
80105ba5:	e8 82 c8 ff ff       	call   8010242c <nameiparent>
80105baa:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bad:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bb1:	75 0a                	jne    80105bbd <create+0x40>
    return 0;
80105bb3:	b8 00 00 00 00       	mov    $0x0,%eax
80105bb8:	e9 7e 01 00 00       	jmp    80105d3b <create+0x1be>
  ilock(dp);
80105bbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bc0:	89 04 24             	mov    %eax,(%esp)
80105bc3:	e8 a0 bc ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105bc8:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105bcb:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bcf:	8d 45 de             	lea    -0x22(%ebp),%eax
80105bd2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bd6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bd9:	89 04 24             	mov    %eax,(%esp)
80105bdc:	e8 a0 c4 ff ff       	call   80102081 <dirlookup>
80105be1:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105be4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105be8:	74 47                	je     80105c31 <create+0xb4>
    iunlockput(dp);
80105bea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bed:	89 04 24             	mov    %eax,(%esp)
80105bf0:	e8 f7 be ff ff       	call   80101aec <iunlockput>
    ilock(ip);
80105bf5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bf8:	89 04 24             	mov    %eax,(%esp)
80105bfb:	e8 68 bc ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c00:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c05:	75 15                	jne    80105c1c <create+0x9f>
80105c07:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c0a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c0e:	66 83 f8 02          	cmp    $0x2,%ax
80105c12:	75 08                	jne    80105c1c <create+0x9f>
      return ip;
80105c14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c17:	e9 1f 01 00 00       	jmp    80105d3b <create+0x1be>
    iunlockput(ip);
80105c1c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c1f:	89 04 24             	mov    %eax,(%esp)
80105c22:	e8 c5 be ff ff       	call   80101aec <iunlockput>
    return 0;
80105c27:	b8 00 00 00 00       	mov    $0x0,%eax
80105c2c:	e9 0a 01 00 00       	jmp    80105d3b <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105c31:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105c35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c38:	8b 00                	mov    (%eax),%eax
80105c3a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c3e:	89 04 24             	mov    %eax,(%esp)
80105c41:	e8 89 b9 ff ff       	call   801015cf <ialloc>
80105c46:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c49:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c4d:	75 0c                	jne    80105c5b <create+0xde>
    panic("create: ialloc");
80105c4f:	c7 04 24 fe 87 10 80 	movl   $0x801087fe,(%esp)
80105c56:	e8 e2 a8 ff ff       	call   8010053d <panic>

  ilock(ip);
80105c5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c5e:	89 04 24             	mov    %eax,(%esp)
80105c61:	e8 02 bc ff ff       	call   80101868 <ilock>
  ip->major = major;
...
80105c8b:	e8 1c ba ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105c90:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105c95:	75 6a                	jne    80105d01 <create+0x184>
    dp->nlink++;  // for ".."
80105c97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c9a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c9e:	8d 50 01             	lea    0x1(%eax),%edx
80105ca1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ca4:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105ca8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cab:	89 04 24             	mov    %eax,(%esp)
80105cae:	e8 f9 b9 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105cb3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cb6:	8b 40 04             	mov    0x4(%eax),%eax
80105cb9:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cbd:	c7 44 24 04 d8 87 10 	movl   $0x801087d8,0x4(%esp)
80105cc4:	80 
80105cc5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cc8:	89 04 24             	mov    %eax,(%esp)
80105ccb:	e8 79 c4 ff ff       	call   80102149 <dirlink>
80105cd0:	85 c0                	test   %eax,%eax
80105cd2:	78 21                	js     80105cf5 <create+0x178>
80105cd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd7:	8b 40 04             	mov    0x4(%eax),%eax
80105cda:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cde:	c7 44 24 04 da 87 10 	movl   $0x801087da,0x4(%esp)
80105ce5:	80 
...
80105cf3:	79 0c                	jns    80105d01 <create+0x184>
      panic("create dots");
80105cf5:	c7 04 24 0d 88 10 80 	movl   $0x8010880d,(%esp)
80105cfc:	e8 3c a8 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105d01:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d04:	8b 40 04             	mov    0x4(%eax),%eax
80105d07:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d0b:	8d 45 de             	lea    -0x22(%ebp),%eax
80105d0e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d15:	89 04 24             	mov    %eax,(%esp)
80105d18:	e8 2c c4 ff ff       	call   80102149 <dirlink>
80105d1d:	85 c0                	test   %eax,%eax
80105d1f:	79 0c                	jns    80105d2d <create+0x1b0>
    panic("create: dirlink");
80105d21:	c7 04 24 19 88 10 80 	movl   $0x80108819,(%esp)
80105d28:	e8 10 a8 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80105d2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d30:	89 04 24             	mov    %eax,(%esp)
80105d33:	e8 b4 bd ff ff       	call   80101aec <iunlockput>
...
80105d40:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105d4a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d51:	e8 a2 f6 ff ff       	call   801053f8 <argstr>
80105d56:	85 c0                	test   %eax,%eax
80105d58:	78 17                	js     80105d71 <sys_open+0x34>
80105d5a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105d5d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d68:	e8 f1 f5 ff ff       	call   8010535e <argint>
80105d6d:	85 c0                	test   %eax,%eax
80105d6f:	79 0a                	jns    80105d7b <sys_open+0x3e>
    return -1;
80105d71:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d76:	e9 46 01 00 00       	jmp    80105ec1 <sys_open+0x184>
  if(omode & O_CREATE){
80105d7b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d7e:	25 00 02 00 00       	and    $0x200,%eax
80105d83:	85 c0                	test   %eax,%eax
80105d85:	74 40                	je     80105dc7 <sys_open+0x8a>
    begin_trans();
80105d87:	e8 91 d4 ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105d8c:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105d8f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105d96:	00 
80105d97:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105d9e:	00 
80105d9f:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105da6:	00 
80105da7:	89 04 24             	mov    %eax,(%esp)
80105daa:	e8 ce fd ff ff       	call   80105b7d <create>
80105daf:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105db2:	e8 af d4 ff ff       	call   80103266 <commit_trans>
    if(ip == 0)
80105db7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105dbb:	75 5c                	jne    80105e19 <sys_open+0xdc>
      return -1;
80105dbd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dc2:	e9 fa 00 00 00       	jmp    80105ec1 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
80105dc7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105dca:	89 04 24             	mov    %eax,(%esp)
80105dcd:	e8 38 c6 ff ff       	call   8010240a <namei>
80105dd2:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105dd5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105dd9:	75 0a                	jne    80105de5 <sys_open+0xa8>
      return -1;
80105ddb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105de0:	e9 dc 00 00 00       	jmp    80105ec1 <sys_open+0x184>
    ilock(ip);
80105de5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105de8:	89 04 24             	mov    %eax,(%esp)
80105deb:	e8 78 ba ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105df0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105df3:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105df7:	66 83 f8 01          	cmp    $0x1,%ax
80105dfb:	75 1c                	jne    80105e19 <sys_open+0xdc>
80105dfd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e00:	85 c0                	test   %eax,%eax
80105e02:	74 15                	je     80105e19 <sys_open+0xdc>
      iunlockput(ip);
80105e04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e07:	89 04 24             	mov    %eax,(%esp)
80105e0a:	e8 dd bc ff ff       	call   80101aec <iunlockput>
      return -1;
80105e0f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e14:	e9 a8 00 00 00       	jmp    80105ec1 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105e19:	e8 fe b0 ff ff       	call   80100f1c <filealloc>
80105e1e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e21:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e25:	74 14                	je     80105e3b <sys_open+0xfe>
80105e27:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e2a:	89 04 24             	mov    %eax,(%esp)
80105e2d:	e8 43 f7 ff ff       	call   80105575 <fdalloc>
80105e32:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105e35:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105e39:	79 23                	jns    80105e5e <sys_open+0x121>
    if(f)
80105e3b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e3f:	74 0b                	je     80105e4c <sys_open+0x10f>
      fileclose(f);
80105e41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e44:	89 04 24             	mov    %eax,(%esp)
80105e47:	e8 78 b1 ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
80105e4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e4f:	89 04 24             	mov    %eax,(%esp)
80105e52:	e8 95 bc ff ff       	call   80101aec <iunlockput>
    return -1;
80105e57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e5c:	eb 63                	jmp    80105ec1 <sys_open+0x184>
  }
  iunlock(ip);
80105e5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e61:	89 04 24             	mov    %eax,(%esp)
80105e64:	e8 4d bb ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
80105e69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e6c:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105e72:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e75:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e78:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105e7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e7e:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105e85:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e88:	83 e0 01             	and    $0x1,%eax
80105e8b:	85 c0                	test   %eax,%eax
80105e8d:	0f 94 c2             	sete   %dl
...
80105e9c:	84 c0                	test   %al,%al
80105e9e:	75 0a                	jne    80105eaa <sys_open+0x16d>
80105ea0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ea3:	83 e0 02             	and    $0x2,%eax
80105ea6:	85 c0                	test   %eax,%eax
80105ea8:	74 07                	je     80105eb1 <sys_open+0x174>
80105eaa:	b8 01 00 00 00       	mov    $0x1,%eax
80105eaf:	eb 05                	jmp    80105eb6 <sys_open+0x179>
...
80105ec6:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105ec9:	e8 4f d3 ff ff       	call   8010321d <begin_trans>
...
80105edc:	e8 17 f5 ff ff       	call   801053f8 <argstr>
...
80105f23:	e8 c4 bb ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105f28:	e8 39 d3 ff ff       	call   80103266 <commit_trans>
  return 0;
...
80105f69:	e8 f0 f3 ff ff       	call   8010535e <argint>
  char *path;
  int len;
  int major, minor;
...
80105f80:	e8 d9 f3 ff ff       	call   8010535e <argint>
  int len;
  int major, minor;
...
80105fcb:	e8 1c bb ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105fd0:	e8 91 d2 ff ff       	call   80103266 <commit_trans>
  return 0;
...
80106070:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106084:	e8 6f f3 ff ff       	call   801053f8 <argstr>
80106089:	85 c0                	test   %eax,%eax
8010608b:	78 1a                	js     801060a7 <sys_exec+0x3a>
8010608d:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106093:	89 44 24 04          	mov    %eax,0x4(%esp)
80106097:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010609e:	e8 bb f2 ff ff       	call   8010535e <argint>
801060a3:	85 c0                	test   %eax,%eax
801060a5:	79 0a                	jns    801060b1 <sys_exec+0x44>
    return -1;
801060a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060ac:	e9 e2 00 00 00       	jmp    80106193 <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
801060b1:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801060b8:	00 
801060b9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801060c0:	00 
801060c1:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801060c7:	89 04 24             	mov    %eax,(%esp)
801060ca:	e8 3f ef ff ff       	call   8010500e <memset>
  for(i=0;; i++){
801060cf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801060d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060d9:	83 f8 1f             	cmp    $0x1f,%eax
801060dc:	76 0a                	jbe    801060e8 <sys_exec+0x7b>
      return -1;
801060de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060e3:	e9 ab 00 00 00       	jmp    80106193 <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
801060e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060eb:	c1 e0 02             	shl    $0x2,%eax
801060ee:	89 c2                	mov    %eax,%edx
801060f0:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801060f6:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
801060f9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801060ff:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
80106105:	89 54 24 08          	mov    %edx,0x8(%esp)
80106109:	89 4c 24 04          	mov    %ecx,0x4(%esp)
8010610d:	89 04 24             	mov    %eax,(%esp)
80106110:	e8 b7 f1 ff ff       	call   801052cc <fetchint>
80106115:	85 c0                	test   %eax,%eax
80106117:	79 07                	jns    80106120 <sys_exec+0xb3>
      return -1;
80106119:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010611e:	eb 73                	jmp    80106193 <sys_exec+0x126>
    if(uarg == 0){
80106120:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106126:	85 c0                	test   %eax,%eax
80106128:	75 26                	jne    80106150 <sys_exec+0xe3>
      argv[i] = 0;
...
80106149:	e8 ae a9 ff ff       	call   80100afc <exec>
8010614e:	eb 43                	jmp    80106193 <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106153:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010615a:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106160:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
80106163:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80106169:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010616f:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106173:	89 54 24 04          	mov    %edx,0x4(%esp)
80106177:	89 04 24             	mov    %eax,(%esp)
8010617a:	e8 81 f1 ff ff       	call   80105300 <fetchstr>
8010617f:	85 c0                	test   %eax,%eax
80106181:	79 07                	jns    8010618a <sys_exec+0x11d>
      return -1;
80106183:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106188:	eb 09                	jmp    80106193 <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
8010618a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
8010618e:	e9 43 ff ff ff       	jmp    801060d6 <sys_exec+0x69>
  return exec(path, argv);
}
80106193:	c9                   	leave  
80106194:	c3                   	ret    
...
80106198:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010619b:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801061a2:	00 
801061a3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061a6:	89 44 24 04          	mov    %eax,0x4(%esp)
801061aa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061b1:	e8 e0 f1 ff ff       	call   80105396 <argptr>
801061b6:	85 c0                	test   %eax,%eax
801061b8:	79 0a                	jns    801061c4 <sys_pipe+0x2f>
    return -1;
801061ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061bf:	e9 9b 00 00 00       	jmp    8010625f <sys_pipe+0xca>
...
801061d1:	e8 62 da ff ff       	call   80103c38 <pipealloc>
801061d6:	85 c0                	test   %eax,%eax
801061d8:	79 07                	jns    801061e1 <sys_pipe+0x4c>
    return -1;
801061da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061df:	eb 7e                	jmp    8010625f <sys_pipe+0xca>
  fd0 = -1;
801061e1:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801061e8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801061eb:	89 04 24             	mov    %eax,(%esp)
801061ee:	e8 82 f3 ff ff       	call   80105575 <fdalloc>
801061f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801061f6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801061fa:	78 14                	js     80106210 <sys_pipe+0x7b>
801061fc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061ff:	89 04 24             	mov    %eax,(%esp)
80106202:	e8 6e f3 ff ff       	call   80105575 <fdalloc>
80106207:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010620a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010620e:	79 37                	jns    80106247 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106210:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106214:	78 14                	js     8010622a <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106216:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010621c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010621f:	83 c2 08             	add    $0x8,%edx
80106222:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106229:	00 
    fileclose(rf);
8010622a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010622d:	89 04 24             	mov    %eax,(%esp)
80106230:	e8 8f ad ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
80106235:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106238:	89 04 24             	mov    %eax,(%esp)
8010623b:	e8 84 ad ff ff       	call   80100fc4 <fileclose>
    return -1;
80106240:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106245:	eb 18                	jmp    8010625f <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106247:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010624a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010624d:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010624f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106252:	8d 50 04             	lea    0x4(%eax),%edx
80106255:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106258:	89 02                	mov    %eax,(%edx)
  return 0;
8010625a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010625f:	c9                   	leave  
80106260:	c3                   	ret    
80106261:	00 00                	add    %al,(%eax)
	...
...
80106267:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010626a:	e8 83 e0 ff ff       	call   801042f2 <fork>
}
8010626f:	c9                   	leave  
80106270:	c3                   	ret    
...
80106274:	83 ec 08             	sub    $0x8,%esp
  exit();
80106277:	e8 f2 e3 ff ff       	call   8010466e <exit>
...
80106286:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106289:	e8 f8 e4 ff ff       	call   80104786 <wait>
}
8010628e:	c9                   	leave  
8010628f:	c3                   	ret    
...
801062a4:	e8 b5 f0 ff ff       	call   8010535e <argint>
...
801062ba:	e8 23 e9 ff ff       	call   80104be2 <kill>
}
801062bf:	c9                   	leave  
801062c0:	c3                   	ret    
...
801062e3:	e8 76 f0 ff ff       	call   8010535e <argint>
...
80106304:	e8 44 df ff ff       	call   8010424d <growproc>
...
8010632d:	e8 2c f0 ff ff       	call   8010535e <argint>
...
8010633b:	eb 6c                	jmp    801063a9 <sys_sleep+0x90>
  acquire(&tickslock);
8010633d:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
80106344:	e8 76 ea ff ff       	call   80104dbf <acquire>
  ticks0 = ticks;
80106349:	a1 a0 27 11 80       	mov    0x801127a0,%eax
...
8010635e:	74 13                	je     80106373 <sys_sleep+0x5a>
      release(&tickslock);
80106360:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
80106367:	e8 b5 ea ff ff       	call   80104e21 <release>
      return -1;
8010636c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106371:	eb 36                	jmp    801063a9 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106373:	c7 44 24 04 60 1f 11 	movl   $0x80111f60,0x4(%esp)
8010637a:	80 
8010637b:	c7 04 24 a0 27 11 80 	movl   $0x801127a0,(%esp)
80106382:	e8 57 e7 ff ff       	call   80104ade <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106387:	a1 a0 27 11 80       	mov    0x801127a0,%eax
...
80106396:	72 bb                	jb     80106353 <sys_sleep+0x3a>
  ...
  release(&tickslock);
80106398:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
8010639f:	e8 7d ea ff ff       	call   80104e21 <release>
  return 0;
...
801063ae:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801063b1:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
801063b8:	e8 02 ea ff ff       	call   80104dbf <acquire>
  xticks = ticks;
801063bd:	a1 a0 27 11 80       	mov    0x801127a0,%eax
801063c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063c5:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
801063cc:	e8 50 ea ff ff       	call   80104e21 <release>
  return xticks;
...
8010643f:	e8 7d d6 ff ff       	call   80103ac1 <picenable>
}
80106444:	c9                   	leave  
80106445:	c3                   	ret    
	...
...
801064c8:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
801064cf:	89 c2                	mov    %eax,%edx
801064d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d4:	66 89 14 c5 a0 1f 11 	mov    %dx,-0x7feee060(,%eax,8)
801064db:	80 
801064dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064df:	66 c7 04 c5 a2 1f 11 	movw   $0x8,-0x7feee05e(,%eax,8)
801064e6:	80 08 00 
801064e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ec:	0f b6 14 c5 a4 1f 11 	movzbl -0x7feee05c(,%eax,8),%edx
801064f3:	80 
801064f4:	83 e2 e0             	and    $0xffffffe0,%edx
801064f7:	88 14 c5 a4 1f 11 80 	mov    %dl,-0x7feee05c(,%eax,8)
801064fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106501:	0f b6 14 c5 a4 1f 11 	movzbl -0x7feee05c(,%eax,8),%edx
80106508:	80 
80106509:	83 e2 1f             	and    $0x1f,%edx
8010650c:	88 14 c5 a4 1f 11 80 	mov    %dl,-0x7feee05c(,%eax,8)
80106513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106516:	0f b6 14 c5 a5 1f 11 	movzbl -0x7feee05b(,%eax,8),%edx
8010651d:	80 
8010651e:	83 e2 f0             	and    $0xfffffff0,%edx
80106521:	83 ca 0e             	or     $0xe,%edx
80106524:	88 14 c5 a5 1f 11 80 	mov    %dl,-0x7feee05b(,%eax,8)
8010652b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010652e:	0f b6 14 c5 a5 1f 11 	movzbl -0x7feee05b(,%eax,8),%edx
80106535:	80 
80106536:	83 e2 ef             	and    $0xffffffef,%edx
80106539:	88 14 c5 a5 1f 11 80 	mov    %dl,-0x7feee05b(,%eax,8)
80106540:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106543:	0f b6 14 c5 a5 1f 11 	movzbl -0x7feee05b(,%eax,8),%edx
8010654a:	80 
8010654b:	83 e2 9f             	and    $0xffffff9f,%edx
8010654e:	88 14 c5 a5 1f 11 80 	mov    %dl,-0x7feee05b(,%eax,8)
80106555:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106558:	0f b6 14 c5 a5 1f 11 	movzbl -0x7feee05b(,%eax,8),%edx
8010655f:	80 
80106560:	83 ca 80             	or     $0xffffff80,%edx
80106563:	88 14 c5 a5 1f 11 80 	mov    %dl,-0x7feee05b(,%eax,8)
8010656a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010656d:	8b 04 85 98 b0 10 80 	mov    -0x7fef4f68(,%eax,4),%eax
80106574:	c1 e8 10             	shr    $0x10,%eax
80106577:	89 c2                	mov    %eax,%edx
80106579:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657c:	66 89 14 c5 a6 1f 11 	mov    %dx,-0x7feee05a(,%eax,8)
80106583:	80 
void
tvinit(void)
{
...
80106595:	a1 98 b1 10 80       	mov    0x8010b198,%eax
8010659a:	66 a3 a0 21 11 80    	mov    %ax,0x801121a0
801065a0:	66 c7 05 a2 21 11 80 	movw   $0x8,0x801121a2
801065a7:	08 00 
801065a9:	0f b6 05 a4 21 11 80 	movzbl 0x801121a4,%eax
801065b0:	83 e0 e0             	and    $0xffffffe0,%eax
801065b3:	a2 a4 21 11 80       	mov    %al,0x801121a4
801065b8:	0f b6 05 a4 21 11 80 	movzbl 0x801121a4,%eax
801065bf:	83 e0 1f             	and    $0x1f,%eax
801065c2:	a2 a4 21 11 80       	mov    %al,0x801121a4
801065c7:	0f b6 05 a5 21 11 80 	movzbl 0x801121a5,%eax
801065ce:	83 c8 0f             	or     $0xf,%eax
801065d1:	a2 a5 21 11 80       	mov    %al,0x801121a5
801065d6:	0f b6 05 a5 21 11 80 	movzbl 0x801121a5,%eax
801065dd:	83 e0 ef             	and    $0xffffffef,%eax
801065e0:	a2 a5 21 11 80       	mov    %al,0x801121a5
801065e5:	0f b6 05 a5 21 11 80 	movzbl 0x801121a5,%eax
801065ec:	83 c8 60             	or     $0x60,%eax
801065ef:	a2 a5 21 11 80       	mov    %al,0x801121a5
801065f4:	0f b6 05 a5 21 11 80 	movzbl 0x801121a5,%eax
801065fb:	83 c8 80             	or     $0xffffff80,%eax
801065fe:	a2 a5 21 11 80       	mov    %al,0x801121a5
80106603:	a1 98 b1 10 80       	mov    0x8010b198,%eax
80106608:	c1 e8 10             	shr    $0x10,%eax
8010660b:	66 a3 a6 21 11 80    	mov    %ax,0x801121a6
  
  initlock(&tickslock, "time");
80106611:	c7 44 24 04 2c 88 10 	movl   $0x8010882c,0x4(%esp)
80106618:	80 
80106619:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
80106620:	e8 79 e7 ff ff       	call   80104d9e <initlock>
}
80106625:	c9                   	leave  
80106626:	c3                   	ret    
...
80106634:	00 
80106635:	c7 04 24 a0 1f 11 80 	movl   $0x80111fa0,(%esp)
...
80106685:	0f 84 34 02 00 00    	je     801068bf <trap+0x27c>
      exit();
8010668b:	e8 de df ff ff       	call   8010466e <exit>
    return;
...
801066a7:	8b 04 85 d4 88 10 80 	mov    -0x7fef772c(,%eax,4),%eax
...
801066bb:	75 31                	jne    801066ee <trap+0xab>
      acquire(&tickslock);
801066bd:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
801066c4:	e8 f6 e6 ff ff       	call   80104dbf <acquire>
      ticks++;
801066c9:	a1 a0 27 11 80       	mov    0x801127a0,%eax
801066ce:	83 c0 01             	add    $0x1,%eax
801066d1:	a3 a0 27 11 80       	mov    %eax,0x801127a0
      wakeup(&ticks);
801066d6:	c7 04 24 a0 27 11 80 	movl   $0x801127a0,(%esp)
801066dd:	e8 d5 e4 ff ff       	call   80104bb7 <wakeup>
      release(&tickslock);
801066e2:	c7 04 24 60 1f 11 80 	movl   $0x80111f60,(%esp)
801066e9:	e8 33 e7 ff ff       	call   80104e21 <release>
    }
    lapiceoi();
801066ee:	e8 f6 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
801066f3:	e9 41 01 00 00       	jmp    80106839 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801066f8:	e8 f4 bf ff ff       	call   801026f1 <ideintr>
    lapiceoi();
801066fd:	e8 e7 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106702:	e9 32 01 00 00       	jmp    80106839 <trap+0x1f6>
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106707:	e8 bb c5 ff ff       	call   80102cc7 <kbdintr>
    lapiceoi();
8010670c:	e8 d8 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
...
80106716:	e8 a9 03 00 00       	call   80106ac4 <uartintr>
    lapiceoi();
8010671b:	e8 c9 c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
...
8010674d:	c7 04 24 34 88 10 80 	movl   $0x80108834,(%esp)
80106754:	e8 48 9c ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106759:	e8 8b c7 ff ff       	call   80102ee9 <lapiceoi>
    break;
...
801067ac:	c7 04 24 58 88 10 80 	movl   $0x80108858,(%esp)
801067b3:	e8 e9 9b ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801067b8:	c7 04 24 8a 88 10 80 	movl   $0x8010888a,(%esp)
...
8010681d:	c7 04 24 90 88 10 80 	movl   $0x80108890,(%esp)
...
80106860:	75 05                	jne    80106867 <trap+0x224>
    exit();
80106862:	e8 07 de ff ff       	call   8010466e <exit>
...
80106888:	75 05                	jne    8010688f <trap+0x24c>
    yield();
8010688a:	e8 f1 e1 ff ff       	call   80104a80 <yield>
...
801068b6:	75 08                	jne    801068c0 <trap+0x27d>
    exit();
801068b8:	e8 b1 dd ff ff       	call   8010466e <exit>
...
801069b0:	74 6c                	je     80106a1e <uartinit+0x10e>
    return;
  uart = 1;
801069b2:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
801069b9:	00 00 00 
...
801069db:	e8 e1 d0 ff ff       	call   80103ac1 <picenable>
  ioapicenable(IRQ_COM1, 0);
801069e0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069e7:	00 
801069e8:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801069ef:	e8 82 bf ff ff       	call   80102976 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801069f4:	c7 45 f4 54 89 10 80 	movl   $0x80108954,-0xc(%ebp)
...
80106a24:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106a27:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
...
80106a40:	e8 c9 c4 ff ff       	call   80102f0e <microdelay>
{
  int i;
...
80106a83:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106a86:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
...
801075c9:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801075cc:	e8 bc b8 ff ff       	call   80102e8d <cpunum>
801075d1:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801075d7:	05 20 f9 10 80       	add    $0x8010f920,%eax
...
80107a79:	e8 81 b0 ff ff       	call   80102aff <kalloc>
...
80107aa4:	e8 65 d5 ff ff       	call   8010500e <memset>
...
80107b27:	74 0c                	je     80107b35 <mappages+0x64>
      panic("remap");
80107b29:	c7 04 24 5c 89 10 80 	movl   $0x8010895c,(%esp)
...
80107b6c:	e8 8e af ff ff       	call   80102aff <kalloc>
...
80107b9a:	e8 6f d4 ff ff       	call   8010500e <memset>
...
80107bb2:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
80107bb9:	e8 7f 89 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107bbe:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
...
80107c10:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
...
80107c2d:	a3 f8 27 11 80       	mov    %eax,0x801127f8
  switchkvm();
...
80107c3f:	a1 f8 27 11 80       	mov    0x801127f8,%eax
...
80107c5a:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107c5d:	e8 a5 d2 ff ff       	call   80104f07 <pushcli>
...
80107d90:	c7 04 24 73 89 10 80 	movl   $0x80108973,(%esp)
...
80107dad:	e8 ee f7 ff ff       	call   801075a0 <lcr3>
  popcli();
80107db2:	e8 98 d1 ff ff       	call   80104f4f <popcli>
}
...
80107dcc:	c7 04 24 87 89 10 80 	movl   $0x80108987,(%esp)
80107dd3:	e8 65 87 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107dd8:	e8 22 ad ff ff       	call   80102aff <kalloc>
...
80107df6:	e8 13 d2 ff ff       	call   8010500e <memset>
...
80107e41:	e8 9b d2 ff ff       	call   801050e1 <memmove>
}
80107e46:	c9                   	leave  
80107e47:	c3                   	ret    
...
80107e5b:	c7 04 24 a4 89 10 80 	movl   $0x801089a4,(%esp)
...
80107e9b:	c7 04 24 c7 89 10 80 	movl   $0x801089c7,(%esp)
...
80107f08:	e8 51 9e ff ff       	call   80101d5e <readi>
...
80107fc3:	e8 46 d0 ff ff       	call   8010500e <memset>
...
80108085:	75 0c                	jne    80108093 <deallocuvm+0x82>
        panic("kfree");
80108087:	c7 04 24 fd 89 10 80 	movl   $0x801089fd,(%esp)
...
801080a7:	e8 ba a9 ff ff       	call   80102a66 <kfree>
      *pte = 0;
...
801080d9:	c7 04 24 03 8a 10 80 	movl   $0x80108a03,(%esp)
...
80108154:	e8 0d a9 ff ff       	call   80102a66 <kfree>
}
80108159:	c9                   	leave  
8010815a:	c3                   	ret    
...
80108182:	75 0c                	jne    80108190 <clearpteu+0x35>
    panic("clearpteu");
80108184:	c7 04 24 14 8a 10 80 	movl   $0x80108a14,(%esp)
...
801081a4:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801081a7:	e8 b9 f9 ff ff       	call   80107b65 <setupkvm>
801081ac:	89 45 f0             	mov    %eax,-0x10(%ebp)
801081af:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081b3:	75 0a                	jne    801081bf <copyuvm+0x1e>
    return 0;
801081b5:	b8 00 00 00 00       	mov    $0x0,%eax
801081ba:	e9 f1 00 00 00       	jmp    801082b0 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
801081bf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801081c6:	e9 c0 00 00 00       	jmp    8010828b <copyuvm+0xea>
...
801081e0:	e8 56 f8 ff ff       	call   80107a3b <walkpgdir>
801081e5:	89 45 ec             	mov    %eax,-0x14(%ebp)
801081e8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801081ec:	75 0c                	jne    801081fa <copyuvm+0x59>
      panic("copyuvm: pte should exist");
801081ee:	c7 04 24 1e 8a 10 80 	movl   $0x80108a1e,(%esp)
...
80108204:	75 0c                	jne    80108212 <copyuvm+0x71>
      panic("copyuvm: page not present");
80108206:	c7 04 24 38 8a 10 80 	movl   $0x80108a38,(%esp)
8010820d:	e8 2b 83 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
8010821c:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
8010821f:	e8 db a8 ff ff       	call   80102aff <kalloc>
80108224:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108227:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
8010822b:	74 6f                	je     8010829c <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010822d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108230:	89 04 24             	mov    %eax,(%esp)
80108233:	e8 80 f3 ff ff       	call   801075b8 <p2v>
80108238:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010823f:	00 
80108240:	89 44 24 04          	mov    %eax,0x4(%esp)
80108244:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108247:	89 04 24             	mov    %eax,(%esp)
8010824a:	e8 92 ce ff ff       	call   801050e1 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
8010824f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108252:	89 04 24             	mov    %eax,(%esp)
80108255:	e8 51 f3 ff ff       	call   801075ab <v2p>
8010825a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010825d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108264:	00 
...
8010827b:	e8 51 f8 ff ff       	call   80107ad1 <mappages>
80108280:	85 c0                	test   %eax,%eax
80108282:	78 1b                	js     8010829f <copyuvm+0xfe>
  uint pa, i;
  char *mem;
...
8010828e:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108291:	0f 82 34 ff ff ff    	jb     801081cb <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
8010829a:	eb 14                	jmp    801082b0 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
8010829c:	90                   	nop
8010829d:	eb 01                	jmp    801082a0 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
8010829f:	90                   	nop
...
801082a6:	e8 22 fe ff ff       	call   801080cd <freevm>
  return 0;
...
801082b5:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
801082cd:	e8 69 f7 ff ff       	call   80107a3b <walkpgdir>
...
801082df:	75 07                	jne    801082e8 <uva2ka+0x36>
    return 0;
801082e1:	b8 00 00 00 00       	mov    $0x0,%eax
801082e6:	eb 25                	jmp    8010830d <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
801082e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082eb:	8b 00                	mov    (%eax),%eax
801082ed:	83 e0 04             	and    $0x4,%eax
801082f0:	85 c0                	test   %eax,%eax
801082f2:	75 07                	jne    801082fb <uva2ka+0x49>
    return 0;
801082f4:	b8 00 00 00 00       	mov    $0x0,%eax
801082f9:	eb 12                	jmp    8010830d <uva2ka+0x5b>
...
80108308:	e8 ab f2 ff ff       	call   801075b8 <p2v>
}
8010830d:	c9                   	leave  
8010830e:	c3                   	ret    
...
80108312:	83 ec 28             	sub    $0x28,%esp
  ...
  buf = (char*)p;
80108315:	8b 45 10             	mov    0x10(%ebp),%eax
80108318:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
8010831b:	e9 8b 00 00 00       	jmp    801083ab <copyout+0x9c>
...
80108338:	e8 75 ff ff ff       	call   801082b2 <uva2ka>
8010833d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108340:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108344:	75 07                	jne    8010834d <copyout+0x3e>
      return -1;
80108346:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010834b:	eb 6d                	jmp    801083ba <copyout+0xab>
    n = PGSIZE - (va - va0);
8010834d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108350:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108353:	89 d1                	mov    %edx,%ecx
80108355:	29 c1                	sub    %eax,%ecx
80108357:	89 c8                	mov    %ecx,%eax
...
80108367:	76 06                	jbe    8010836f <copyout+0x60>
      n = len;
...
80108375:	89 d1                	mov    %edx,%ecx
80108377:	29 c1                	sub    %eax,%ecx
80108379:	89 c8                	mov    %ecx,%eax
8010837b:	03 45 e8             	add    -0x18(%ebp),%eax
8010837e:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108381:	89 54 24 08          	mov    %edx,0x8(%esp)
80108385:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108388:	89 54 24 04          	mov    %edx,0x4(%esp)
8010838c:	89 04 24             	mov    %eax,(%esp)
8010838f:	e8 4d cd ff ff       	call   801050e1 <memmove>
    len -= n;
80108394:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108397:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010839a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010839d:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
801083a0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083a3:	05 00 10 00 00       	add    $0x1000,%eax
801083a8:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
801083ab:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801083af:	0f 85 6b ff ff ff    	jne    80108320 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
